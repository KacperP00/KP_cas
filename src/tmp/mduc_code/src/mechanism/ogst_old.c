...
*/
	...
	M[mM15] = c[sN2] + c[sAR] + c[sO] + 2 * c[sH2]
		 ...
		 + c[sC8H9O2] + c[sOC8H7OOH] + c[sA1CH3CH3XC8H10] + c[sA1CH3CH2XC8H9]
		 + c[sA1CH3CHOXC8H8O] + c[sA2CH3XC11H10] + c[sA1CHOCH2XC8H7O] + c[sA1CHOCHOXC8H6O2]
		 + c[sA2OHXC10H8O] + c[sA2CH2XC11H9] + c[sA2CH2OXC11H9O] + c[sA2CHOXC11H8O]
		 + c[sA2OXC10H7O] + c[sC4H2] + c[sOC6H4O];
	...
	M[mM21] = c[sN2] + c[sAR] + c[sO] + 2 * c[sH2]
		 ...
		 + c[sOC8H7OOH] + c[sA1CH3CH3XC8H10] + c[sA1CH3CH2XC8H9] + c[sA1CH3CHOXC8H8O]
		 + c[sA2CH3XC11H10] + c[sA1CHOCH2XC8H7O] + c[sA1CHOCHOXC8H6O2] + c[sA2OHXC10H8O]
		 + c[sA2CH2XC11H9] + c[sA2CH2OXC11H9O] + c[sA2CHOXC11H8O] + c[sA2OXC10H7O]
		 + c[sC4H2] + c[sOC6H4O];



	k[r3f] = 8.6310000000E+11 * exp( -80207000 / rt );
	k[r3b] = 5.0623635033E+11 * exp( -0.0350345 * lgt - 74440909.81 / rt );
	k[r4f] = 2.0660000000E+05 * exp( 1.51 * lgt - 14351000 / rt );
	k[r4b] = 2.1217331924E+06 * exp( 1.41638 * lgt - 77059304.43 / rt );
	k[r5f] = 3.3200000000E+01 * exp( 2.42 * lgt + 8075000 / rt );
	k[r5b] = 5.8130803668E+02 * exp( 2.36141 * lgt - 60399394.61 / rt );
	k[r1f] = 1.0740000000E+11 * exp( -63957000 / rt );
	k[r1b] = 2.1355916977E+08 * exp( 0.434958 * lgt + 6604131.16 / rt );
	kTroe0 = 6.4390000000E+14 * exp( -1.72 * lgt - 2196000 / rt );
	kTroeInf = 4.7040000000E+09 * exp( 0.44 * lgt );
	fcTroe = 0.5 * exp( -temp / 1e-30 ) + 0.5 * exp( -temp / 1e+30 );
	k[r15f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM15] );
	kTroe0 = 9.1328854916E+17 * exp( -1.73291 * lgt - 206859348.7 / rt );
	kTroeInf = 6.6720132555E+12 * exp( 0.427093 * lgt - 204663348.7 / rt );
	k[r15b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM15] );
	k[r16] = 2.8120000000E+03 * exp( 2.09 * lgt + 6071000 / rt );
	k[r21] = 1.4170000000E+08 * exp( 6817000 / rt );
	k[r20] = 9.4060000000E+11 * exp( -50133000 / rt );
	k[r19] = 8.2200000000E+08 * exp( 2079000 / rt );
	k[r18] = 1.7200000000E+07 * exp( 1 * lgt + 3029000 / rt );
	k[r17] = 6.2450000000E+10 * exp( -1234000 / rt );
	k[r26] = 3.7230000000E+08 * exp( -1331000 / rt );
	k[r23] = 2.4100000000E+10 * exp( -16610000 / rt );
	kTroe0 = 2.1760000000E+22 * exp( -2.3 * lgt - 203970000 / rt );
	kTroeInf = 1.7470000000E+13 * exp( 0.9 * lgt - 203966000 / rt );
	fcTroe = 0.57 * exp( -temp / 1e-30 ) + 0.43 * exp( -temp / 1e+30 );
	k[r22] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM16] );
	k[r39] = 1.9790000000E+10 * exp( -30418000 / rt );
	k[rG06f] = 1.0800000000E+11 * exp( -13010000 / rt );
	k[rG06b] = 1.7379827487E+12 * exp( -0.291033 * lgt - 1692273.875 / rt );
	k[rG08] = 6.2810000000E+09 * exp( 3160000 / rt );
	k[rG09] = 6.7100000000E+10;
	kTroe0 = 1.0400000000E+20 * exp( -2.76 * lgt - 6690000 / rt );
	kTroeInf = 6.0000000000E+11;
	fcTroe = 0.438 * exp( -temp / 91 ) + 0.562 * exp( -temp / 5836 ) + 1 * exp( -8552 / temp );
	k[rG14] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rG19] = 9.9490000000E+09 * exp( -6280000 / rt );
	k[rG20] = 2.4000000000E+09 * exp( -6280000 / rt );
	k[rG17] = 1.1300000000E+04 * exp( 2 * lgt - 12550000 / rt );
	k[rG15] = 8.0000000000E+10;
	k[rG16] = 2.0000000000E+10;
	k[rG21] = 5.0000000000E+09 * exp( -6280000 / rt );
	k[rG36] = 7.7590000000E+09;
	k[rG35] = 4.5590000000E+10;
	k[rG38f] = 3.0000000000E+10;
	k[rG38b] = 2.1872817488E+10 * exp( -0.0622863 * lgt - 37302987.98 / rt );
	k[rG34f] = 7.0000000000E+10;
	k[rG34b] = 2.1163554877E+13 * exp( -0.573354 * lgt - 68461920.07 / rt );
	k[rG28f] = 1.5000000000E+10 * exp( -2510000 / rt );
	k[rG28b] = 1.0936408744E+10 * exp( -0.0622863 * lgt - 39812987.98 / rt );
	k[rG52] = 6.3410000000E+10;
	k[rG55] = 5.6000000000E+04 * exp( 1.6 * lgt - 22680000 / rt );
	k[rG57f] = 7.6150000000E+14 * exp( -1.34 * lgt - 5930000 / rt );
	k[rG57b] = 2.5866625919E+13 * exp( -0.86027 * lgt - 176384.3555 / rt );
	k[rG53] = 2.1410000000E+10;
	k[rG72] = 1.0000000000E+11;
	k[rLPG65] = 1.4500000000E+09;
	kTroe0 = 3.8200000000E+25 * exp( -4.89 * lgt - 14360000 / rt );
	kTroeInf = 1.0100000000E+05 * exp( 1.63 * lgt );
	fcTroe = 0.955 * exp( -temp / 880.1 ) + 0.045 * exp( -temp / 2.5e+09 ) + 1 * exp( -1.786e+09 / temp );
	k[rLPG60f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM0] );
	kTroe0 = 1.6260000000E+36 * exp( -6.659 * lgt - 158341000 / rt );
	kTroeInf = 4.2980000000E+15 * exp( -0.139 * lgt - 143981000 / rt );
	k[rLPG60b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM0] );
	k[rG59] = 7.2770000000E+08 * exp( -57910000 / rt );
	k[rG74f] = 5.5100000000E+09 * exp( 0.1 * lgt - 44350000 / rt );
	k[rG74b] = 9.4829147064E+14 * exp( -1.0902 * lgt - 7214861.361 / rt );
	kTroe0 = 1.5500000000E+18 * exp( -2.79 * lgt - 17540000 / rt );
	kTroeInf = 1.8000000000E+07 * exp( -9980000 / rt );
	fcTroe = 1 * exp( -0 / temp );
	k[r27] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM20] );
	k[r29] = 5.7150000000E+09 * exp( -0.664 * lgt - 1388000 / rt );
	k[r31] = 1.5700000000E+02 * exp( 2.18 * lgt - 75072000 / rt );
	k[r28f] = 6.9880000000E+01 * exp( 2.053 * lgt + 1488000 / rt );
	k[r28b] = 3.9069941448E+08 * exp( 0.773803 * lgt - 105981755.2 / rt );
	kTroe0 = 2.6900000000E+27 * exp( -5.11 * lgt - 29690000 / rt );
	...
	k[rLPG24] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[r38] = 3.4280000000E+10 * exp( -1715000 / rt );
	k[r36f] = 4.3760000000E+08 * exp( 0.659 * lgt - 62232000 / rt );
	k[r36b] = 8.4837182791E+04 * exp( 0.891456 * lgt + 3517584.76 / rt );
	k[r32] = 1.4700000000E+11;
	k[rDD68] = 1.3830000000E+08 * exp( 4602000 / rt );
	k[r35] = 3.0200000000E+10;
	k[rDD54] = 2.0600000000E+11;
	k[rG46] = 3.9000000000E+10 * exp( -14810000 / rt );
	k[rG47] = 5.8080000000E+07 * exp( 1.18 * lgt + 1870000 / rt );
	k[rG45] = 5.6760000000E+04 * exp( 1.9 * lgt - 11470000 / rt );
	k[rG49] = 1.4000000000E+03 * exp( 2 * lgt - 50210000 / rt );
	k[rLPDD62] = 1.7910000000E+13 * exp( -1.1 * lgt );
	k[rLPG89] = 5.9680000000E+12 * exp( -0.168 * lgt - 61525000 / rt );
	kTroe0 = 6.3030000000E+58 * exp( -13.872 * lgt - 189916000 / rt );
	kTroeInf = 1.5470000000E+43 * exp( -8.622 * lgt - 177536000 / rt );
	fcTroe = 0.242 * exp( -temp / 94 ) + 0.758 * exp( -temp / 1555 ) + 1 * exp( -4200 / temp );
	k[rLPG44] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rDD44] = 5.3180000000E+11 * exp( -0.353 * lgt - 73555000 / rt );
	k[rDD47] = 1.8500000000E+04 * exp( 1.51 * lgt + 4025000 / rt );
	k[rDD50] = 3.6680000000E+03 * exp( 2.1 * lgt - 20368000 / rt );
	k[rDD48] = 1.0000000000E+09 * exp( -49873000 / rt );
	k[rDD53] = 3.4710000000E+22 * exp( -1.542 * lgt - 463169000 / rt );
	k[rDD52] = 2.6200000000E+03 * exp( 2.06 * lgt - 3833000 / rt );
	k[rLPG63] = 1.1520000000E+08 * exp( -0.019 * lgt + 6396000 / rt );
	k[rLPDD59] = 4.2510000000E-55 * exp( 18.783 * lgt + 37518000 / rt );
	k[rLPG61] = 1.5280000000E+10 * exp( -0.019 * lgt + 4846000 / rt );
	k[rLPG64] = 3.6340000000E+09 * exp( -0.019 * lgt - 49004000 / rt );
	k[rDD66] = 1.9900000000E+09 * exp( -48785000 / rt );
	k[rDD67] = 1.4540000000E+16 * exp( -1.126 * lgt - 171544000 / rt );
	kTroe0 = 4.3040000000E+25 * exp( -4.66 * lgt - 15820000 / rt );
	kTroeInf = 1.1610000000E+07 * exp( 1.27 * lgt - 11330000 / rt );
	fcTroe = 0.2122 * exp( -temp / -10210 );
	k[rG115f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	kTroe0 = 9.4097780916E+27 * exp( -4.48812 * lgt - 162604360.4 / rt );
	kTroeInf = 2.5382788951E+09 * exp( 1.44188 * lgt - 158114360.4 / rt );
	k[rG115b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rG116] = 8.1000000000E+03 * exp( 2 * lgt - 7950000 / rt );
	k[rG117] = 9.1850000000E+03 * exp( 2 * lgt - 7950000 / rt );
	k[rLPG120f] = 3.7780000000E-04 * exp( 3.703 * lgt + 7342000 / rt );
	k[rLPG120b] = 2.0570000000E+31 * exp( -4.52 * lgt - 266751000 / rt );
	k[rG122] = 1.2800000000E+06 * exp( 0.73 * lgt - 10790000 / rt );
	k[rG135] = 2.7550000000E+14 * exp( -1.39 * lgt - 4250000 / rt );
	k[rLPG134] = 2.5380000000E+08 * exp( 0.29 * lgt - 50000 / rt );
	k[rG133] = 1.1790000000E+03 * exp( 1.61 * lgt + 1610000 / rt );
	k[rG130] = 1.6140000000E+10;
	k[rLPG131] = 1.0300000000E+10 * exp( 0.21 * lgt + 1790000 / rt );
	k[rG160] = 4.1840000000E-05 * exp( 4.2 * lgt + 3600000 / rt );
	k[rG158] = 7.1500000000E+01 * exp( 2.47 * lgt - 3890000 / rt );
	k[rG159] = 3.8900000000E+05 * exp( 1.36 * lgt - 3710000 / rt );
	k[rLPG157] = 7.3880000000E+06 * exp( 0.88 * lgt - 4770000 / rt );
	k[rG156] = 3.4820000000E+02 * exp( 2.75 * lgt - 48740000 / rt );
	k[rG161] = 3.5970000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	kTroe0 = 2.3320000000E+33 * exp( -6.64 * lgt - 24140000 / rt );
	kTroeInf = 1.5740000000E+06 * exp( 1.46 * lgt - 5670000 / rt );
	fcTroe = 1.569 * exp( -temp / 299 ) + -0.569 * exp( -temp / -9147 ) + 1 * exp( -152.4 / temp );
	k[rG155f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	kTroe0 = 4.2990018456E+36 * exp( -6.76131 * lgt - 175460755 / rt );
	kTroeInf = 2.9016418975E+09 * exp( 1.33869 * lgt - 156990755 / rt );
	k[rG155b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rLPDD15] = 4.3030000000E+09 * exp( -0.019 * lgt + 4010000 / rt );
	k[rG171] = 6.3900000000E+03 * exp( 1.02 * lgt + 8510000 / rt );
	k[rR037] = 4.9170000000E+11;
	k[rG109] = 1.0000000000E+11;
	k[rR022] = 2.7500000000E+10;
	k[rG110] = 1.0000000000E+11;
	k[rG111] = 6.0920000000E+07 * exp( -3570000 / rt );
	k[rR024] = 1.0000000000E+10;
	k[rLPG124] = 1.4570000000E+11 * exp( -0.048 * lgt - 15621000 / rt );
	k[rLPR028] = 8.7400000000E+12 * exp( -1.428 * lgt - 13051000 / rt );
	k[rLPG123f] = 4.8550000000E+15 * exp( -1.428 * lgt - 46521000 / rt );
	k[rLPG123b] = 3.8770000000E+07 * exp( 0.596 * lgt - 22499000 / rt );
	k[rLPG127f] = 4.1370000000E+15 * exp( -1.428 * lgt - 21421000 / rt );
	k[rLPG127b] = 3.3920000000E+08 * exp( 0.502 * lgt - 60107000 / rt );
	k[rLPR025] = 3.7050000000E+14 * exp( -1.446 * lgt - 13299000 / rt );
	k[rLPR030] = 4.6260000000E+11 * exp( -0.509 * lgt - 119000 / rt );
	k[rLPG139] = 1.7080000000E+07 * exp( -0.009 * lgt - 119000 / rt );
	k[rLPG140] = 1.5990000000E+07 * exp( -0.009 * lgt - 119000 / rt );
	k[rLPG137] = 7.0040000000E+34 * exp( -6.879 * lgt - 197579000 / rt );
	k[rLPG138] = 3.0250000000E+10 * exp( 0.021 * lgt + 1531000 / rt );
	k[rLPG136] = 1.4210000000E+34 * exp( -6.579 * lgt - 207051000 / rt );
	k[rLPG144] = 3.2560000000E+10 * exp( -0.009 * lgt - 128000 / rt );
	kTroe0 = 3.1690000000E-68 * exp( 20.949 * lgt + 187371000 / rt );
	kTroeInf = 7.9230000000E-68 * exp( 20.949 * lgt + 169799000 / rt );
	fcTroe = 1 * exp( -0 / temp );
	k[rLPDD76f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM0] );
	kTroe0 = 5.1040000000E+02 * exp( 1.465 * lgt + 3246000 / rt );
	kTroeInf = 1.2760000000E+03 * exp( 1.465 * lgt - 14326000 / rt );
	k[rLPDD76b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM0] );
	k[rG168] = 1.3200000000E+20 * exp( -2.02 * lgt - 86820000 / rt );
	k[rLPR015] = 1.1770000000E+26 * exp( -3.805 * lgt - 106695000 / rt );
	k[rLPR116] = 2.0330000000E+11 * exp( -0.619 * lgt - 5490000 / rt );
	k[rLPR115] = 1.1950000000E+11 * exp( -0.087 * lgt - 726000 / rt );
	k[rLPR133] = 8.2140000000E-06 * exp( 4.164 * lgt - 41693000 / rt );
	k[rLPLPR118] = 2.8880000000E+11 * exp( -0.508 * lgt - 248000 / rt );
	k[rLPR016] = 2.2850000000E+54 * exp( -12.379 * lgt - 104020000 / rt );
	k[rLPLPR113] = 4.5190000000E+12 * exp( -0.589 * lgt - 3840000 / rt );
	k[rLPR111] = 1.3780000000E+20 * exp( -3.319 * lgt - 110010000 / rt );
	k[rLPR007] = 1.1950000000E+34 * exp( -6.861 * lgt - 224777000 / rt );
	k[rLPLPR117] = 1.7170000000E+15 * exp( -1.559 * lgt - 16050000 / rt );
	k[rR141] = 4.3550000000E+18 * exp( -2.39 * lgt - 46780000 / rt );
	k[rR143] = 3.1760000000E+04 * exp( 1.6 * lgt + 4070000 / rt );
	k[rLPR153] = 8.8680000000E+01 * exp( 2.926 * lgt - 27350000 / rt );
	k[rLPR142] = 1.4940000000E+05 * exp( 1.6 * lgt - 1370000 / rt );
	k[rLPR151] = 4.4630000000E+00 * exp( 2.776 * lgt + 6471000 / rt );
	kTroe0 = 3.9900000000E+36 * exp( -6.796 * lgt - 166004000 / rt );
	kTroeInf = 1.9510000000E+15 * exp( -0.506 * lgt - 153584000 / rt );
	fcTroe = 1 * exp( -temp / 1310 ) + 1 * exp( -48100 / temp );
	k[rG183] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rG184] = 3.0820000000E+13 * exp( -1.63 * lgt - 14300000 / rt );
	kTroe0 = 1.6290000000E+67 * exp( -16.267 * lgt - 179210000 / rt );
	kTroeInf = 1.3850000000E+13 * exp( -0.067 * lgt - 127040000 / rt );
	fcTroe = 0.8106 * exp( -temp / 277 ) + 0.1894 * exp( -temp / 8748 ) + 1 * exp( -7891 / temp );
	k[rG163] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rLPHP55] = 3.1670000000E+10 * exp( -0.493 * lgt - 969000 / rt );
	k[rLPHP43] = 9.7530000000E+16 * exp( -0.434 * lgt - 297422000 / rt );
	k[rLPHP54] = 4.3310000000E+11 * exp( -0.493 * lgt - 4529000 / rt );
	k[rLPHP52] = 4.1170000000E+11 * exp( -0.493 * lgt - 4529000 / rt );
	k[rLPHP53] = 1.4860000000E+04 * exp( 1.847 * lgt + 3421000 / rt );
	k[rLPDD514] = 1.3160000000E+10 * exp( 0.015 * lgt - 5525000 / rt );
	k[rLPHP56] = 3.2380000000E+10 * exp( -0.493 * lgt - 969000 / rt );
	k[rLPHP39] = 8.6100000000E+17 * exp( -1.4 * lgt - 162800000 / rt );
	k[rHP41] = 8.3900000000E+14 * exp( -0.64 * lgt - 112570000 / rt );
	k[rHP29] = 6.8490000000E+21 * exp( -2.61 * lgt - 134000000 / rt );
	k[rHP32] = 4.1220000000E-19 * exp( 8.84 * lgt - 29730000 / rt );
	k[rDD199] = 2.3670000000E+08 * exp( 16736000 / rt );
	k[rDD212] = 9.3780000000E+09 * exp( 0.086 * lgt - 6452000 / rt );
	k[rLPDD205] = 7.1310000000E+15 * exp( -297064000 / rt );
	k[rDD214] = 5.5420000000E+25 * exp( -3.686 * lgt - 142868000 / rt );
	k[rDD208] = 7.1930000000E+11 * exp( 0.279 * lgt - 128848000 / rt );
	k[rDD43] = 1.0000000000E+08 * exp( 16736000 / rt );
	k[rHP26] = 1.9030000000E+13 * exp( -1.65 * lgt + 7630000 / rt );
	k[rLPHP22] = 1.0030000000E+16 * exp( -297064000 / rt );
	k[rHP15] = 6.6600000000E+08 * exp( 0.45 * lgt - 8430000 / rt );
	k[rLPHP12] = 6.7480000000E+18 * exp( -1.65 * lgt - 132560000 / rt );
	k[rHP11] = 2.9740000000E+19 * exp( -1.75 * lgt - 133780000 / rt );
	k[rHP10] = 1.8870000000E+12 * exp( 0.02 * lgt - 116250000 / rt );
	k[rLPDD286] = 4.6000000000E+16 * exp( -1.413 * lgt - 110770000 / rt );
	k[rDD282] = 7.3220000000E+14 * exp( -0.833 * lgt - 118041000 / rt );
	k[rDD288] = 9.4310000000E+10 * exp( 0.336 * lgt - 100547000 / rt );
	k[rDD287] = 1.1680000000E+22 * exp( -2.405 * lgt - 160016000 / rt );
	k[rDD323] = 5.8390000000E+18 * exp( -1.902 * lgt - 118943000 / rt );
	k[rDD324] = 5.9620000000E+21 * exp( -2.324 * lgt - 159951000 / rt );
	k[rDD319] = 5.9340000000E+09 * exp( 0.693 * lgt - 101293000 / rt );
	k[rDD210] = 1.5380000000E+24 * exp( -2.246 * lgt - 370781000 / rt );
	k[rDD421] = 1.8190000000E+24 * exp( -2.223 * lgt - 371839000 / rt );
	k[rDD436] = 8.5070000000E+23 * exp( -2.147 * lgt - 370881000 / rt );
	k[rDD425] = 1.2680000000E+24 * exp( -2.229 * lgt - 371576000 / rt );
	k[rDD422] = 1.9440000000E+11 * exp( -207694000 / rt );
	k[rDD434] = 2.0710000000E+05 * exp( 1.544 * lgt - 556000 / rt );
	k[rDD429] = 7.1390000000E-02 * exp( 3.557 * lgt - 56660000 / rt );
	k[rDD424] = 3.9120000000E+03 * exp( 2.52 * lgt - 12080000 / rt );
	k[rDD432] = 5.7120000000E+04 * exp( 2.521 * lgt - 18533000 / rt );
	k[rDD427] = 1.3330000000E+11 * exp( -74015000 / rt );
	k[rLPDD431] = 2.0700000000E-02 * exp( 3.73 * lgt - 61347000 / rt );
	k[rDD405f] = 2.3720000000E+12 * exp( 0.309 * lgt - 152536000 / rt );
	k[rDD405b] = 5.6190000000E+02 * exp( 2.187 * lgt + 7611000 / rt );
	k[rDD418] = 7.2920000000E+10 * exp( 0.51 * lgt - 113311000 / rt );
	k[rDD415] = 1.4520000000E+17 * exp( -1.265 * lgt - 131866000 / rt );
	k[rDD416] = 3.8460000000E+14 * exp( -0.397 * lgt - 121439000 / rt );
	k[rLPDD406] = 3.2050000000E+16 * exp( -1.223 * lgt - 128372000 / rt );
	k[rDD408f] = 1.7070000000E+11 * exp( -0.324 * lgt - 2235000 / rt );
	k[rDD408b] = 4.2560000000E+25 * exp( -2.989 * lgt - 165486000 / rt );
	k[rDD472] = 8.7100000000E+38 * exp( -7.955 * lgt - 166778000 / rt );
	k[rLPDD465f] = 2.4200000000E+07 * exp( 1.188 * lgt - 77083000 / rt );
	k[rLPDD465b] = 7.2484982708E+06 * exp( 0.937827 * lgt - 23205657.49 / rt );
	k[rLPDD473] = 1.5350000000E-06 * exp( 4.946 * lgt - 24970000 / rt );
	k[rLPDD486f] = 3.1810000000E+14 * exp( -1.558 * lgt - 14198000 / rt );
	k[rLPDD486b] = 7.1597693926E+28 * exp( -4.19719 * lgt - 177495502.4 / rt );
	k[rLPDD502] = 1.1130000000E+14 * exp( -0.852 * lgt - 81442000 / rt );
	k[rLPLPDD495] = 3.8030000000E+19 * exp( -1.292 * lgt - 171906000 / rt );
	k[rLPDD499] = 4.3110000000E+23 * exp( -2.155 * lgt - 178393000 / rt );
	k[rLPDD490] = 9.4840000000E+20 * exp( -1.679 * lgt - 172679000 / rt );
	k[rLPR140] = 1.1290000000E+63 * exp( -14.011 * lgt - 294551000 / rt );
	k[rLPLPDD107] = 6.2000000000E-25 * exp( 9.495 * lgt + 41108000 / rt );
	k[rDD332N] = 1.0990000000E+08 * exp( 0.76 * lgt + 1423000 / rt );
	k[rDD294] = 1.5280000000E+07 * exp( 0.76 * lgt + 1423000 / rt );
	k[rDD290] = 8.2480000000E+12 * exp( -119179000 / rt );
	k[rLPDD293] = 1.4280000000E+26 * exp( -3.723 * lgt - 152644000 / rt );
	k[rHP60] = 7.7880000000E+06 * exp( 0.76 * lgt + 1420000 / rt );
	k[rDD239] = 3.4920000000E+15 * exp( -1.716 * lgt - 14670000 / rt );
	k[rDD263] = 1.0440000000E+17 * exp( -2.149 * lgt - 18957000 / rt );
	k[rDD260f] = 2.5000000000E+10 * exp( -85563000 / rt );
	k[rDD260b] = 6.7155278570E+09 * exp( -0.23424 * lgt - 33307702.91 / rt );
	k[rDD259] = 7.2030000000E+09 * exp( 1.23 * lgt - 127068000 / rt );
	k[rP000f] = 1.5000000000E+09 * exp( 0.5 * lgt - 8370000 / rt );
	k[rP000b] = 6.1199043605E+09 * exp( 0.794062 * lgt - 150584803.3 / rt );
	k[rP001f] = 4.6200000000E+12 * exp( -0.89 * lgt - 38250000 / rt );
	k[rP001b] = 2.4680465396E+22 * exp( -2.30141 * lgt - 194882567.4 / rt );
	k[rP002f] = 6.8000000000E+21 * exp( -3.45 * lgt - 85090000 / rt );
	k[rP002b] = 6.5879507878E+29 * exp( -4.51606 * lgt - 195705788.7 / rt );
	k[rP003f] = 1.4500000000E+45 * exp( -8.9 * lgt - 405860000 / rt );
	k[rP003b] = 5.9159075488E+45 * exp( -8.60594 * lgt - 548074803.3 / rt );
	k[rP004f] = 2.2400000000E+68 * exp( -14.65 * lgt - 596540000 / rt );
	k[rP004b] = 5.7144070433E+62 * exp( -14.1444 * lgt - 262723022 / rt );
	k[rP005f] = 9.6000000000E+67 * exp( -17.77 * lgt - 130960000 / rt );
	k[rP005b] = 3.7352568967E+81 * exp( -19.121 * lgt - 575688821.6 / rt );
	k[rP006f] = 1.3800000000E+13 * exp( -1 * lgt - 37240000 / rt );
	k[rP006b] = 3.0077645189E+23 * exp( -2.11735 * lgt - 336087370.7 / rt );
	k[rP007f] = 1.6700000000E+20 * exp( -3.3 * lgt - 104430000 / rt );
	k[rP007b] = 6.6010235311E+28 * exp( -4.07199 * lgt - 357260592 / rt );
	k[rP008] = 2.1600000000E+36 * exp( -7.74 * lgt - 99800000 / rt );
	k[rP009f] = 8.2500000000E+43 * exp( -10.1 * lgt - 70960000 / rt );
	k[rP009b] = 2.9151378137E+59 * exp( -11.8517 * lgt - 535008868.8 / rt );
	k[rP010f] = 1.0700000000E+42 * exp( -9.57 * lgt - 71190000 / rt );
	k[rP010b] = 1.5425608195E+58 * exp( -11.0277 * lgt - 677453672.1 / rt );
	k[rP011f] = 5.7700000000E+34 * exp( -7 * lgt - 131820000 / rt );
	k[rP011b] = 5.2012066553E+44 * exp( -8.24617 * lgt - 262051890.7 / rt );
	k[rK012f] = 3.2900000000E+03 * exp( 2.05 * lgt - 13230000 / rt );
	k[rK012b] = 2.8151364037E+14 * exp( 0.27021 * lgt - 191386104.5 / rt );
	k[rP013f] = 6.0000000000E+09;
	k[rP013b] = 3.8029710467E+23 * exp( -2.06437 * lgt - 497693591.2 / rt );
	k[rP014f] = 1.8700000000E+04 * exp( 1.47 * lgt - 23150000 / rt );
	k[rP014b] = 7.4111081854E+11 * exp( -0.382874 * lgt - 44811809.88 / rt );
	k[rP015f] = 9.4500000000E-06 * exp( 4.47 * lgt - 18710000 / rt );
	k[rP015b] = 2.7559045191E-05 * exp( 4.39414 * lgt - 28239401.86 / rt );
	k[rP016f] = 4.3000000000E+60 * exp( -12.48 * lgt - 619590000 / rt );
	k[rP016b] = 6.5130890750E+54 * exp( -12.2493 * lgt - 132929473 / rt );
	k[rK017f] = 1.2900000000E+05 * exp( 1.89 * lgt - 73550000 / rt );
	k[rK017b] = 4.5583789859E+01 * exp( 2.46953 * lgt - 19962836.49 / rt );
	k[rP018f] = 7.8000000000E+00 * exp( 2.68 * lgt - 3070000 / rt );
	k[rP018b] = 2.8305822277E-02 * exp( 3.16591 * lgt - 12191140.91 / rt );
	k[rK019f] = 5.9000000000E+10 * exp( 0.54 * lgt - 115340000 / rt );
	k[rK019b] = 1.3748876245E+10 * exp( 0.647444 * lgt - 97958978.78 / rt );
	k[rK020f] = 7.1800000000E+10 * exp( 1.02 * lgt - 161810000 / rt );
	k[rK020b] = 4.1942662262E+06 * exp( 1.32078 * lgt - 30401375.45 / rt );
	k[rK021f] = 1.6500000000E+08 * exp( 0.49 * lgt - 44480000 / rt );
	k[rK021b] = 2.2486281887E+06 * exp( 1.13958 * lgt - 346144739 / rt );
	k[rP022f] = 2.5000000000E+09;
	k[rP022b] = 3.4989212542E+08 * exp( 0.555961 * lgt - 364373043.4 / rt );
	k[rP023f] = 4.3000000000E+60 * exp( -12.48 * lgt - 619590000 / rt );
	k[rP023b] = 6.1874015827E+54 * exp( -12.2599 * lgt - 135887131.6 / rt );
	k[rK024f] = 5.2300000000E+03 * exp( 2.36 * lgt - 70780000 / rt );
	k[rK024b] = 1.7556732603E+00 * exp( 2.92894 * lgt - 20150495.14 / rt );
	k[rP025f] = 1.3400000000E-01 * exp( 3.33 * lgt - 6090000 / rt );
	k[rP025b] = 4.6196306864E-04 * exp( 3.80532 * lgt - 18168799.56 / rt );
	k[rP026f] = 3.0100000000E+14 * exp( 0.34 * lgt - 465490000 / rt );
	k[rP026b] = 1.8586223399E+09 * exp( 0.452698 * lgt + 831847.1725 / rt );
	k[rP027f] = 6.3500000000E+01 * exp( 2.75 * lgt - 48740000 / rt );
	k[rP027b] = 9.1474604387E-02 * exp( 3.2115 * lgt - 15491516.35 / rt );
	k[rP028f] = 6.5500000000E-05 * exp( 4.2 * lgt + 3600000 / rt );
	k[rP028b] = 9.6901068957E-07 * exp( 4.56787 * lgt - 25859820.78 / rt );
	k[rK100f] = 1.3400000000E+01 * exp( 2.5 * lgt - 5370000 / rt );
	k[rK100b] = 3.3117446183E+14 * exp( 0.979368 * lgt - 386582470.9 / rt );
	k[rK102f] = 3.0200000000E+00 * exp( 2.55 * lgt - 13310000 / rt );
	k[rK102b] = 3.6667703577E+10 * exp( 1.2202 * lgt - 292022356 / rt );
	k[rP104f] = 3.8000000000E+04 * exp( 1.62 * lgt - 18570000 / rt );
	k[rP104b] = 1.0751660854E+14 * exp( 0.397642 * lgt - 279901334.8 / rt );
	k[rP105f] = 3.6000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP105b] = 7.9754609459E+25 * exp( -3.13503 * lgt - 311885598.9 / rt );
	k[rP106f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP106b] = 9.6548479060E+36 * exp( -6.03013 * lgt - 365963746.5 / rt );
	k[rP107f] = 1.2600000000E+01 * exp( 2.61 * lgt - 6000000 / rt );
	k[rP107b] = 7.7106058842E+12 * exp( 0.803868 * lgt - 279700375 / rt );
	k[rP108f] = 8.6000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP108b] = 6.6467392724E+54 * exp( -12.2468 * lgt - 121361984.6 / rt );
	k[rK109f] = 2.6500000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK109b] = 4.7781328800E+01 * exp( 2.45204 * lgt - 6415348.089 / rt );
	k[rK110f] = 9.6300000000E-01 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK110b] = 1.7831960352E-03 * exp( 3.50842 * lgt - 15893652.52 / rt );
	k[rP111f] = 8.6000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP111b] = 7.5406406999E+54 * exp( -12.2625 * lgt - 122653241.3 / rt );
	k[rK112f] = 2.6500000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK112b] = 5.4207306452E+01 * exp( 2.43625 * lgt - 7706604.8 / rt );
	k[rK113f] = 9.6300000000E-01 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK113b] = 2.0230130968E-03 * exp( 3.49263 * lgt - 17184909.23 / rt );
	k[rK114f] = 1.2800000000E+03 * exp( 2.05 * lgt - 8080000 / rt );
	k[rK114b] = 2.2606983071E+14 * exp( 0.192174 * lgt - 181300070.2 / rt );
	k[rK115f] = 3.2900000000E+03 * exp( 2.05 * lgt - 13230000 / rt );
	k[rK115b] = 2.8326023455E+14 * exp( 0.287919 * lgt - 186404982.5 / rt );
	k[rP116f] = 6.0000000000E+09;
	k[rP116b] = 4.8470418645E+18 * exp( -2.02971 * lgt - 26435709.78 / rt );
	k[rP117f] = 6.0000000000E+09;
	k[rP117b] = 2.3628374402E+18 * exp( -1.93396 * lgt - 26390622.05 / rt );
	k[rP118f] = 7.2000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP118b] = 1.0487461179E+20 * exp( -2.88767 * lgt - 27251057.87 / rt );
	k[rP119f] = 7.2000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP119b] = 5.7999873154E+19 * exp( -2.80771 * lgt - 28497226.85 / rt );
	k[rP120f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP120b] = 1.2440515728E+31 * exp( -5.78528 * lgt - 92856693.82 / rt );
	k[rP121f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP121b] = 6.0645063853E+30 * exp( -5.68953 * lgt - 92811606.1 / rt );
	k[rK122f] = 7.1800000000E+10 * exp( 1.02 * lgt - 161810000 / rt );
	k[rK122b] = 2.6267266215E+06 * exp( 1.38384 * lgt - 60866185.59 / rt );
	k[rK123f] = 1.6500000000E+08 * exp( 0.49 * lgt - 44480000 / rt );
	k[rK123b] = 1.4082395362E+06 * exp( 1.20264 * lgt - 376609549.1 / rt );
	k[rP124f] = 2.5000000000E+09;
	k[rP124b] = 2.1912556594E+08 * exp( 0.619019 * lgt - 394837853.5 / rt );
	k[rK125f] = 7.1800000000E+10 * exp( 1.02 * lgt - 161810000 / rt );
	k[rK125b] = 4.3354949417E+06 * exp( 1.29787 * lgt - 58106247.65 / rt );
	k[rK126f] = 1.6500000000E+08 * exp( 0.49 * lgt - 44480000 / rt );
	k[rK126b] = 2.3243436664E+06 * exp( 1.11667 * lgt - 373849611.2 / rt );
	k[rP127f] = 2.5000000000E+09;
	k[rP127b] = 3.6167364160E+08 * exp( 0.533047 * lgt - 392077915.6 / rt );
	k[rP128f] = 2.1500000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP128b] = 5.9464917060E+54 * exp( -12.2367 * lgt - 111810655.9 / rt );
	k[rK129f] = 1.3200000000E+05 * exp( 1.88 * lgt - 70380000 / rt );
	k[rK129b] = 8.5172313916E+01 * exp( 2.47205 * lgt + 4285980.552 / rt );
	k[rP130f] = 6.7200000000E-02 * exp( 3.33 * lgt - 6090000 / rt );
	k[rP130b] = 4.4530158534E-04 * exp( 3.82843 * lgt + 5867676.125 / rt );
	k[rP131f] = 2.1500000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP131b] = 5.1910717013E+54 * exp( -12.225 * lgt - 110360350.9 / rt );
	k[rK132f] = 1.3200000000E+05 * exp( 1.88 * lgt - 70380000 / rt );
	k[rK132b] = 7.4352342586E+01 * exp( 2.48384 * lgt + 5736285.547 / rt );
	k[rP133f] = 6.7200000000E-02 * exp( 3.33 * lgt - 6090000 / rt );
	k[rP133b] = 3.8873214199E-04 * exp( 3.84022 * lgt + 7317981.12 / rt );
	k[rK200f] = 2.8800000000E+11 * exp( 0.23 * lgt - 71240000 / rt );
	k[rK200b] = 2.1483543223E+08 * exp( 0.811179 * lgt - 85017550.86 / rt );
	k[rP201f] = 3.5200000000E+09 * exp( -55900000 / rt );
	k[rP201b] = 7.1773752755E+10 * exp( 0.217336 * lgt - 170621365.3 / rt );
	k[rP202f] = 8.6000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP202b] = 1.2560982049E+55 * exp( -12.2259 * lgt - 125068499.8 / rt );
	k[rK203f] = 2.6500000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK203b] = 9.0296969496E+01 * exp( 2.47285 * lgt - 10121863.29 / rt );
	k[rK204f] = 9.6300000000E-01 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK204b] = 3.3698769382E-03 * exp( 3.52923 * lgt - 19600167.72 / rt );
	k[rK205f] = 3.2900000000E+03 * exp( 2.05 * lgt - 13230000 / rt );
	k[rK205b] = 2.4444249624E+16 * exp( -0.322738 * lgt - 188836244.6 / rt );
	k[rP206f] = 6.0000000000E+09;
	k[rP206b] = 2.0390362347E+20 * exp( -2.54462 * lgt - 28821884.2 / rt );
	k[rP207f] = 3.6000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP207b] = 4.1687273816E+21 * exp( -3.38177 * lgt - 33343747.49 / rt );
	k[rP208f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP208b] = 5.2334316593E+32 * exp( -6.30019 * lgt - 95242868.24 / rt );
	k[rP209f] = 2.1500000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP209b] = 5.7147903002E+54 * exp( -12.2371 * lgt - 118358316.7 / rt );
	k[rK210f] = 1.3200000000E+05 * exp( 1.88 * lgt - 70380000 / rt );
	k[rK210b] = 8.1853626892E+01 * exp( 2.47167 * lgt - 2261680.225 / rt );
	k[rP211f] = 6.7200000000E-02 * exp( 3.33 * lgt - 6090000 / rt );
	k[rP211b] = 4.2795068192E-04 * exp( 3.82804 * lgt - 679984.652 / rt );
	k[rK212f] = 7.1800000000E+10 * exp( 1.02 * lgt - 161810000 / rt );
	k[rK212b] = 6.1509446396E+04 * exp( 1.88558 * lgt - 52723839.08 / rt );
	k[rK213f] = 1.6500000000E+08 * exp( 0.49 * lgt - 44480000 / rt );
	k[rK213b] = 3.2976417705E+04 * exp( 1.70438 * lgt - 368467202.6 / rt );
	k[rP214f] = 2.5000000000E+09;
	k[rP214b] = 5.1312124153E+06 * exp( 1.12075 * lgt - 386695507 / rt );
	k[rP301f] = 9.5500000000E+08 * exp( -9070000 / rt );
	k[rP301b] = 1.0546908314E+16 * exp( -1.57654 * lgt - 32778677.98 / rt );
	k[rP302f] = 1.3900000000E+10 * exp( -470000 / rt );
	k[rP302b] = 2.4550866312E+23 * exp( -1.78804 * lgt - 500210459.3 / rt );
	k[rP304f] = 8.6000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP304b] = 8.1347711535E+55 * exp( -12.4557 * lgt - 126953664.6 / rt );
	k[rP305f] = 4.0100000000E+05 * exp( 1.8 * lgt - 68420000 / rt );
	k[rP305b] = 8.8489841788E+02 * exp( 2.17308 * lgt - 8897028.137 / rt );
	k[rP306f] = 2.6900000000E-01 * exp( 3.33 * lgt - 6090000 / rt );
	k[rP306b] = 6.0962361139E-03 * exp( 3.60945 * lgt - 9275332.564 / rt );
	k[rK401f] = 1.3400000000E+01 * exp( 2.5 * lgt - 5370000 / rt );
	k[rK401b] = 3.2105425876E+14 * exp( 0.97143 * lgt - 409641149.6 / rt );
	k[rK403f] = 1.3400000000E+01 * exp( 2.5 * lgt - 5370000 / rt );
	k[rK403b] = 4.0290414867E+14 * exp( 0.96566 * lgt - 412605223.6 / rt );
	k[rP405f] = 3.8000000000E+04 * exp( 1.62 * lgt - 18570000 / rt );
	k[rP405b] = 4.8091959456E+13 * exp( 0.473091 * lgt - 323520364.2 / rt );
	k[rP406f] = 3.8000000000E+04 * exp( 1.62 * lgt - 18570000 / rt );
	k[rP406b] = 8.6959251872E+13 * exp( 0.393137 * lgt - 322274195.2 / rt );
	k[rP407f] = 3.2900000000E+03 * exp( 2.05 * lgt - 13230000 / rt );
	k[rP407b] = 1.9744900653E+13 * exp( 0.444306 * lgt - 286506547.6 / rt );
	k[rP408f] = 6.0000000000E+09;
	k[rP408b] = 3.4325764465E+26 * exp( -1.92589 * lgt - 766849162.3 / rt );
	k[rP409f] = 6.0000000000E+09;
	k[rP409b] = 4.3076808769E+26 * exp( -1.93166 * lgt - 769813236.2 / rt );
	k[rP410f] = 1.8000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP410b] = 2.8481563769E+25 * exp( -3.12264 * lgt - 325039818.2 / rt );
	k[rP411f] = 1.8000000000E+14 * exp( -1.44 * lgt - 65930000 / rt );
	k[rP411b] = 3.1202065530E+25 * exp( -3.11662 * lgt - 326553587.1 / rt );
	k[rP412f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP412b] = 3.7764146576E+36 * exp( -6.03025 * lgt - 400196782.8 / rt );
	k[rP413f] = 3.6200000000E+25 * exp( -4.24 * lgt - 99850000 / rt );
	k[rP413b] = 4.7391775412E+36 * exp( -6.03603 * lgt - 403160856.7 / rt );
	k[rP414f] = 1.2600000000E+01 * exp( 2.61 * lgt - 6000000 / rt );
	k[rP414b] = 7.1189266062E+12 * exp( 0.801281 * lgt - 318383370.2 / rt );
	k[rP415f] = 1.2600000000E+01 * exp( 2.61 * lgt - 6000000 / rt );
	k[rP415b] = 6.2750170621E+12 * exp( 0.817072 * lgt - 317092113.5 / rt );
	k[rP416f] = 3.1800000000E+08 * exp( -9070000 / rt );
	k[rP416b] = 6.3789616436E+19 * exp( -1.89045 * lgt - 242743191.6 / rt );
	k[rP417f] = 2.3900000000E+08 * exp( -9070000 / rt );
	k[rP417b] = 1.9791193614E+19 * exp( -1.90968 * lgt - 253371937.3 / rt );
	k[rP418f] = 1.3900000000E+10 * exp( -470000 / rt );
	k[rP418b] = 1.8408529969E+27 * exp( -2.12118 * lgt - 720803718.6 / rt );
	k[rP419f] = 4.3000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP419b] = 8.2369419565E+54 * exp( -12.2546 * lgt - 110187626.9 / rt );
	k[rK420f] = 2.0000000000E+05 * exp( 1.8 * lgt - 68420000 / rt );
	k[rK420b] = 8.9377808763E+01 * exp( 2.37424 * lgt + 7869009.54 / rt );
	k[rK421f] = 1.3400000000E-01 * exp( 3.33 * lgt - 6090000 / rt );
	k[rK421b] = 6.1498561740E-04 * exp( 3.81061 * lgt + 7490705.113 / rt );
	k[rP422f] = 4.3000000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP422b] = 8.2369419565E+54 * exp( -12.2546 * lgt - 110187626.9 / rt );
	k[rK423f] = 2.6500000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK423b] = 1.1842559661E+02 * exp( 2.44424 * lgt + 4759009.54 / rt );
	k[rK424f] = 9.6300000000E-01 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK424b] = 4.4196354445E-03 * exp( 3.50061 * lgt - 4719294.887 / rt );
	k[rP425f] = 1.3000000000E+11 * exp( 1.08 * lgt - 294550000 / rt );
	k[rP425b] = 5.8424565666E-02 * exp( 2.8367 * lgt - 18258059.5 / rt );
	k[rP501f] = 1.3400000000E+01 * exp( 2.5 * lgt - 5370000 / rt );
	k[rP501b] = 3.5811034647E+14 * exp( 0.969451 * lgt - 413991985.3 / rt );
	k[rP502f] = 3.8000000000E+04 * exp( 1.62 * lgt - 18570000 / rt );
	k[rP502b] = 6.9008878968E+11 * exp( 0.969942 * lgt - 321579572.7 / rt );
	k[rP503f] = 1.2800000000E+03 * exp( 2.05 * lgt - 8080000 / rt );
	k[rP503b] = 7.7618330600E+10 * exp( 0.783907 * lgt - 210403876.8 / rt );
	k[rP504f] = 6.0000000000E+09;
	k[rP504b] = 3.8824030263E+17 * exp( -1.08918 * lgt - 488612879.9 / rt );
	k[rP505f] = 1.2600000000E+01 * exp( 2.61 * lgt - 6000000 / rt );
	k[rP505b] = 4.2972952007E+12 * exp( 0.78322 * lgt - 318828753.1 / rt );
	k[rP506f] = 2.1500000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP506b] = 7.2045750124E+54 * exp( -12.252 * lgt - 114884568.4 / rt );
	k[rK507f] = 2.6500000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK507b] = 2.0716574153E+02 * exp( 2.44675 * lgt + 62068.03303 / rt );
	k[rK508f] = 9.6300000000E-01 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK508b] = 7.7314117922E-03 * exp( 3.50313 * lgt - 9416236.394 / rt );
	k[rK600f] = 1.2800000000E+03 * exp( 2.05 * lgt - 8080000 / rt );
	k[rK600b] = 4.3852288122E+11 * exp( 0.882089 * lgt - 289602697.5 / rt );
	k[rP601f] = 1.7200000000E+60 * exp( -12.48 * lgt - 619550000 / rt );
	k[rP601b] = 1.2604271375E+54 * exp( -12.2341 * lgt - 85298616.63 / rt );
	k[rK602f] = 5.3000000000E+05 * exp( 1.87 * lgt - 71530000 / rt );
	k[rK602b] = 9.0608162916E+01 * exp( 2.46473 * lgt + 29648019.84 / rt );
	k[rK603f] = 1.9300000000E+00 * exp( 3.02 * lgt - 18300000 / rt );
	k[rK603b] = 3.3885134819E-03 * exp( 3.52111 * lgt + 20169715.41 / rt );
	k[rK700f] = 1.2800000000E+03 * exp( 2.05 * lgt - 8080000 / rt );
	k[rK700b] = 8.9132609449E+10 * exp( 0.76659 * lgt - 230176187.5 / rt );
	k[rK701f] = 1.2800000000E+03 * exp( 2.05 * lgt - 8080000 / rt );
	k[rK701b] = 1.1012450591E+11 * exp( 0.882751 * lgt - 279789056.4 / rt );
	k[rP800] = 6.3700000000E+08 * exp( -9070000 / rt );
	k[rP801] = 9.5500000000E+08 * exp( -9070000 / rt );
	k[rP802] = 1.3900000000E+10 * exp( -470000 / rt );
	k[rCP01f] = 1.7300000000E+68 * exp( -15.16 * lgt - 486900000 / rt );
	k[rCP01b] = 7.6332526441E+61 * exp( -14.464 * lgt - 137434558.3 / rt );
	k[rCP02f] = 2.8000000000E+10 * exp( -9450000 / rt );
	k[rCP02b] = 2.8821974020E+06 * exp( 1.04483 * lgt - 93057921.84 / rt );
	k[rCP03f] = 3.3000000000E+11 * exp( -51650000 / rt );
	k[rCP03b] = 1.1622581454E+04 * exp( 1.13526 * lgt - 2981345.18 / rt );
	k[rCP04] = 3.3000000000E+11 * exp( -51650000 / rt );
	k[rCP05f] = 4.7700000000E+01 * exp( 2.71 * lgt - 4630000 / rt );
	k[rCP05b] = 2.8798925207E-03 * exp( 3.7198 * lgt - 82471831.66 / rt );
	k[rCP06f] = 3.0800000000E+03 * exp( 2 * lgt );
	k[rCP06b] = 3.2559435064E+00 * exp( 2.95121 * lgt - 146316226.3 / rt );
	k[rCP07f] = 1.0000000000E+11 * exp( -155440000 / rt );
	k[rCP07b] = 6.2582530698E+07 * exp( 0.683127 * lgt - 10637907.05 / rt );
	k[rCP08f] = 1.1000000000E+01 * exp( 2.6 * lgt - 53970000 / rt );
	k[rCP08b] = 1.0420300995E+00 * exp( 2.89385 * lgt - 71243579.16 / rt );
	k[rCP09f] = 1.8000000000E-04 * exp( 4 * lgt );
	k[rCP09b] = 3.4048615419E-05 * exp( 4.52606 * lgt - 92521076.66 / rt );
	k[rCP10f] = 6.0000000000E+09;
	k[rCP10b] = 1.4518195750E+09 * exp( 0.560401 * lgt - 117036937.8 / rt );
	k[rCP11f] = 6.0000000000E+09;
	k[rCP11b] = 1.5162412910E+12 * exp( -0.2405 * lgt - 123947539.5 / rt );
	k[rCP12f] = 7.6600000000E+06 * exp( 0.88 * lgt - 4770000 / rt );
	k[rCP12b] = 2.2014248883E+10 * exp( -0.124313 * lgt - 111518622.2 / rt );
	k[rCP13] = 3.8900000000E+05 * exp( 1.36 * lgt - 3710000 / rt );
	k[rCP14] = 3.7500000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	k[rCP15] = 3.7500000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	k[rCP16f] = 6.8700000000E+52 * exp( -12.5 * lgt - 176000000 / rt );
	k[rCP16b] = 5.5097990876E+64 * exp( -13.5715 * lgt - 487565243.7 / rt );
	k[rCP17] = 6.3900000000E+26 * exp( -4.03 * lgt - 147300000 / rt );
	k[rCP18] = 4.9100000000E+28 * exp( -4.85 * lgt - 103650000 / rt );
	k[rCP19f] = 7.0000000000E+10;
	k[rCP19b] = 1.2179628270E+15 * exp( -1.03661 * lgt - 240967609.8 / rt );
	k[rCP20f] = 4.3400000000E+04 * exp( 1.3 * lgt - 73920000 / rt );
	k[rCP20b] = 1.5015495409E+06 * exp( 0.698346 * lgt - 244326478.6 / rt );
	k[rCP21f] = 3.1000000000E+10;
	k[rCP21b] = 1.5338425964E+13 * exp( -0.692564 * lgt - 18654658.39 / rt );
	k[rCP22] = 1.0200000000E+10;
	k[rCP23f] = 2.0000000000E+13 * exp( -125520000 / rt );
	k[rCP23b] = 9.8598712442E+08 * exp( 0.103818 * lgt - 72608471.51 / rt );
	k[rCP24] = 1.0000000000E+12 * exp( -150620000 / rt );
	k[rCP25] = 6.6700000000E+09;
	k[rCP26] = 3.3300000000E+09;
	k[rCP27] = 1.6700000000E+09;
	k[rCP28] = 1.4300000000E-16 * exp( 7.6 * lgt + 14770000 / rt );
	k[rCP29] = 1.3300000000E+09;
	k[rCP30] = 1.2800000000E+04 * exp( 1.02 * lgt + 8510000 / rt );
	k[rCP31] = 3.3700000000E+44 * exp( -8 * lgt - 454700000 / rt );
	k[rCP32f] = 2.7400000000E+06 * exp( 1.46 * lgt - 5670000 / rt );
	k[rCP32b] = 1.0257136572E+12 * exp( 0.796263 * lgt - 220916454.1 / rt );
	k[rCP33f] = 1.0000000000E+10 * exp( -8370000 / rt );
	k[rCP33b] = 2.2459405120E+04 * exp( 1.12696 * lgt - 406300873.9 / rt );
	k[rCP34] = 7.8600000000E-04 * exp( 3.07 * lgt - 23970000 / rt );
	k[rI00f] = 1.0000000000E+10;
	k[rI00b] = 5.2485026204E+25 * exp( -2.03247 * lgt - 521300387.2 / rt );
	k[rI01f] = 1.7300000000E+68 * exp( -15.16 * lgt - 486900000 / rt );
	k[rI01b] = 1.8449825236E+63 * exp( -14.9678 * lgt - 147532832.2 / rt );
	k[rI02f] = 2.8000000000E+10 * exp( -9450000 / rt );
	k[rI02b] = 6.9663668743E+07 * exp( 0.540969 * lgt - 103156195.8 / rt );
	k[rI03f] = 3.1600000000E+01 * exp( 2.48 * lgt - 46280000 / rt );
	k[rI03b] = 4.5880603280E+08 * exp( 1.36023 * lgt - 103605736.2 / rt );
	k[rI05f] = 4.7700000000E+01 * exp( 2.71 * lgt - 4630000 / rt );
	k[rI05b] = 6.9607958996E-02 * exp( 3.21593 * lgt - 92570105.57 / rt );
	k[rI06f] = 3.0800000000E+03 * exp( 2 * lgt );
	k[rI06b] = 7.8697236255E+01 * exp( 2.44735 * lgt - 156414500.2 / rt );
	k[rI07f] = 1.0000000000E+11 * exp( -155440000 / rt );
	k[rI07b] = 1.5126405584E+09 * exp( 0.179262 * lgt - 20736180.96 / rt );
	k[rI08f] = 1.1000000000E+01 * exp( 2.6 * lgt - 53970000 / rt );
	k[rI08b] = 2.5186213693E+01 * exp( 2.38999 * lgt - 81341853.07 / rt );
	k[rI09f] = 1.8000000000E-04 * exp( 4 * lgt );
	k[rI09b] = 8.2296634648E-04 * exp( 4.0222 * lgt - 102619350.6 / rt );
	k[rI12] = 3.8300000000E+06 * exp( 0.88 * lgt - 4770000 / rt );
	k[rI15] = 1.8800000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	k[rI17] = 2.5600000000E+26 * exp( -4.03 * lgt - 147300000 / rt );
	k[rI18] = 1.9600000000E+28 * exp( -4.85 * lgt - 103650000 / rt );
	k[rI19f] = 2.8000000000E+10;
	k[rI19b] = 2.1780081605E+13 * exp( -0.525451 * lgt - 246670384.8 / rt );
	k[rI20f] = 1.7400000000E+04 * exp( 1.3 * lgt - 73920000 / rt );
	k[rI20b] = 2.6913158062E+04 * exp( 1.20951 * lgt - 250029253.6 / rt );
	k[rI21] = 1.2400000000E+10;
	k[rI22] = 4.0800000000E+09;
	k[rI23] = 4.3200000000E+36 * exp( -7.74 * lgt - 99800000 / rt );
	k[rI31] = 3.3700000000E+44 * exp( -8 * lgt - 454700000 / rt );
	k[rI32] = 1.3700000000E+06 * exp( 1.46 * lgt - 5670000 / rt );
	k[rT01f] = 2.3100000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rT01b] = 4.4820102636E-03 * exp( 3.57723 * lgt - 50936358.17 / rt );
	k[rT02f] = 1.5600000000E+13 * exp( 0.68 * lgt - 373240000 / rt );
	k[rT02b] = 1.2986502050E+10 * exp( 0.254459 * lgt + 1763440.913 / rt );
	k[rT03f] = 4.3500000000E+22 * exp( -1.73 * lgt - 436010000 / rt );
	k[rT03b] = 5.2773986505E+10 * exp( -0.111273 * lgt + 6505423.169 / rt );
	k[rT04f] = 5.8300000000E+64 * exp( -14.15 * lgt - 285890000 / rt );
	k[rT04b] = 8.4963346413E+55 * exp( -12.1057 * lgt - 218378017.7 / rt );
	k[rT05f] = 8.2000000000E+14 * exp( -337550000 / rt );
	k[rT05b] = 4.3614434871E+01 * exp( 2.2454 * lgt - 46091406.02 / rt );
	k[rT06f] = 2.1800000000E+04 * exp( 2.5 * lgt - 192650000 / rt );
	k[rT06b] = 2.5740303959E+04 * exp( 2.06155 * lgt - 22309907.82 / rt );
	k[rT07f] = 6.4700000000E-03 * exp( 3.98 * lgt - 14160000 / rt );
	k[rT07b] = 1.2565333739E-03 * exp( 3.90326 * lgt - 72229922.61 / rt );
	k[rT08f] = 1.7700000000E+02 * exp( 2.39 * lgt + 2520000 / rt );
	k[rT08b] = 3.5302337866E+02 * exp( 2.21964 * lgt - 118258227 / rt );
	k[rT09f] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rT09b] = 6.8369388406E-01 * exp( 2.76966 * lgt - 48452858.8 / rt );
	k[rT10f] = 3.1400000000E-02 * exp( 3.37 * lgt - 19750000 / rt );
	k[rT10b] = 1.7210570482E+04 * exp( 1.86503 * lgt - 21643114.7 / rt );
	k[rT11f] = 1.1800000000E-03 * exp( 4.09 * lgt - 10650000 / rt );
	k[rT11b] = 1.3441383262E-04 * exp( 3.97822 * lgt - 62953832.43 / rt );
	k[rT12f] = 1.6900000000E+09 * exp( 0.3 * lgt - 18420000 / rt );
	k[rT12b] = 1.2674962700E+17 * exp( -0.891202 * lgt - 447620388 / rt );
	k[rT13f] = 1.6600000000E+04 * exp( 1.8 * lgt - 16630000 / rt );
	k[rT13b] = 1.9399287458E+07 * exp( 0.787767 * lgt - 79387362.49 / rt );
	k[rT14f] = 4.2200000000E+11 * exp( -93120000 / rt );
	k[rT14b] = 1.5060641068E+14 * exp( -0.595515 * lgt - 160103077.4 / rt );
	k[rT15f] = 9.3300000000E+01 * exp( 2.5 * lgt - 61440000 / rt );
	k[rT15b] = 1.6675285524E+04 * exp( 1.67228 * lgt - 53175579.93 / rt );
	k[rT16f] = 7.9400000000E+10 * exp( -50000000 / rt );
	k[rT16b] = 1.0571054566E+14 * exp( -0.637038 * lgt - 151028340.4 / rt );
	k[rT17f] = 2.2800000000E+11;
	k[rT17b] = 8.0100757473E+17 * exp( -0.6588 * lgt - 335402917 / rt );
	k[rT18f] = 2.0000000000E+10;
	k[rT18b] = 4.8247335589E+17 * exp( -0.492206 * lgt - 341422792.2 / rt );
	k[rT19f] = 1.1900000000E+06 * exp( 1.03 * lgt + 9410000 / rt );
	k[rT19b] = 5.8610185036E+06 * exp( 0.819065 * lgt - 50768437.11 / rt );
	k[rT20] = 4.3200000000E+36 * exp( -7.74 * lgt - 99800000 / rt );
	k[rT21f] = 3.7600000000E+12 * exp( -1.55 * lgt - 47370000 / rt );
	k[rT21b] = 3.1822436227E+12 * exp( -1.51645 * lgt - 253641155 / rt );
	k[rT22f] = 6.2600000000E+34 * exp( -8.86 * lgt - 69380000 / rt );
	k[rT22b] = 2.6747811416E+32 * exp( -8.19414 * lgt - 329708198.2 / rt );
	kTroe0 = 4.6600000000E+35 * exp( -7.44 * lgt - 58910000 / rt );
	kTroeInf = 2.4300000000E+09 * exp( 0.52 * lgt - 210000 / rt );
	fcTroe = 0.3 * exp( -temp / 100 ) + 0.7 * exp( -temp / 90000 ) + 1 * exp( -10000 / temp );
	k[rT23f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	kTroe0 = 4.3784646437E+38 * exp( -6.95964 * lgt - 492237148.5 / rt );
	kTroeInf = 2.2831907906E+12 * exp( 1.00036 * lgt - 433537148.5 / rt );
	k[rT23b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rT24f] = 4.2000000000E+03 * exp( 2.1 * lgt - 20380000 / rt );
	k[rT24b] = 1.0428348047E+03 * exp( 1.96844 * lgt - 20126215 / rt );
	k[rT25f] = 1.3000000000E+02 * exp( 2.5 * lgt - 20920000 / rt );
	k[rT25b] = 1.8932230751E+01 * exp( 2.33341 * lgt - 14900124.81 / rt );
	k[rT26f] = 6.3000000000E+03 * exp( 2 * lgt - 6280000 / rt );
	k[rT26b] = 1.6064500624E+04 * exp( 1.77482 * lgt - 68734519.42 / rt );
	k[rT27f] = 1.0000000000E+04 * exp( 1.5 * lgt - 41590000 / rt );
	k[rT27b] = 4.5627585431E+06 * exp( 0.849667 * lgt - 50249369.82 / rt );
	k[rT28f] = 8.5500000000E+01 * exp( 2.19 * lgt - 160000 / rt );
	k[rT28b] = 9.8745294140E+02 * exp( 2.07772 * lgt - 106603252.2 / rt );
	k[rT29f] = 5.2600000000E+28 * exp( -5.08 * lgt - 93090000 / rt );
	k[rT29b] = 6.3725845392E+24 * exp( -4.82261 * lgt - 34519369.16 / rt );
	k[rT30f] = 7.2100000000E+33 * exp( -6.21 * lgt - 154180000 / rt );
	k[rT30b] = 4.1991617492E+20 * exp( -3.78987 * lgt - 40040180.59 / rt );
	k[rT31f] = 2.3700000000E+32 * exp( -6.1 * lgt - 120540000 / rt );
	k[rT31b] = 1.5941382341E+20 * exp( -3.79215 * lgt - 112843432.7 / rt );
	k[rT32f] = 1.3300000000E+10;
	k[rT32b] = 3.7590981019E+08 * exp( 0.606189 * lgt - 374502732.7 / rt );
	k[rT33f] = 6.6700000000E+09;
	k[rT33b] = 1.1057324691E+08 * exp( 0.571154 * lgt - 368736642.5 / rt );
	k[rT34f] = 3.3300000000E+09;
	k[rT34b] = 9.6657755389E+08 * exp( 0.512565 * lgt - 437211037.1 / rt );
	k[rT35f] = 2.8500000000E-16 * exp( 7.6 * lgt + 14770000 / rt );
	k[rT35b] = 4.8973857002E-17 * exp( 7.84448 * lgt - 131322717.9 / rt );
	k[rT36] = 2.1000000000E+16 * exp( -342000000 / rt );
	k[rT37] = 4.0900000000E+06 * exp( 1.16 * lgt - 10060000 / rt );
	k[rT38] = 5.8400000000E+09 * exp( -7570000 / rt );
	k[rT39] = 2.8900000000E+05 * exp( 1.35 * lgt + 6580000 / rt );
	k[rT40] = 1.2000000000E+02 * exp( 2.5 * lgt - 157130000 / rt );
	k[rT41] = 4.0900000000E+01 * exp( 2.5 * lgt - 42690000 / rt );
	k[rT42] = 3.4900000000E-11 * exp( 6.21 * lgt - 6820000 / rt );
	k[rT43f] = 1.0100000000E+71 * exp( -15.92 * lgt - 522120000 / rt );
	k[rT43b] = 1.5737620878E+66 * exp( -15.741 * lgt - 155676974.5 / rt );
	k[rT44f] = 1.1500000000E+11 * exp( -51870000 / rt );
	k[rT44b] = 4.1803986880E+08 * exp( 0.527769 * lgt - 118500338 / rt );
	k[rT45f] = 2.8100000000E+10 * exp( -30760000 / rt );
	k[rT45b] = 5.9912631081E+07 * exp( 0.492735 * lgt - 91624247.79 / rt );
	k[rT46f] = 2.9500000000E+03 * exp( 2 * lgt + 5490000 / rt );
	k[rT46b] = 1.1012916128E+02 * exp( 2.43415 * lgt - 123848642.4 / rt );
	k[rT47] = 2.9000000000E+10 * exp( -152400000 / rt );
	k[rT50f] = 8.3900000000E+60 * exp( -12.48 * lgt - 619590000 / rt );
	k[rT50b] = 5.9493864399E+54 * exp( -12.2592 * lgt - 143886133 / rt );
	k[rT51f] = 3.9100000000E+05 * exp( 1.8 * lgt - 68420000 / rt );
	k[rT51b] = 6.4682847912E+01 * exp( 2.36964 * lgt - 25789496.49 / rt );
	k[rT52f] = 2.6000000000E+10 * exp( -61500000 / rt );
	k[rT52b] = 2.5227716017E+06 * exp( 0.53461 * lgt - 13103406.31 / rt );
	k[rT53f] = 1.3600000000E+01 * exp( 2.69 * lgt - 2590000 / rt );
	k[rT53b] = 2.3105306687E-02 * exp( 3.16602 * lgt - 22667800.92 / rt );
	k[rT54f] = 1.7900000000E-05 * exp( 4.46 * lgt - 57060000 / rt );
	k[rT54b] = 5.4416006531E-06 * exp( 4.51087 * lgt - 23342651.31 / rt );
	k[rT55f] = 1.0000000000E+11;
	k[rT55b] = 1.6480389513E+20 * exp( -1.23308 * lgt - 538461229.5 / rt );
	k[rT56f] = 3.0000000000E+10;
	k[rT56b] = 3.6132196175E+17 * exp( -1.54684 * lgt - 111153956.2 / rt );
	k[rT57f] = 3.0000000000E+10;
	k[rT57b] = 6.9312742321E+13 * exp( -0.785212 * lgt - 263236749.6 / rt );
	k[rT58f] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rT58b] = 2.0524277087E+22 * exp( -3.38189 * lgt - 70672825.02 / rt );
	k[rT59] = 2.5500000000E+10 * exp( -0.44 * lgt + 6900000 / rt );
	k[rT60] = 2.5500000000E+10 * exp( -0.44 * lgt + 6900000 / rt );
	k[rE01f] = 3.6100000000E+10;
	k[rE01b] = 9.7891110020E+17 * exp( -0.723732 * lgt - 430033992.4 / rt );
	k[rE02f] = 2.0000000000E+10;
	k[rE02b] = 3.0096212144E+21 * exp( -1.4418 * lgt - 329900840.3 / rt );
	k[rE03f] = 2.0000000000E+10;
	k[rE03b] = 1.1999372607E+25 * exp( -2.29587 * lgt - 434547961.2 / rt );
	k[rE04f] = 2.3100000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rE04b] = 6.1576309766E-06 * exp( 4.25437 * lgt - 58903820.16 / rt );
	k[rE05f] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rE05b] = 9.3929607283E-04 * exp( 3.4468 * lgt - 56420320.79 / rt );
	k[rE06f] = 4.8300000000E-05 * exp( 4.71 * lgt - 25990000 / rt );
	k[rE06b] = 4.1554038409E-10 * exp( 5.78253 * lgt - 29029371.1 / rt );
	k[rE07f] = 1.9600000000E-03 * exp( 4.09 * lgt - 10650000 / rt );
	k[rE07b] = 9.8904120951E-09 * exp( 5.1275 * lgt - 7923280.916 / rt );
	k[rE08f] = 4.4700000000E+03 * exp( 2.01 * lgt - 1530000 / rt );
	k[rE08b] = 3.9494269248E-01 * exp( 2.98891 * lgt - 67277675.53 / rt );
	k[rE09f] = 8.0300000000E+00 * exp( 2.6 * lgt - 58200000 / rt );
	k[rE09b] = 6.3577513555E-02 * exp( 2.92155 * lgt + 5094971.583 / rt );
	k[rE10f] = 7.5300000000E-04 * exp( 3.65 * lgt - 29930000 / rt );
	k[rE10b] = 1.1904806541E-05 * exp( 4.20376 * lgt - 41882525.92 / rt );
	k[rE11f] = 1.7200000000E+11 * exp( 0.78 * lgt - 161940000 / rt );
	k[rE11b] = 4.2169346325E+00 * exp( 2.47345 * lgt - 6105276.279 / rt );
	k[rE12f] = 3.7900000000E+06 * exp( 2.08 * lgt - 134330000 / rt );
	k[rE12b] = 1.0739437552E+04 * exp( 1.84471 * lgt - 9686488.018 / rt );
	k[rE13f] = 1.6700000000E+09;
	k[rE13b] = 1.1039793641E+09 * exp( 0.113509 * lgt - 308429851.5 / rt );
	k[rE14f] = 2.4100000000E+10;
	k[rE14b] = 1.6361457188E+11 * exp( 0.0198847 * lgt - 371138156 / rt );
	k[rE15f] = 3.3100000000E+09 * exp( 3220000 / rt );
	k[rE15b] = 4.0209968984E+12 * exp( -0.405265 * lgt - 314123006.4 / rt );
	k[rE16f] = 3.7000000000E+13 * exp( -1.63 * lgt - 14300000 / rt );
	k[rE16b] = 1.4870776226E+14 * exp( -1.8782 * lgt - 94319836.75 / rt );
	k[rE17f] = 3.1700000000E+10 * exp( 0.03 * lgt + 1650000 / rt );
	k[rE17b] = 8.0200953199E+08 * exp( 0.465129 * lgt - 387258232 / rt );
	k[rE18f] = 3.1700000000E+10 * exp( 0.03 * lgt + 1650000 / rt );
	k[rE18b] = 2.4313367079E+09 * exp( 0.346652 * lgt - 375315438.3 / rt );
	k[rE19] = 7.0000000000E+09 * exp( 4180000 / rt );
	k[rE30] = 4.8200000000E+33 * exp( -8.23 * lgt - 21620000 / rt );
	k[rE31] = 3.8800000000E+01 * exp( 1.84 * lgt + 2420000 / rt );
	k[rE32] = 1.2100000000E+45 * exp( -10.15 * lgt - 170770000 / rt );
	k[rE33] = 2.4500000000E+25 * exp( -4.48 * lgt - 136430000 / rt );
	k[rE34] = 1.2300000000E+13 * exp( -1.12 * lgt - 113030000 / rt );
	k[rE35] = 5.4500000000E-02 * exp( 3.57 * lgt - 67350000 / rt );
	k[rE36] = 1.0000000000E+08;
	k[rE37] = 6.3000000000E+14 * exp( -180100000 / rt );
	k[rST01] = 2.4000000000E+14 * exp( -326900000 / rt );
	k[rST02f] = 5.1000000000E+04 * exp( 1.66 * lgt - 2750000 / rt );
	k[rST02b] = 3.2882754328E+00 * exp( 2.42964 * lgt - 146713214.8 / rt );
	k[rST03f] = 1.1400000000E+02 * exp( 2 * lgt - 38490000 / rt );
	k[rST03b] = 3.0178171755E+02 * exp( 1.94272 * lgt - 14154671.17 / rt );
	k[rST04f] = 1.8800000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	k[rST04b] = 3.7188357721E+32 * exp( -7.56182 * lgt - 103841676.9 / rt );
	k[rST05f] = 1.8800000000E+33 * exp( -7.8 * lgt - 29540000 / rt );
	k[rST05b] = 1.2267086362E+32 * exp( -7.44334 * lgt - 115784470.6 / rt );
	k[rST06f] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rST06b] = 8.8911775253E-03 * exp( 3.2153 * lgt + 6725309.257 / rt );
	k[rST10f] = 1.3300000000E+10 * exp( -61500000 / rt );
	k[rST10b] = 2.6187006539E+06 * exp( 0.533908 * lgt - 5104404.95 / rt );
	k[rST11f] = 1.0300000000E+10 * exp( 0.21 * lgt + 1790000 / rt );
	k[rST11b] = 2.0850645483E+07 * exp( 1.0994 * lgt - 542745477.2 / rt );
	k[rST12f] = 6.7000000000E+02 * exp( 1.61 * lgt + 1610000 / rt );
	k[rST12b] = 5.5513158673E+01 * exp( 1.89788 * lgt - 71644724.18 / rt );
	k[rST13] = 3.0300000000E+08 * exp( 0.29 * lgt - 50000 / rt );
	k[rST14f] = 4.5800000000E+13 * exp( -1.39 * lgt - 4250000 / rt );
	k[rST14b] = 2.9579446638E+12 * exp( -1.01328 * lgt - 393498943.6 / rt );
	k[rST00f] = 1.0000000000E+10;
	k[rST00b] = 7.2340731681E+07 * exp( 0.771407 * lgt - 83837426.03 / rt );
	k[rXY00f] = 2.5000000000E+18 * exp( -0.6 * lgt - 396590000 / rt );
	k[rXY00b] = 1.0584848633E+15 * exp( -1.02266 * lgt - 21983285.59 / rt );
	k[rXY01f] = 4.3200000000E+29 * exp( -3.58 * lgt - 460930000 / rt );
	k[rXY01b] = 2.4885817320E+17 * exp( -1.95607 * lgt - 18728819.02 / rt );
	k[rXY02f] = 1.2900000000E-02 * exp( 3.98 * lgt - 14160000 / rt );
	k[rXY02b] = 1.2741968022E-03 * exp( 3.90614 * lgt - 72626649.11 / rt );
	k[rXY03f] = 2.3600000000E-03 * exp( 4.09 * lgt - 10650000 / rt );
	k[rXY03b] = 1.3672597006E-04 * exp( 3.98111 * lgt - 63350558.93 / rt );
	k[rXY04f] = 3.5400000000E+02 * exp( 2.39 * lgt + 2520000 / rt );
	k[rXY04b] = 3.5909595731E+02 * exp( 2.22252 * lgt - 118654953.5 / rt );
	k[rXY05f] = 4.3600000000E+04 * exp( 2.5 * lgt - 192650000 / rt );
	k[rXY05b] = 2.6183079225E+04 * exp( 2.06443 * lgt - 22706634.32 / rt );
	k[rXY06f] = 1.8700000000E+02 * exp( 2.5 * lgt - 61440000 / rt );
	k[rXY06b] = 1.6998488070E+04 * exp( 1.67516 * lgt - 53572306.43 / rt );
	k[rXY07f] = 8.4400000000E+11 * exp( -93120000 / rt );
	k[rXY07b] = 1.5319708690E+14 * exp( -0.592634 * lgt - 160499803.9 / rt );
	k[rXY09f] = 4.6200000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rXY09b] = 3.7531845431E-03 * exp( 3.57309 * lgt - 50922686.05 / rt );
	k[rXY10f] = 1.5700000000E+00 * exp( 2.88 * lgt - 13480000 / rt );
	k[rXY10b] = 6.9907410294E-01 * exp( 2.77812 * lgt - 48875800.75 / rt );
	k[rXY11] = 1.8200000000E+05 * exp( 1.55 * lgt - 12930000 / rt );
	k[rXY12] = 8.2000000000E+14 * exp( -337550000 / rt );
	k[rXY13f] = 5.8300000000E+64 * exp( -14.15 * lgt - 285890000 / rt );
	k[rXY13b] = 7.9321711003E+55 * exp( -12.1034 * lgt - 218295533.4 / rt );
	k[rXY14f] = 4.3700000000E+15 * exp( -1.34 * lgt - 6660000 / rt );
	k[rXY14b] = 2.3757277888E+18 * exp( -1.74104 * lgt - 283859870.9 / rt );
	k[rXY15f] = 5.9900000000E+20 * exp( -2.47 * lgt - 67750000 / rt );
	k[rXY15b] = 1.1442380922E+14 * exp( -0.706342 * lgt - 288930613.3 / rt );
	k[rXY16f] = 1.9700000000E+19 * exp( -2.36 * lgt - 34110000 / rt );
	k[rXY16b] = 3.8323543459E+13 * exp( -0.717967 * lgt - 361405951.1 / rt );
	k[rXY17] = 2.0000000000E+10;
	k[rXY18f] = 1.3800000000E-01 * exp( 2.42 * lgt - 31130000 / rt );
	k[rXY18b] = 1.4917919852E-01 * exp( 2.45392 * lgt - 237768739.7 / rt );
	k[rXY19f] = 6.5700000000E+00 * exp( 1.87 * lgt - 20930000 / rt );
	k[rXY19b] = 3.0056748401E-02 * exp( 2.52177 * lgt - 282703438.3 / rt );
	k[rXY201] = 2.2800000000E+10 * exp( -0.31 * lgt + 2750000 / rt );
	k[rXY202] = 3.1300000000E+15 * exp( -1.44 * lgt - 58340000 / rt );
	k[rXY203] = 1.0300000000E+14 * exp( -1.33 * lgt - 24700000 / rt );
	k[rXY22] = 4.3200000000E+36 * exp( -7.74 * lgt - 99800000 / rt );
	k[rXY23f] = 1.2500000000E+18 * exp( -0.6 * lgt - 396590000 / rt );
	k[rXY23b] = 1.0731519576E+15 * exp( -1.02766 * lgt - 19452677.75 / rt );
	k[rXY24] = 2.1600000000E+29 * exp( -3.58 * lgt - 460930000 / rt );
	k[rXY25] = 2.1000000000E+16 * exp( -342000000 / rt );
	k[rXY26f] = 6.4700000000E-03 * exp( 3.98 * lgt - 14160000 / rt );
	k[rXY26b] = 1.2958586951E-03 * exp( 3.90114 * lgt - 70096041.28 / rt );
	k[rXY27f] = 1.1800000000E-03 * exp( 4.09 * lgt - 10650000 / rt );
	k[rXY27b] = 1.3862053915E-04 * exp( 3.9761 * lgt - 60819951.09 / rt );
	k[rXY28f] = 1.7700000000E+02 * exp( 2.39 * lgt + 2520000 / rt );
	k[rXY28b] = 3.6407183790E+02 * exp( 2.21751 * lgt - 116124345.7 / rt );
	k[rXY29f] = 2.1800000000E+04 * exp( 2.5 * lgt - 192650000 / rt );
	k[rXY29b] = 2.6545889980E+04 * exp( 2.05943 * lgt - 20176026.48 / rt );
	k[rXY30f] = 9.3300000000E+01 * exp( 2.5 * lgt - 61440000 / rt );
	k[rXY30b] = 1.7197166576E+04 * exp( 1.67015 * lgt - 51041698.59 / rt );
	k[rXY31f] = 4.2200000000E+11 * exp( -93120000 / rt );
	k[rXY31b] = 1.5531989112E+14 * exp( -0.597639 * lgt - 157969196.1 / rt );
	k[rXY33] = 4.0900000000E+06 * exp( 1.16 * lgt - 10060000 / rt );
	k[rXY34] = 5.8400000000E+09 * exp( -7570000 / rt );
	k[rXY35] = 2.8900000000E+05 * exp( 1.35 * lgt + 6580000 / rt );
	k[rXY36] = 1.2000000000E+02 * exp( 2.5 * lgt - 157130000 / rt );
	k[rXY37] = 4.0900000000E+01 * exp( 2.5 * lgt - 42690000 / rt );
	k[rXY38] = 3.4900000000E-11 * exp( 6.21 * lgt - 6820000 / rt );
	k[rXY39f] = 2.3100000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rXY39b] = 8.2660146550E-06 * exp( 4.21307 * lgt - 67516080.26 / rt );
	k[rXY40f] = 2.3100000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rXY40b] = 2.8887454010E-03 * exp( 3.56984 * lgt - 50158374.84 / rt );
	k[rXY41f] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rXY41b] = 1.5357183416E-03 * exp( 3.41811 * lgt - 65469194.96 / rt );
	k[rXY42] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rXY43f] = 4.3700000000E+15 * exp( -1.34 * lgt - 6660000 / rt );
	k[rXY43b] = 4.9836580785E+18 * exp( -1.77587 * lgt - 280931537.4 / rt );
	k[rXY44] = 5.9900000000E+20 * exp( -2.47 * lgt - 67750000 / rt );
	k[rXY45f] = 1.9700000000E+19 * exp( -2.36 * lgt - 34110000 / rt );
	k[rXY45b] = 2.9093665114E+13 * exp( -0.716213 * lgt - 363172247.8 / rt );
	k[rXY46] = 2.0000000000E+10;
	k[rXY47f] = 1.3800000000E-01 * exp( 2.42 * lgt - 31980000 / rt );
	k[rXY47b] = 3.1293910075E-01 * exp( 2.41908 * lgt - 235690406.2 / rt );
	k[rXY48] = 1.1900000000E+06 * exp( 1.03 * lgt + 9410000 / rt );
	k[rXY50] = 4.2000000000E+16 * exp( -342000000 / rt );
	k[rXY51] = 8.1800000000E+06 * exp( 1.16 * lgt - 10060000 / rt );
	k[rXY52] = 1.1700000000E+10 * exp( -7570000 / rt );
	k[rXY53] = 5.7800000000E+05 * exp( 1.35 * lgt + 6580000 / rt );
	k[rXY54] = 2.4000000000E+02 * exp( 2.5 * lgt - 157130000 / rt );
	k[rXY55] = 8.1800000000E+01 * exp( 2.5 * lgt - 42690000 / rt );
	k[rXY56] = 6.9800000000E-11 * exp( 6.21 * lgt - 6820000 / rt );
	k[rXY57f] = 4.6200000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rXY57b] = 5.9828399303E-06 * exp( 4.24966 * lgt - 72210710.39 / rt );
	k[rXY58] = 1.5700000000E+00 * exp( 2.88 * lgt - 13480000 / rt );
	k[rN01f] = 2.3100000000E+03 * exp( 2.17 * lgt - 17420000 / rt );
	k[rN01b] = 2.5952295683E-05 * exp( 4.14699 * lgt - 50392663.12 / rt );
	k[rN02f] = 7.8300000000E-01 * exp( 2.88 * lgt - 13480000 / rt );
	k[rN02b] = 1.0967302857E-03 * exp( 3.74052 * lgt - 49438848.61 / rt );
	k[rN04f] = 1.2500000000E+18 * exp( -0.6 * lgt - 396590000 / rt );
	k[rN04b] = 7.7463001274E+12 * exp( -0.435322 * lgt - 9868756.914 / rt );
	k[rN05f] = 3.2000000000E+34 * exp( -5.02 * lgt - 478030000 / rt );
	k[rN05b] = 2.7785868184E+20 * exp( -2.80977 * lgt - 12814647.68 / rt );
	k[rN06f] = 5.8300000000E+64 * exp( -14.15 * lgt - 285890000 / rt );
	k[rN06b] = 8.1687995828E+55 * exp( -12.1044 * lgt - 207395890.8 / rt );
	k[rN07f] = 8.2000000000E+14 * exp( -337550000 / rt );
	k[rN07b] = 6.5241355800E+02 * exp( 1.84259 * lgt - 103227017.7 / rt );
	k[rN08f] = 6.4700000000E-03 * exp( 3.98 * lgt - 14160000 / rt );
	k[rN08b] = 9.3538573948E-06 * exp( 4.49348 * lgt - 60512120.44 / rt );
	k[rN09f] = 1.1800000000E-03 * exp( 4.09 * lgt - 10650000 / rt );
	k[rN09b] = 1.0006004205E-06 * exp( 4.56844 * lgt - 51236030.25 / rt );
	k[rN10f] = 1.7700000000E+02 * exp( 2.39 * lgt + 2520000 / rt );
	k[rN10b] = 2.6279686713E+00 * exp( 2.80985 * lgt - 106540424.9 / rt );
	k[rN11f] = 2.1800000000E+04 * exp( 2.5 * lgt - 192650000 / rt );
	k[rN11b] = 1.9161539004E+02 * exp( 2.65177 * lgt - 10592105.65 / rt );
	k[rN12f] = 4.2200000000E+11 * exp( -93120000 / rt );
	k[rN12b] = 1.1211408447E+12 * exp( -0.00529554 * lgt - 148385275.3 / rt );
	k[rN13f] = 9.3300000000E+01 * exp( 2.5 * lgt - 61440000 / rt );
	k[rN13b] = 1.2413378431E+02 * exp( 2.2625 * lgt - 41457777.75 / rt );
	k[rN14] = 1.1000000000E+10 * exp( -18960000 / rt );
	k[rN15] = 1.4700000000E+10 * exp( -18960000 / rt );
	k[rN16f] = 2.2800000000E+11;
	k[rN16b] = 1.0052196131E+18 * exp( -0.655882 * lgt - 318374553.9 / rt );
	k[rN17] = 2.0000000000E+10;
	k[rN18f] = 1.1900000000E+06 * exp( 1.03 * lgt + 9410000 / rt );
	k[rN18b] = 7.3552497358E+06 * exp( 0.821983 * lgt - 33740074.02 / rt );
	k[rN19] = 4.3200000000E+36 * exp( -7.74 * lgt - 99800000 / rt );
	k[rN20f] = 3.7600000000E+12 * exp( -1.55 * lgt - 47370000 / rt );
	k[rN20b] = 1.7159707068E+14 * exp( -1.93741 * lgt - 261565117.8 / rt );
	k[rN21f] = 3.0800000000E+06 * exp( 0.37 * lgt - 70750000 / rt );
	k[rN21b] = 1.9552148774E+03 * exp( 1.33906 * lgt - 347371636.2 / rt );
	k[rN22f] = 5.2600000000E+28 * exp( -5.08 * lgt - 93090000 / rt );
	k[rN22b] = 2.7382161014E+26 * exp( -5.24648 * lgt - 59471695 / rt );
	k[rN23f] = 7.2100000000E+33 * exp( -6.21 * lgt - 154180000 / rt );
	k[rN23b] = 3.2171025483E+20 * exp( -3.7915 * lgt - 46086416.7 / rt );
	k[rN24f] = 1.3300000000E+10;
	k[rN24b] = 1.6152352136E+10 * exp( 0.182318 * lgt - 399455058.5 / rt );
	k[rN25f] = 6.6700000000E+09;
	k[rN25b] = 4.7511875788E+09 * exp( 0.147283 * lgt - 393688968.3 / rt );
	k[rN26f] = 3.3300000000E+09;
	k[rN26b] = 4.1532571362E+10 * exp( 0.0886938 * lgt - 462163363 / rt );
	k[rN27f] = 2.8500000000E-16 * exp( 7.6 * lgt + 14770000 / rt );
	k[rN27b] = 2.1043424841E-15 * exp( 7.42061 * lgt - 156275043.7 / rt );
	k[rN28] = 2.1000000000E+16 * exp( -342000000 / rt );
	k[rN29] = 4.0900000000E+06 * exp( 1.16 * lgt - 10060000 / rt );
	k[rN30] = 5.8400000000E+09 * exp( -7570000 / rt );
	k[rN31] = 2.8900000000E+05 * exp( 1.35 * lgt + 6580000 / rt );
	k[rN32] = 1.2000000000E+02 * exp( 2.5 * lgt - 157130000 / rt );
	k[rN33] = 4.0900000000E+01 * exp( 2.5 * lgt - 42690000 / rt );
	k[rN34] = 3.4900000000E-11 * exp( 6.21 * lgt - 6820000 / rt );
	k[rOX00f] = 1.2900000000E+61 * exp( -12.48 * lgt - 619590000 / rt );
	k[rOX00b] = 8.0660235973E+54 * exp( -12.2685 * lgt - 143558218.7 / rt );
	kTroe0 = 1.0000000000E+81 * exp( -18.87 * lgt - 376980000 / rt );
	kTroeInf = 4.3000000000E+12 * exp( 0.62 * lgt - 323430000 / rt );
	fcTroe = 0.098 * exp( -temp / 696 ) + 0.902 * exp( -temp / 358 ) + 1 * exp( -3856 / temp );
	k[rOX01f] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	kTroe0 = 4.2026355221E+75 * exp( -18.4977 * lgt - 50925964.37 / rt );
	kTroeInf = 1.8071332745E+07 * exp( 0.992264 * lgt + 2624035.634 / rt );
	k[rOX01b] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, M[mM3] );
	k[rOX02f] = 5.0000000000E+75 * exp( -19.31 * lgt - 284180000 / rt );
	k[rOX02b] = 2.7802587455E+86 * exp( -20.3484 * lgt - 537844017.3 / rt );
	k[rOX03f] = 6.0200000000E+05 * exp( 1.8 * lgt - 68420000 / rt );
	k[rOX03b] = 8.7814943551E+01 * exp( 2.3603 * lgt - 25461582.19 / rt );
	k[rOX04f] = 2.3400000000E+01 * exp( 2.68 * lgt - 3070000 / rt );
	k[rOX04b] = 3.5054860727E-02 * exp( 3.14667 * lgt - 22819886.61 / rt );
	k[rOX05f] = 1.3200000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX05b] = 5.9403631765E+04 * exp( 1.73243 * lgt - 24846500.63 / rt );
	k[rOX06f] = 4.3400000000E+11 * exp( -269000000 / rt );
	k[rOX06b] = 3.8490104908E+08 * exp( 0.19859 * lgt + 2368432.605 / rt );
	k[rOX99f] = 2.7400000000E+05 * exp( 1.55 * lgt - 12930000 / rt );
	k[rOX99b] = 2.4619859479E+08 * exp( 0.54483 * lgt - 73831723.77 / rt );
	k[rOX07f] = 1.9900000000E+04 * exp( 1.8 * lgt - 16630000 / rt );
	k[rOX07b] = 1.7880846848E+07 * exp( 0.79483 * lgt - 77531723.77 / rt );
	k[rOX08f] = 2.0300000000E+09 * exp( 0.3 * lgt - 18420000 / rt );
	k[rOX08b] = 1.2500560065E+17 * exp( -0.903806 * lgt - 447183774 / rt );
	k[rOX09f] = 5.8000000000E+13 * exp( -0.77 * lgt - 63980000 / rt );
	k[rOX09b] = 7.5724507824E+08 * exp( 0.100471 * lgt - 368646648 / rt );
	k[rOX10f] = 4.0000000000E+10 * exp( -61500000 / rt );
	k[rOX10b] = 3.4223477473E+06 * exp( 0.525263 * lgt - 12775492 / rt );
	k[rOX11f] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX11b] = 1.7896397866E+22 * exp( -3.36548 * lgt - 69145100.61 / rt );
	k[rOX12f] = 3.0000000000E+10 * exp( -37580000 / rt );
	k[rOX12b] = 5.2188245827E+17 * exp( -1.69733 * lgt - 249952673.3 / rt );
	k[rOX13f] = 1.0000000000E+11;
	k[rOX13b] = 1.4370279961E+20 * exp( -1.21667 * lgt - 536933505.1 / rt );
	k[rOX14f] = 3.0000000000E+10;
	k[rOX14b] = 3.1505916423E+17 * exp( -1.53043 * lgt - 109626231.8 / rt );
	k[rOX15f] = 3.0000000000E+10;
	k[rOX15b] = 6.0438105008E+13 * exp( -0.768803 * lgt - 261709025.2 / rt );
	k[rOX16f] = 3.8900000000E-06 * exp( 4.57 * lgt - 22000000 / rt );
	k[rOX16b] = 1.4511636996E-05 * exp( 4.52848 * lgt - 56045263 / rt );
	k[rOX17f] = 6.5900000000E+15 * exp( -0.61 * lgt - 310110000 / rt );
	k[rOX17b] = 1.3972060163E+03 * exp( 1.46428 * lgt - 186012874.1 / rt );
	k[rOX18f] = 1.0100000000E+71 * exp( -15.92 * lgt - 522120000 / rt );
	k[rOX18b] = 1.4737470456E+66 * exp( -15.7214 * lgt - 154257949.8 / rt );
	k[rOX19f] = 6.8300000000E-02 * exp( 3.4 * lgt - 30260000 / rt );
	k[rOX19b] = 2.3250079098E-04 * exp( 3.94744 * lgt - 95471313.33 / rt );
	k[rOX20f] = 1.7300000000E-02 * exp( 3.4 * lgt + 4780000 / rt );
	k[rOX20b] = 6.0479791809E-04 * exp( 3.85381 * lgt - 123139617.8 / rt );
	k[rOX21f] = 3.7000000000E-07 * exp( 4.7 * lgt - 20200000 / rt );
	k[rOX21b] = 2.3145507889E-06 * exp( 4.72866 * lgt - 94324468.15 / rt );
	k[rOX22f] = 7.3200000000E+10 * exp( -173220000 / rt );
	k[rOX22b] = 1.5149637533E+09 * exp( 0.185728 * lgt - 10021298.54 / rt );
	k[rOX23f] = 2.9000000000E+10 * exp( -152400000 / rt );
	k[rOX23b] = 1.8592380137E-04 * exp( 2.57168 * lgt - 46699482.58 / rt );
	k[rOX24f] = 6.3400000000E+10 * exp( 0.03 * lgt + 1650000 / rt );
	k[rOX24b] = 5.2814831459E+13 * exp( -0.571852 * lgt - 171657572.7 / rt );
	k[rOX25f] = 6.5100000000E+04 * exp( 1.3 * lgt - 73920000 / rt );
	k[rOX25b] = 1.0783545407E+05 * exp( 1.13311 * lgt - 176666441.5 / rt );
	k[rOX26f] = 7.4000000000E+11 * exp( -246860000 / rt );
	k[rOX26b] = 9.9091879382E-02 * exp( 2.13692 * lgt - 208819519.7 / rt );
	k[rOX27f] = 4.3000000000E+06 * exp( 1.45 * lgt - 16180000 / rt );
	k[rOX27b] = 2.1555116600E-01 * exp( 2.92318 * lgt - 193385973.8 / rt );
	k[rOX28] = 3.0000000000E+10 * exp( -20920000 / rt );
	k[rOX30f] = 1.8300000000E+10 * exp( -18950000 / rt );
	k[rOX30b] = 3.1407237352E+12 * exp( -0.681513 * lgt - 84971054.68 / rt );
	k[rOX31f] = 1.8300000000E+10 * exp( -18950000 / rt );
	k[rOX31b] = 3.1219053405E+17 * exp( -0.802706 * lgt - 449243458.8 / rt );
	k[rOX32f] = 2.2000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX32b] = 2.7428177703E+04 * exp( 2.13353 * lgt - 26376185.49 / rt );
	k[rOX33f] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX33b] = 2.7654693660E+21 * exp( -3.06357 * lgt - 96420665.62 / rt );
	k[rOX34f] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX34b] = 2.4376382025E+21 * exp( -3.04777 * lgt - 95129408.91 / rt );
	k[rOX35] = 3.0000000000E+10 * exp( -37580000 / rt );
	k[rOX36] = 3.0000000000E+10 * exp( -37580000 / rt );
	k[rOX37f] = 1.0000000000E+11;
	k[rOX37b] = 2.2205903841E+19 * exp( -0.914757 * lgt - 564209070.1 / rt );
	k[rOX38f] = 1.0000000000E+11;
	k[rOX38b] = 1.9573516232E+19 * exp( -0.898966 * lgt - 562917813.4 / rt );
	k[rOX39f] = 3.0000000000E+10;
	k[rOX39b] = 4.8685018832E+16 * exp( -1.22852 * lgt - 136901796.8 / rt );
	k[rOX40f] = 3.0000000000E+10;
	k[rOX40b] = 4.2913677966E+16 * exp( -1.21273 * lgt - 135610540.1 / rt );
	k[rOX41f] = 8.6200000000E+15 * exp( -0.61 * lgt - 310110000 / rt );
	k[rOX41b] = 5.2489324223E+03 * exp( 1.18469 * lgt - 220346419.8 / rt );
	k[rOX42f] = 1.0100000000E+71 * exp( -15.92 * lgt - 522120000 / rt );
	k[rOX42b] = 1.0160881342E+66 * exp( -15.7988 * lgt - 157847595.9 / rt );
	k[rOX43f] = 6.8300000000E-02 * exp( 3.4 * lgt - 30260000 / rt );
	k[rOX43b] = 1.6029975810E-04 * exp( 3.86999 * lgt - 99060959.38 / rt );
	k[rOX44f] = 1.7300000000E-02 * exp( 3.4 * lgt + 4780000 / rt );
	k[rOX44b] = 4.1698335546E-04 * exp( 3.77637 * lgt - 126729263.8 / rt );
	k[rOX45f] = 3.7000000000E-07 * exp( 4.7 * lgt - 20200000 / rt );
	k[rOX45b] = 1.5957878251E-06 * exp( 4.65122 * lgt - 97914114.2 / rt );
	k[rOX46f] = 2.9000000000E+10 * exp( -152400000 / rt );
	k[rOX46b] = 1.8719655889E-02 * exp( 1.86567 * lgt - 87541656.19 / rt );
	k[rOX47] = 1.6800000000E+11;
	k[rOX48] = 6.5100000000E+04 * exp( 1.3 * lgt - 73920000 / rt );
	k[rOX50] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX51] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX52] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX53] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX54] = 8.5700000000E+17 * exp( -2.27 * lgt - 30080000 / rt );
	k[rOX60] = 1.1000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX61] = 1.1000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX62] = 2.2000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX63] = 1.7600000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX64] = 2.2000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX65] = 2.2000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	k[rOX66] = 2.2000000000E-01 * exp( 3.25 * lgt - 23390000 / rt );
	...
	cdot[sO] = - w[r3f] + w[r3b] + w[r5f] - w[r5b]
		+ w[r1f] - w[r1b] - w[r18] + w[rG09]
		+ w[rG20] - w[rG15] - w[rG52] - w[rG53]
		- w[r27] - w[rG46] - w[rG116] - w[rG117]
		+ w[rLPG134] - w[rLPG131] - w[rG158] - w[rG159]
		- w[rLPG157] - w[rG110] - w[rLPG138] + w[rLPR133]
		- w[rLPLPR113] - w[rR143] - w[rLPR142] - w[rLPHP54]
		- w[rLPHP52] - w[rLPHP53] - w[rDD424] - w[rCP05f]
		+ w[rCP05b] - w[rCP12f] + w[rCP12b] - w[rCP13]
		- w[rCP19f] + w[rCP19b] - w[rCP26] - w[rCP33f]
		+ w[rCP33b] - w[rI05f] + w[rI05b] - w[rI12]
		- w[rI19f] + w[rI19b] - w[rT11f] + w[rT11b]
		- w[rT12f] + w[rT12b] - w[rT13f] + w[rT13b]
		- w[rT17f] + w[rT17b] - w[rT25f] + w[rT25b]
		- w[rT33f] + w[rT33b] - w[rT38] - w[rT45f]
		+ w[rT45b] - w[rT52f] + w[rT52b] - w[rT55f]
		...
		+ w[rN09b] - w[rN14] - w[rN15] - w[rN16f]
		+ w[rN16b] - w[rN25f] + w[rN25b] - w[rN30]
		- w[rOX99f] + w[rOX99b] - w[rOX07f] + w[rOX07b]
		- w[rOX08f] + w[rOX08b] - w[rOX09f] + w[rOX09b]
		- w[rOX10f] + w[rOX10b] + w[rOX11f] - w[rOX11b]
		- w[rOX13f] + w[rOX13b] - w[rOX24f] + w[rOX24b]
		- w[rOX28] - w[rOX30f] + w[rOX30b] - w[rOX31f]
		+ w[rOX31b] + w[rOX33f] - w[rOX33b] + w[rOX34f]
		- w[rOX34b] - w[rOX37f] + w[rOX37b] - w[rOX38f]
		+ w[rOX38b] - w[rOX47];

	cdot[sH2] = - w[r3f] + w[r3b] - w[r4f] + w[r4b]
		+ w[r16] - w[rG06f] + w[rG06b] - w[rG34f]
		+ w[rG34b] + w[rG53] + w[r32] + w[rG45]
		+ w[rDD50] + w[rG130] + w[rG156] + w[rLPG123f]
		...
		- w[rK420b] + w[rK423f] - w[rK423b] + w[rP504f]
		- w[rP504b] + w[rK507f] - w[rK507b] + w[rK602f]
		- w[rK602b] + w[rP800] + w[rP801] + w[rP802]
		+ w[rCP02f] - w[rCP02b] + w[rCP25] + w[rCP29]
		+ w[rI02f] - w[rI02b] + w[rT07f] - w[rT07b]
		+ w[rT24f] - w[rT24b] + w[rT32f] - w[rT32b]
		+ w[rT37] + w[rT44f] - w[rT44b] + w[rT51f]
		- w[rT51b] + w[rE06f] - w[rE06b] + w[rE13f]
		- w[rE13b] + w[rXY02f] - w[rXY02b] + w[rXY17]
		+ w[rXY26f] - w[rXY26b] + w[rXY33] + w[rXY46]
		+ w[rN08f] - w[rN08b] + w[rN24f] - w[rN24b]
		+ w[rN29] + w[rOX03f] - w[rOX03b] + w[rOX19f]
		- w[rOX19b] + w[rOX43f] - w[rOX43b];

	cdot[sH] = w[r3f] - w[r3b] + w[r4f] - w[r4b]
		- w[r1f] + w[r1b] - w[r15f] + w[r15b]
		- w[r16] - w[r17] - w[r23] + w[rG06f]
		- w[rG06b] + w[rG08] - w[rG14] + 2 * w[rG19]
		+ w[rG15] + w[rG16] + w[rG21] + w[rG35]
		+ w[rG34f] - w[rG34b] + w[rG52] + w[rG53]
		+ w[rG72] + w[rG74f] - w[rG74b] + w[r29]
		+ w[r28f] - w[r28b] + w[r36f] - w[r36b]
		- w[r32] - w[rG45] + w[rLPG44] + w[rDD44]
		- w[rDD50] + w[rDD50] + w[rDD52] + w[rLPDD59]
		- w[rG115f] + w[rG115b] + w[rG116] + w[rLPG120f]
		- w[rLPG120b] - w[rG130] + w[rLPG157] - w[rG156]
		- w[rG155f] + w[rG155b] - w[rG109] + w[rG110]
		- w[rLPG124] - w[rLPG123f] + w[rLPG123b] + w[rLPG136]
		- w[rLPR015] - w[rLPR016] - w[rR141] - w[rLPR153]
		+ w[rG183] - w[rLPDD514] + w[rLPHP39] - w[rDD212]
		...
		+ w[rK112b] + w[rP116f] - w[rP116b] + w[rP117f]
		- w[rP117b] + w[rK122f] - w[rK122b] - w[rK123f]
		+ w[rK123b] + w[rK125f] - w[rK125b] - w[rK126f]
		+ w[rK126b] + w[rP128f] - w[rP128b] - w[rK129f]
		+ w[rK129b] + w[rP131f] - w[rP131b] - w[rK132f]
		+ w[rK132b] + w[rK200f] - w[rK200b] - w[rP201f]
		+ w[rP201f] - w[rP201b] + w[rP201b] + w[rP202f]
		- w[rP202b] - w[rK203f] + w[rK203b] + w[rP206f]
		- w[rP206b] + w[rP209f] - w[rP209b] - w[rK210f]
		+ w[rK210b] + w[rK212f] - w[rK212b] - w[rK213f]
		+ w[rK213b] + w[rP301f] - w[rP301b] + w[rP304f]
		- w[rP304b] - w[rP305f] + w[rP305b] + w[rP405f]
		- w[rP405b] + w[rP406f] - w[rP406b] + w[rP407f]
		- w[rP407b] + w[rP410f] - w[rP410b] + w[rP411f]
		- w[rP411b] + w[rP412f] - w[rP412b] + w[rP413f]
		- w[rP413b] + w[rP414f] - w[rP414b] + w[rP415f]
		- w[rP415b] + w[rP416f] - w[rP416b] + w[rP417f]
		- w[rP417b] + w[rP419f] - w[rP419b] - w[rK420f]
		+ w[rK420b] + w[rP422f] - w[rP422b] - w[rK423f]
		+ w[rK423b] + w[rP502f] - w[rP502b] + w[rP503f]
		- w[rP503b] + w[rP505f] - w[rP505b] + w[rP506f]
		- w[rP506b] - w[rK507f] + w[rK507b] + w[rK600f]
		- w[rK600b] + w[rP601f] - w[rP601b] - w[rK602f]
		+ w[rK602b] + w[rK700f] - w[rK700b] + w[rK701f]
		- w[rK701b] + w[rP800] + w[rP801] + w[rCP01f]
		- w[rCP01b] - w[rCP02f] + w[rCP02b] - w[rCP03f]
		+ w[rCP03b] - w[rCP04] + w[rCP12f] - w[rCP12b]
		+ 2 * w[rCP17] + 2 * w[rCP18] + w[rCP19f] - w[rCP19b]
		+ w[rCP22] + w[rCP23f] - w[rCP23b] - w[rCP25]
		- w[rCP29] - w[rCP32f] + w[rCP32b] + w[rI01f]
		- w[rI01b] - w[rI02f] + w[rI02b] + w[rI03f]
		- w[rI03b] + 2 * w[rI12] + 2 * w[rI17] + 2 * w[rI18]
		+ w[rI19f] - w[rI19b] + 2 * w[rI22] + 2 * w[rI23]
		- w[rI32] - w[rT01f] + w[rT01b] + w[rT02f]
		- w[rT02b] - w[rT04f] + w[rT04b] - w[rT07f]
		+ w[rT07b] + w[rT10f] - w[rT10b] + w[rT13f]
		- w[rT13b] + 2 * w[rT20] - w[rT23f] + w[rT23b]
		- w[rT24f] + w[rT24b] + w[rT29f] - w[rT29b]
		- w[rT32f] + w[rT32b] + w[rT36] - w[rT37]
		+ w[rT43f] - w[rT43b] - w[rT44f] + w[rT44b]
		+ w[rT47] + w[rT50f] - w[rT50b] - w[rT51f]
		+ w[rT51b] + w[rT56f] - w[rT56b] + w[rT59]
		- w[rE01f] + w[rE01b] - w[rE04f] + w[rE04b]
		- w[rE06f] + w[rE06b] + w[rE12f] - w[rE12b]
		- w[rE13f] + w[rE13b] + w[rXY00f] - w[rXY00b]
		- w[rXY02f] + w[rXY02b] - w[rXY09f] + w[rXY09b]
		+ 2 * w[rXY11] + w[rXY12] - w[rXY13f] + w[rXY13b]
		+ w[rXY14f] - w[rXY14b] + w[rXY201] + 2 * w[rXY22]
		+ w[rXY23f] - w[rXY23b] + w[rXY25] - w[rXY26f]
		+ w[rXY26b] - w[rXY33] - w[rXY39f] + w[rXY39b]
		- w[rXY40f] + w[rXY40b] + w[rXY42] + w[rXY43f]
		- w[rXY43b] + w[rXY48] + w[rXY50] - w[rXY51]
		+ w[rXY51] - w[rXY57f] + w[rXY57b] + w[rXY58]
		- w[rN01f] + w[rN01b] + w[rN04f] - w[rN04b]
		- w[rN06f] + w[rN06b] - w[rN08f] + w[rN08b]
		+ 2 * w[rN14] + w[rN17] + 2 * w[rN19] + w[rN22f]
		- w[rN22b] - w[rN24f] + w[rN24b] + w[rN28]
		- w[rN29] + w[rOX00f] - w[rOX00b] + w[rOX01f]
		- w[rOX01b] - w[rOX03f] + w[rOX03b] + w[rOX05f]
		- w[rOX05b] + w[rOX99f] - w[rOX99b] + w[rOX07f]
		- w[rOX07b] + w[rOX12f] - w[rOX12b] + w[rOX14f]
		- w[rOX14b] + w[rOX18f] - w[rOX18b] - w[rOX19f]
		+ w[rOX19b] + w[rOX24f] - w[rOX24b] - w[rOX27f]
		+ w[rOX27b] + w[rOX30f] - w[rOX30b] + w[rOX32f]
		- w[rOX32b] + w[rOX35] + w[rOX36] + w[rOX39f]
		- w[rOX39b] + w[rOX40f] - w[rOX40b] + w[rOX42f]
		- w[rOX42b] - w[rOX43f] + w[rOX43b] + w[rOX47];

	cdot[sOH] = w[r3f] - w[r3b] - w[r4f] + w[r4b]
		- 2 * w[r5f] + 2 * w[r5b] + w[r1f] - w[r1b]
		- w[r19] + w[r18] + 2 * w[r17] - w[r26]
		+ w[r23] + 2 * w[r22] - w[r39] - w[rG17]
		- w[rG16] + w[rG21] + w[rG35] - w[rG55]
		- w[rG57f] + w[rG57b] + w[rLPG65] + w[rG59]
		- w[r29] + w[r31] - w[r28f] + w[r28b]
		- w[r35] - w[rDD54] + w[rG46] - w[rG47]
		- w[rLPDD62] - w[rDD47] + w[rDD47] + w[rDD48]
		+ w[rDD53] - w[rDD52] + w[rLPG63] + w[rLPG64]
		+ w[rDD66] - w[rLPG120f] + w[rLPG120b] - w[rG122]
		- w[rG160] - w[rG161] + w[rR037] + w[rG111]
		- w[rR024] - w[rLPG127f] + w[rLPG127b] - w[rLPR025]
		...
		+ w[rP018b] - w[rP022f] + w[rP022b] - w[rP025f]
		+ w[rP025b] - w[rP028f] + w[rP028b] - w[rK110f]
		+ w[rK110b] - w[rK113f] + w[rK113b] - w[rP124f]
		+ w[rP124b] - w[rP127f] + w[rP127b] - w[rP130f]
		+ w[rP130b] - w[rP133f] + w[rP133b] - w[rK204f]
		+ w[rK204b] - w[rP211f] + w[rP211b] - w[rP214f]
		...
		- w[rCP15] + w[rCP20f] - w[rCP20b] + w[rCP21f]
		- w[rCP21b] - w[rCP22] + w[rCP26] - w[rCP27]
		+ w[rI05f] - w[rI05b] - w[rI06f] + w[rI06b]
		- w[rI15] + w[rI20f] - w[rI20b] - w[rI22]
		- w[rT08f] + w[rT08b] - w[rT09f] + w[rT09b]
		- w[rT10f] + w[rT10b] + w[rT11f] - w[rT11b]
		- w[rT18f] + w[rT18b] + w[rT19f] - w[rT19b]
		+ w[rT21f] - w[rT21b] + w[rT25f] - w[rT25b]
		- w[rT26f] + w[rT26b] + w[rT33f] - w[rT33b]
		- w[rT34f] + w[rT34b] + w[rT38] - w[rT39]
		+ w[rT45f] - w[rT45b] - w[rT46f] + w[rT46b]
		+ w[rT52f] - w[rT52b] - w[rT53f] + w[rT53b]
		- w[rT56f] + w[rT56b] + w[rT57f] - w[rT57b]
		- w[rE05f] + w[rE05b] + w[rE07f] - w[rE07b]
		- w[rE08f] + w[rE08b] - w[rE14f] + w[rE14b]
		+ w[rE19] + w[rE31] + w[rE34] + w[rE36]
		+ w[rE37] - w[rST04f] + w[rST04b] - w[rST05f]
		+ w[rST05b] - w[rST06f] + w[rST06b] + w[rST10f]
		- w[rST10b] - w[rST00f] + w[rST00b] + w[rXY03f]
		- w[rXY03b] - w[rXY04f] + w[rXY04b] - w[rXY10f]
		+ w[rXY10b] - w[rXY17] + w[rXY18f] - w[rXY18b]
		+ w[rXY201] + w[rXY202] + w[rXY203] + w[rXY27f]
		- w[rXY27b] - w[rXY28f] + w[rXY28b] + w[rXY34]
		- w[rXY35] - w[rXY41f] + w[rXY41b] - w[rXY42]
		- w[rXY46] + w[rXY47f] - w[rXY47b] + w[rXY48]
		- w[rXY53] + w[rXY53] - w[rXY58] - w[rN02f]
		+ w[rN02b] + w[rN09f] - w[rN09b] - w[rN10f]
		+ w[rN10b] - w[rN17] + w[rN18f] - w[rN18b]
		+ w[rN20f] - w[rN20b] + w[rN25f] - w[rN25b]
		- w[rN26f] + w[rN26b] + w[rN30] - w[rN31]
		- w[rOX04f] + w[rOX04b] - w[rOX05f] + w[rOX05b]
		+ w[rOX10f] - w[rOX10b] - w[rOX14f] + w[rOX14b]
		+ w[rOX15f] - w[rOX15b] - w[rOX20f] + w[rOX20b]
		+ w[rOX25f] - w[rOX25b] - w[rOX32f] + w[rOX32b]
		- w[rOX39f] + w[rOX39b] - w[rOX40f] + w[rOX40b]
	...
	cdot[sH2O] = w[r4f] - w[r4b] + w[r5f] - w[r5b]
		...
		- w[rG08] + w[rG17] + w[rG36] - w[rG38f]
		+ w[rG38f] - w[rG38b] + w[rG38b] + w[rG55]
		+ w[rG57f] - w[rG57b] + w[r35] + w[rG47]
		+ w[rDD47] + w[rDD52] + w[rG160] + w[rLPG127f]
		- w[rLPG127b] + w[rLPR151] + w[rDD434] + w[rDD332N]
		+ w[rDD294] + w[rHP60] + w[rP018f] - w[rP018b]
		+ w[rP022f] - w[rP022b] + w[rP025f] - w[rP025b]
		+ w[rP028f] - w[rP028b] + w[rK110f] - w[rK110b]
		+ w[rK113f] - w[rK113b] + w[rP124f] - w[rP124b]
		+ w[rP127f] - w[rP127b] + w[rP130f] - w[rP130b]
		+ w[rP133f] - w[rP133b] + w[rK204f] - w[rK204b]
		+ w[rP211f] - w[rP211b] + w[rP214f] - w[rP214b]
		+ w[rP306f] - w[rP306b] + w[rK421f] - w[rK421b]
		+ w[rK424f] - w[rK424b] + w[rK508f] - w[rK508b]
		+ w[rK603f] - w[rK603b] + w[rCP06f] - w[rCP06b]
		+ w[rCP27] + w[rI06f] - w[rI06b] + w[rI21]
		+ w[rT08f] - w[rT08b] + w[rT26f] - w[rT26b]
		+ w[rT34f] - w[rT34b] + w[rT39] + w[rT46f]
		- w[rT46b] + w[rT53f] - w[rT53b] + w[rE08f]
		- w[rE08b] + w[rE14f] - w[rE14b] + w[rXY04f]
		- w[rXY04b] + w[rXY28f] - w[rXY28b] + w[rXY35]
		+ w[rN10f] - w[rN10b] + w[rN26f] - w[rN26b]
		+ w[rN31] + w[rOX04f] - w[rOX04b] + w[rOX20f]
		- w[rOX20b] + w[rOX44f] - w[rOX44b];

	cdot[sO2] = - w[r1f] + w[r1b] - w[r15f] + w[r15b]
		+ w[r16] + w[r21] + w[r20] + w[r19]
		+ w[r18] - w[rG09] - w[rG19] - w[rG20]
		- w[rG21] - w[rG36] - w[rG35] - w[rLPG60f]
		+ w[rLPG60b] - w[rG59] - w[r38] - w[rDD68]
		- w[rLPG89] + w[rLPG63] + w[rDD67] - w[rG135]
		- w[rLPG134] - w[rG133] - w[rG171] - w[rG111]
		- w[rLPG139] - w[rLPG140] + w[rLPR116] - w[rLPR133]
		- w[rLPR111] - w[rG184] - w[rDD422] - w[rDD408f]
		+ w[rDD408b] - w[rLPDD486f] + w[rLPDD486b] - w[rDD239]
		- w[rDD263] - w[rCP07f] + w[rCP07b] - w[rCP20f]
		+ w[rCP20b] - w[rCP28] - w[rCP30] - w[rI07f]
		+ w[rI07b] - w[rI20f] + w[rI20b] - w[rT06f]
		+ w[rT06b] - w[rT21f] + w[rT21b] - w[rT22f]
		+ w[rT22b] - w[rT35f] + w[rT35b] - w[rT40]
		- w[rT58f] + w[rT58b] - w[rT59] - w[rT60]
		- w[rE16f] + w[rE16b] - w[rE30] - w[rE31]
		+ w[rE32] - w[rE36] - w[rST12f] + w[rST12b]
	...
	cdot[sHO2] = w[r15f] - w[r15b] - w[r16] - 2 * w[r21]
		- 2 * w[r20] - w[r19] - w[r18] - w[r17]
		+ w[r26] + w[r39] - w[rLPG65] - w[r31]
		+ w[r38] - w[rG49] + w[rLPG89] - w[rDD48]
		- w[rLPG63] + w[rG133] + w[rG171] - w[rR037]
		- w[rLPR116] - w[rLPLPR117] + w[rG184] + w[rDD422]
		- w[rDD429] + w[rDD472] + w[rLPDD473] + w[rDD239]
		+ w[rCP07f] - w[rCP07b] - w[rCP08f] + w[rCP08b]
		- w[rCP21f] + w[rCP21b] + w[rCP28] + w[rCP30]
		+ w[rI07f] - w[rI07b] - w[rI08f] + w[rI08b]
		- w[rI21] + w[rT06f] - w[rT06b] - w[rT15f]
		+ w[rT15b] - w[rT19f] + w[rT19b] + w[rT35f]
		- w[rT35b] + w[rT40] - w[rT41] - w[rT57f]
		+ w[rT57b] - w[rE09f] + w[rE09b] + w[rE16f]
		- w[rE16b] - w[rE19] + w[rE33] + w[rST12f]
		- w[rST12b] + w[rXY05f] - w[rXY05b] - w[rXY06f]
		+ w[rXY06b] - w[rXY201] - w[rXY202] - w[rXY203]
		+ w[rXY29f] - w[rXY29b] - w[rXY30f] + w[rXY30b]
		+ w[rXY36] - w[rXY37] - w[rXY48] - w[rXY55]
		+ w[rXY55] + w[rN11f] - w[rN11b] - w[rN13f]
		+ w[rN13b] - w[rN18f] + w[rN18b] + w[rN27f]
		- w[rN27b] + w[rN32] - w[rN33] + w[rOX06f]
		- w[rOX06b] - w[rOX15f] + w[rOX15b] + w[rOX22f]
		- w[rOX22b];

	cdot[sH2O2] = w[r21] + w[r20] - w[r26] - w[r23]
		- w[r22] - w[r39] + w[rG49] + w[rDD48]
		+ w[rDD429] + w[rCP08f] - w[rCP08b] + w[rI08f]
		- w[rI08b] + w[rT15f] - w[rT15b] + w[rT41]
		+ w[rE09f] - w[rE09b] + w[rXY06f] - w[rXY06b]
		+ w[rXY30f] - w[rXY30b] + w[rXY37] + w[rN13f]
		- w[rN13b] + w[rN33];

	cdot[sCH] = - w[rG06f] + w[rG06b] - w[rG08] - w[rG09]
		+ w[rG17];

	cdot[sTXCH2] = w[rG06f] - w[rG06b] - w[rG14] - w[rG19]
		- w[rG20] - w[rG17] - w[rG15] - w[rG16]
		- w[rG21] + w[rG38f] - w[rG38b] + w[rG28f]
		- w[rG28b] + w[rG55] - w[rG72] - w[rLPG24]
		+ w[rG117] + w[rG158] + w[rLPHP54];

	cdot[sCH2O] = w[rG08] + w[rG20] + w[rG16] + w[rG52]
		+ w[rG59] - w[rG46] - w[rG47] - w[rG45]
		- w[rG49] - w[rLPDD62] + w[rLPG89] + w[rLPG44]
		- w[rLPG64] - w[rDD66] + w[rG135] + w[rG158]
		+ w[rLPG139] + w[rLPG138] + w[rG168] + w[rLPR111]
		+ w[rLPHP55] + w[rLPHP53] + w[rDD199] + w[rDD43]
		+ w[rLPR140] + w[rDD259] + w[rT22f] - w[rT22b]
		- w[rT28f] + w[rT28b] + w[rT30f] - w[rT30b]
		+ w[rE17f] - w[rE17b] + w[rE19] + w[rE37]
		+ w[rST05f] - w[rST05b] + w[rXY15f] - w[rXY15b]
		+ w[rXY19f] - w[rXY19b] + w[rXY202] + w[rXY44]
		+ w[rN21f] - w[rN21b] + w[rN23f] - w[rN23b];

	cdot[sHCO] = w[rG09] + w[rG15] - w[r38] - w[r36f]
		+ w[r36b] - w[r32] - w[rDD68] - w[r35]
		- w[rDD54] + w[rG46] + w[rG47] + w[rG45]
		+ w[rG49] + w[rDD53] + w[rLPG64] + w[rDD66]
		+ w[rDD67] + w[rG135] + w[rG159] + 2 * w[rR024]
		+ w[rLPR030] + 2 * w[rLPG140] + w[rLPG138] + w[rLPG144]
		- w[rLPR115] + w[rR143] + w[rLPHP54] + w[rLPHP56]
		+ w[rHP26] + w[rCP14] + w[rCP15] + w[rI15]
		+ w[rT28f] - w[rT28b] + w[rT31f] - w[rT31b]
		+ w[rE31] + w[rE34] + w[rST02f] - w[rST02b]
		+ w[rST14f] - w[rST14b] + w[rXY16f] - w[rXY16b]
		+ w[rXY203] + w[rXY39f] - w[rXY39b] + w[rXY41f]
		- w[rXY41b] + w[rXY45f] - w[rXY45b] + w[rXY57f]
		- w[rXY57b] + w[rXY58];

	cdot[sCH3] = w[rG14] + w[rG34f] - w[rG34b] - w[rG52]
		- w[rG55] - w[rG57f] + w[rG57b] - w[rG53]
		- w[rG72] - w[rLPG65] - w[rLPG60f] + w[rLPG60b]
		- w[rG59] - 2 * w[rG74f] + 2 * w[rG74b] - w[rLPG61]
		+ w[rG122] + w[rG159] - w[rR022] + w[rLPG124]
		- w[rLPR028] - w[rLPR030] + w[rLPG137] + w[rLPDD76f]
		- w[rLPDD76b] + w[rG168] + w[rLPR015] + w[rLPR133]
		+ w[rLPR007] + w[rR141] + w[rLPR142] + w[rG163]
		...
		- w[rT42] - w[rT54f] + w[rT54b] - w[rE02f]
		+ w[rE02b] - w[rE10f] + w[rE10b] - w[rE15f]
		+ w[rE15b] + w[rE18f] - w[rE18b] - w[rST03f]
		+ w[rST03b] + w[rST04f] - w[rST04b] + w[rXY01f]
		- w[rXY01b] - w[rXY07f] + w[rXY07b] + w[rXY09f]
		- w[rXY09b] + w[rXY10f] - w[rXY10b] + w[rXY13f]
		- w[rXY13b] + w[rXY24] - w[rXY31f] + w[rXY31b]
		- w[rXY38] + w[rXY40f] - w[rXY40b] + w[rXY42]
		- w[rXY56] + w[rXY56] + w[rN01f] - w[rN01b]
		+ w[rN02f] - w[rN02b] + w[rN05f] - w[rN05b]
		+ w[rN06f] - w[rN06b] - w[rN12f] + w[rN12b]
		+ w[rN15] - w[rN34] + w[rOX16f] - w[rOX16b]
		- w[rOX21f] + w[rOX21b] - w[rOX45f] + w[rOX45b]
		+ w[rOX60] + w[rOX61];

	cdot[sCO2] = w[rG19] + w[r27] + w[r29] + w[r31]
		+ w[r28f] - w[r28b] + w[rDD44] + w[rDD50]
		+ w[rDD52] + w[rCP33f] - w[rCP33b] + w[rT59];

	cdot[sCO] = w[rG21] + w[rG36] + w[rG35] + w[rG53]
		- w[r27] - w[r29] - w[r31] - w[r28f]
		+ w[r28b] - w[rLPG24] + w[r38] + w[r36f]
		- w[r36b] + w[r32] + w[r35] + w[rDD47]
		+ w[rDD48] + w[rG117] + w[rG122] + w[rG109]
		+ w[rR022] + 2 * w[rG110] + 2 * w[rG111] + w[rLPG124]
		+ w[rLPR028] + w[rLPR025] + w[rLPG139] + w[rLPG137]
		+ w[rLPDD76f] - w[rLPDD76b] + w[rLPR115] + w[rLPHP52]
		...
		+ w[rOX46f] - w[rOX46b] + w[rOX47] + w[rOX48]
		+ 2 * w[rOX50] + 2 * w[rOX51] + 2 * w[rOX52] + 2 * w[rOX53]
		+ 2 * w[rOX54] + w[rOX60] + w[rOX61];

	cdot[sSXCH2] = - w[rG36] - w[rG35] - w[rG38f] + w[rG38b]
		- w[rG34f] + w[rG34b] - w[rG28f] + w[rG28b]
		+ w[rG57f] - w[rG57b] + w[rG109];

	cdot[sC2H4] = w[rG72] - w[rG160] - w[rG158] - w[rG159]
		- w[rLPG157] - w[rG156] - w[rG161] - w[rG155f]
		+ w[rG155b] + w[rG171] + w[rR022] + w[rR141]
		+ w[rG163] + w[rHP41] + w[rHP29] + w[rDD214]
		+ w[rHP10] + w[rDD287] + w[rDD324] - w[rP015f]
		+ w[rP015b] - w[rP106f] + w[rP106b] - w[rP120f]
		+ w[rP120b] - w[rP121f] + w[rP121b] - w[rP208f]
		+ w[rP208b] - w[rP412f] + w[rP412b] - w[rP413f]
		+ w[rP413b] + w[rCP10f] - w[rCP10b] + w[rCP13]
		+ w[rCP15] + w[rI15] + w[rE11f] - w[rE11b];

	cdot[sCH3O] = w[rLPG65] - w[rLPG89] - w[rLPG44] + w[rLPG63]
		+ 2 * w[rLPG61] + w[rLPG64] + w[rLPDD15] + w[rLPR025]
		+ w[rLPG144] + w[rLPLPR118] + w[rLPDD431];

	cdot[sCH3O2] = w[rLPG60f] - w[rLPG60b] + w[rLPDD62] - w[rLPG63]
		- w[rLPDD59] - w[rLPG61] - w[rLPG64] - w[rLPDD15]
		- w[rLPLPR118] - w[rLPDD431];

	cdot[sC2H5] = w[rG74f] - w[rG74b] + w[rG155f] - w[rG155b]
		- w[rLPDD15] - w[rG171] - w[rR037] + w[rLPR028]
		+ w[rLPR030] + w[rR143] + w[rLPHP54] + w[rLPHP52]
		+ w[rLPHP56] + w[rHP41] + w[rHP32] + w[rHP26]
		+ w[rDD288] + w[rDD319] + w[rLPDD490] - w[rE03f]
		+ w[rE03b] + w[rE04f] - w[rE04b] + w[rE05f]
		- w[rE05b];

	cdot[sCH2CO] = w[rLPG24] + w[rLPG120f] - w[rLPG120b] - w[rLPG124]
		- w[rLPR028] - w[rLPG123f] + w[rLPG123b] - w[rLPG127f]
		+ w[rLPG127b] - w[rLPR025] + w[rLPG136] + w[rLPR133]
		+ w[rLPDD490] + w[rLPLPDD107] + w[rLPDD293] + w[rOX28];

	cdot[sO2CHO] = w[rDD68] - w[rDD66] - w[rDD67] - w[rDD427];

	cdot[sHOCHO] = w[rDD54] - w[rDD47] - w[rDD50] - w[rDD48]
		- w[rDD53] - w[rDD52] + w[rLPDD59];

	cdot[sOCHO] = - w[rDD44] + w[rDD66] + w[rDD427];

	cdot[sC2H2] = - w[rG115f] + w[rG115b] - w[rG116] - w[rG117]
		- w[rLPG120f] + w[rLPG120b] - w[rG122] + w[rG133]
		+ w[rG130] + w[rLPR111] + w[rLPR007] - w[rP001f]
		+ w[rP001b] - w[rP002f] + w[rP002b] - w[rP005f]
		+ w[rP005b] - w[rP006f] + w[rP006b] - w[rP007f]
		+ w[rP007b] - w[rK012f] + w[rK012b] - w[rK100f]
		+ w[rK100b] - w[rK102f] + w[rK102b] - w[rP104f]
		+ w[rP104b] - w[rK114f] + w[rK114b] - w[rK115f]
		+ w[rK115b] - w[rK205f] + w[rK205b] - w[rK401f]
		+ w[rK401b] - w[rK403f] + w[rK403b] - w[rP405f]
		+ w[rP405b] - w[rP406f] + w[rP406b] - w[rP407f]
		+ w[rP407b] + w[rP425f] - w[rP425b] - w[rP501f]
		+ w[rP501b] - w[rP502f] + w[rP502b] - w[rP503f]
		+ w[rP503b] - w[rK600f] + w[rK600b] - w[rK700f]
		+ w[rK700b] - w[rK701f] + w[rK701b] + w[rCP03f]
		- w[rCP03b] + w[rCP04] + w[rCP13] + w[rCP15]
		- w[rCP16f] + w[rCP16b] + 2 * w[rCP31] - w[rI03f]
		+ w[rI03b] + w[rI31] + w[rT05f] - w[rT05b]
		+ w[rST01] + w[rXY12] + w[rN07f] - w[rN07b]
		- w[rOX02f] + w[rOX02b] + w[rOX28];

	cdot[sC2H3] = w[rG115f] - w[rG115b] - w[rG135] - w[rLPG134]
		- w[rG133] - w[rG130] - w[rLPG131] + w[rG160]
		+ w[rG156] + w[rLPR015] + w[rLPR140] - w[rP013f]
		+ w[rP013b] - w[rP014f] + w[rP014b] + w[rP015f]
		- w[rP015b] - w[rP105f] + w[rP105b] - w[rP116f]
		+ w[rP116b] - w[rP117f] + w[rP117b] - w[rP118f]
		+ w[rP118b] - w[rP119f] + w[rP119b] - w[rP206f]
		+ w[rP206b] - w[rP207f] + w[rP207b] - w[rP408f]
		+ w[rP408b] - w[rP409f] + w[rP409b] - w[rP410f]
		+ w[rP410b] - w[rP411f] + w[rP411b] - w[rP504f]
		+ w[rP504b] - w[rCP10f] + w[rCP10b] + w[rT60]
		+ w[rST06f] - w[rST06b];

	cdot[sHCCO] = w[rG116] - w[rG109] - w[rR022] - w[rG110]
		- w[rG111] - w[rR024] + w[rLPG123f] - w[rLPG123b]
		+ w[rLPG127f] - w[rLPG127b] + w[rST00f] - w[rST00b]
		+ w[rOX62] + w[rOX63] + w[rOX64] + w[rOX65]
		+ w[rOX66];

	cdot[sCH2CHO] = w[rLPG134] + w[rLPG131] + w[rLPG157] - w[rLPR030]
		- w[rLPG139] - w[rLPG140] - w[rLPG137] - w[rLPG138]
		- w[rLPG136] - w[rLPG144] - w[rLPDD76f] + w[rLPDD76b]
		+ w[rLPR142];

	cdot[sC2H5O] = w[rG161] + w[rLPDD15] + w[rR037] - w[rG168];
	...
	cdot[sC3H6] = w[rLPR116] + w[rLPR115] + w[rLPR016] - w[rR141]
		...
		+ w[rG183] + w[rG184] + w[rLPHP53] + w[rHP32]
		+ w[rDD208] + w[rHP11] + w[rDD415];

	cdot[sCH3COCH2] = w[rLPLPR118] + w[rLPLPR113] + w[rLPLPR117] + w[rLPLPDD495]
		- w[rLPR140] - w[rLPLPDD107];

	cdot[sNXC3H7] = - w[rG183] - w[rG184] - w[rG163] + w[rLPHP55]
		+ w[rHP29] + w[rLPDD205] + w[rDD208] + w[rLPHP12]
		+ w[rDD323] + w[rDD421] + w[rHP60];
	...
	cdot[sA1XC6H6] = w[rP000f] - w[rP000b] + w[rP003f] - w[rP003b]
		...
		- w[rE04b] + w[rST01] + w[rST00f] - w[rST00b]
		+ w[rXY12] - w[rOX00f] + w[rOX00b] - w[rOX03f]
		+ w[rOX03b] - w[rOX04f] + w[rOX04b] - w[rOX05f]
		+ w[rOX05b] - w[rOX06f] + w[rOX06b] - w[rOX99f]
	...
	cdot[sA1XXC6H5] = w[rP004f] - w[rP004b] + w[rP005f] - w[rP005b]
		...
		- w[rP013f] + w[rP013b] - w[rP015f] + w[rP015b]
		- w[rP107f] + w[rP107b] - w[rP301f] + w[rP301b]
		- 2 * w[rP302f] + 2 * w[rP302b] - w[rP416f] + w[rP416b]
		- w[rP418f] + w[rP418b] - w[rP800] - w[rP802]
		- w[rI00f] + w[rI00b] + w[rT03f] - w[rT03b]
		+ w[rT04f] - w[rT04b] - w[rT16f] + w[rT16b]
		- w[rT28f] + w[rT28b] + w[rT30f] - w[rT30b]
		+ w[rT36] + w[rT37] + w[rT38] + w[rT39]
		+ w[rT40] + w[rT41] + w[rT42] - w[rE03f]
		+ w[rE03b] + w[rE11f] - w[rE11b] + w[rE37]
		+ w[rXY24] + w[rXY44] + w[rXY50] + w[rOX00f]
		- w[rOX00b] - w[rOX01f] + w[rOX01b] + w[rOX03f]
		- w[rOX03b] + w[rOX04f] - w[rOX04b] + w[rOX06f]
		- w[rOX06b] + w[rOX10f] - w[rOX10b] - w[rOX11f]
		+ w[rOX11b] - w[rOX12f] + w[rOX12b] - w[rOX13f]
	...
	cdot[sC3H3] = - w[rP008] - 2 * w[rP009f] + 2 * w[rP009b] - 2 * w[rP010f]
		...
		+ w[rCP16b] - w[rI00f] + w[rI00b] - w[rI23]
		- w[rT20] - w[rXY22] - w[rN19];

	cdot[sA1C2H2XC8H7] = w[rK012f] - w[rK012b] - w[rK019f] + w[rK019b]
		- w[rK020f] + w[rK020b] - w[rK021f] + w[rK021b]
		- w[rP022f] + w[rP022b] + w[rP026f] - w[rP026b]
		+ w[rP027f] - w[rP027b] + w[rP028f] - w[rP028b]
		- w[rP104f] + w[rP104b] + w[rST03f] - w[rST03b]
		- w[rST11f] + w[rST11b] - w[rST12f] + w[rST12b]
		- w[rST13] - w[rST14f] + w[rST14b];

	cdot[sA1C2H3XC8H8] = w[rP013f] - w[rP013b] + w[rP014f] - w[rP014b]
		- w[rP023f] + w[rP023b] - w[rK024f] + w[rK024b]
		- w[rP025f] + w[rP025b] - w[rP026f] + w[rP026b]
		- w[rP027f] + w[rP027b] - w[rP028f] + w[rP028b]
		+ w[rE12f] - w[rE12b] + w[rE13f] - w[rE13b]
		+ w[rE14f] - w[rE14b] + w[rE15f] - w[rE15b]
		+ w[rE16f] - w[rE16b] + w[rE33] - w[rST01]
		- w[rST02f] + w[rST02b] - w[rST03f] + w[rST03b]
		- w[rST04f] + w[rST04b] - w[rST05f] + w[rST05b]
		- w[rST06f] + w[rST06b] - w[rST10f] + w[rST10b];

	cdot[sA1C2HXC8H6] = - w[rP016f] + w[rP016b] - w[rK017f] + w[rK017b]
		- w[rP018f] + w[rP018b] + w[rK020f] - w[rK020b]
		+ w[rK021f] - w[rK021b] + w[rP022f] - w[rP022b]
		- w[rP105f] + w[rP105b] - w[rP416f] + w[rP416b]
		+ w[rST12f] - w[rST12b] - w[rST00f] + w[rST00b];
	...
	cdot[sA2XXC10H7] = w[rK100f] - w[rK100b] + w[rP108f] - w[rP108b]
		...
		- w[rK114f] + w[rK114b] - w[rP116f] + w[rP116b]
		- w[rP120f] + w[rP120b] - w[rP414f] + w[rP414b]
		- w[rP801] - w[rP802] + w[rN05f] - w[rN05b]
		+ w[rN06f] - w[rN06b] + w[rN23f] - w[rN23b]
		+ w[rN28] + w[rN29] + w[rN30] + w[rN31]
		+ w[rN32] + w[rN33] + w[rN34] - w[rOX33f]
		+ w[rOX33b] - w[rOX35] - w[rOX37f] + w[rOX37b]
	...
	cdot[sA2YXC10H7] = w[rP111f] - w[rP111b] + w[rK112f] - w[rK112b]
		...
		- w[rP117f] + w[rP117b] - w[rP121f] + w[rP121b]
		- w[rP415f] + w[rP415b] - w[rOX34f] + w[rOX34b]
		- w[rOX36] - w[rOX38f] + w[rOX38b] - w[rOX40f]
		+ w[rOX40b];

	cdot[sA2C2H2AXC12H9] = w[rK114f] - w[rK114b] + w[rP116f] - w[rP116b]
		+ w[rP118f] - w[rP118b] + w[rP120f] - w[rP120b]
		- w[rK122f] + w[rK122b] - w[rK123f] + w[rK123b]
		- w[rP124f] + w[rP124b] - w[rK200f] + w[rK200b]
		- w[rP405f] + w[rP405b] + w[rOX51];

	cdot[sA2C2H2BXC12H9] = w[rK115f] - w[rK115b] + w[rP117f] - w[rP117b]
		+ w[rP119f] - w[rP119b] + w[rP121f] - w[rP121b]
		- w[rK125f] + w[rK125b] - w[rK126f] + w[rK126b]
		- w[rP127f] + w[rP127b] - w[rP406f] + w[rP406b]
		+ w[rOX50];

	cdot[sA2C2HAXC12H8] = w[rK122f] - w[rK122b] + w[rK123f] - w[rK123b]
		+ w[rP124f] - w[rP124b] - w[rP128f] + w[rP128b]
		- w[rK129f] + w[rK129b] - w[rP130f] + w[rP130b]
		- w[rP201f] + w[rP201b] - w[rP410f] + w[rP410b]
		+ w[rOX60];

	cdot[sA2C2HBXC12H8] = w[rK125f] - w[rK125b] + w[rK126f] - w[rK126b]
		+ w[rP127f] - w[rP127b] - w[rP131f] + w[rP131b]
		- w[rK132f] + w[rK132b] - w[rP133f] + w[rP133b]
		- w[rP411f] + w[rP411b] + w[rOX61];

	cdot[sA2C2HAYXC12H7] = w[rP128f] - w[rP128b] + w[rK129f] - w[rK129b]
		+ w[rP130f] - w[rP130b] - w[rK401f] + w[rK401b]
		- w[rP408f] + w[rP408b] - w[rP412f] + w[rP412b];

	cdot[sA2C2HBYXC12H7] = w[rP131f] - w[rP131b] + w[rK132f] - w[rK132b]
		+ w[rP133f] - w[rP133b] - w[rK403f] + w[rK403b]
		- w[rP409f] + w[rP409b] - w[rP413f] + w[rP413b];
	...
	cdot[sA2R5XXC12H7] = w[rP202f] - w[rP202b] + w[rK203f] - w[rK203b]
		...
		- w[rP206f] + w[rP206b] - w[rP208f] + w[rP208b]
		+ w[rP425f] - w[rP425b] - w[rP505f] + w[rP505b]
		- w[rOX53];

	cdot[sA2R5C2H2XC14H9] = w[rK205f] - w[rK205b] + w[rP206f] - w[rP206b]
		+ w[rP207f] - w[rP207b] + w[rP208f] - w[rP208b]
		- w[rK212f] + w[rK212b] - w[rK213f] + w[rK213b]
		- w[rP214f] + w[rP214b] - w[rP502f] + w[rP502b];
	...
	cdot[sA3XC14H10] = w[rP405f] - w[rP405b] + w[rP406f] - w[rP406b]
		+ w[rP407f] - w[rP407b] + w[rP408f] - w[rP408b]
		+ w[rP409f] - w[rP409b] + w[rP410f] - w[rP410b]
	...
	cdot[sA3R5XC16H10] = w[rP502f] - w[rP502b] + w[rP503f] - w[rP503b]
		+ w[rP504f] - w[rP504b] + w[rP505f] - w[rP505b]
	...
	cdot[sC5H6] = - w[rCP01f] + w[rCP01b] - w[rCP02f] + w[rCP02b]
		...
		+ w[rCP09b] - w[rCP10f] + w[rCP10b] - w[rCP11f]
		+ w[rCP11b] - w[rCP12f] + w[rCP12b] - w[rCP13]
		- w[rCP14] - w[rCP15] - w[rCP34] + w[rOX09f]
		- w[rOX09b] + w[rOX17f] - w[rOX17b];

	cdot[sC5H5] = w[rCP01f] - w[rCP01b] + w[rCP02f] - w[rCP02b]
		+ w[rCP05f] - w[rCP05b] + w[rCP06f] - w[rCP06b]
		+ w[rCP07f] - w[rCP07b] + w[rCP08f] - w[rCP08b]
		+ w[rCP09f] - w[rCP09b] + w[rCP10f] - w[rCP10b]
		+ w[rCP11f] - w[rCP11b] + w[rCP16f] - w[rCP16b]
		- 2 * w[rCP17] - w[rCP18] - w[rCP19f] + w[rCP19b]
		- w[rCP20f] + w[rCP20b] - w[rCP21f] + w[rCP21b]
		- w[rCP22] - w[rCP34] - w[rI17] + w[rT05f]
	...
	cdot[sC4H6] = w[rCP11f] - w[rCP11b] + w[rCP14];

	cdot[sTXC5H5O] = w[rCP12f] - w[rCP12b] - w[rCP24] - w[rCP29]
		- w[rCP30] + w[rCP32f] - w[rCP32b] + w[rOX27f]
		- w[rOX27b];

	cdot[sC5H4O] = w[rCP19f] - w[rCP19b] + w[rCP20f] - w[rCP20b]
		+ w[rCP23f] - w[rCP23b] + w[rCP25] + w[rCP26]
		+ w[rCP27] + w[rCP28] + w[rCP29] + w[rCP30]
		- w[rCP31] - w[rCP32f] + w[rCP32b] - w[rCP33f]
		+ w[rCP33b] + w[rOX26f] - w[rOX26b];

	cdot[sSXC5H5O] = w[rCP21f] - w[rCP21b] + w[rCP22] - w[rCP23f]
		+ w[rCP23b] - w[rCP25] - w[rCP26] - w[rCP27]
		- w[rCP28];

	cdot[sC9H8] = w[rCP34] + w[rI00f] - w[rI00b] - w[rI01f]
		+ w[rI01b] - w[rI02f] + w[rI02b] + w[rI03f]
		- w[rI03b] - w[rI05f] + w[rI05b] - w[rI06f]
		+ w[rI06b] - w[rI07f] + w[rI07b] - w[rI08f]
		+ w[rI08b] - w[rI09f] + w[rI09b] - w[rI12]
		- w[rI15] + w[rOX41f] - w[rOX41b];

	cdot[sC9H7] = w[rI01f] - w[rI01b] + w[rI02f] - w[rI02b]
		+ w[rI05f] - w[rI05b] + w[rI06f] - w[rI06b]
		+ w[rI07f] - w[rI07b] + w[rI08f] - w[rI08b]
		+ w[rI09f] - w[rI09b] - w[rI17] - w[rI18]
		- w[rI19f] + w[rI19b] - w[rI20f] + w[rI20b]
		- w[rI21] - w[rI22] - w[rI23] + w[rN07f]
	...
	cdot[sA1CH2XC7H7] = - w[rI03f] + w[rI03b] + w[rT02f] - w[rT02b]
		...
		+ w[rT16f] - w[rT16b] - w[rT17f] + w[rT17b]
		- w[rT18f] + w[rT18b] - w[rT19f] + w[rT19b]
		- w[rT20] - w[rT21f] + w[rT21b] - w[rT22f]
		+ w[rT22b] - w[rE02f] + w[rE02b] + w[rE17f]
		- w[rE17b] + w[rE19] + w[rE31] + w[rE34]
		+ w[rST02f] - w[rST02b] + w[rST05f] - w[rST05b]
		+ w[rST11f] - w[rST11b] + w[rST13];

	cdot[sC9H6O] = w[rI12] + w[rI19f] - w[rI19b] + w[rI20f]
		- w[rI20b] + w[rI21] + w[rI22] - w[rI31]
		- w[rI32] + w[rOX35] + w[rOX36] + w[rOX47]
		+ w[rOX48];

	cdot[sOXC6H4] = w[rI15] + w[rI31] + w[rOX01f] - w[rOX01b]
		+ w[rOX02f] - w[rOX02b];
	...
	cdot[sOA1CH3XC7H7O] = w[rT13f] - w[rT13b] + w[rT43f] - w[rT43b]
		...
		+ w[rT46f] - w[rT46b] - w[rT47] + w[rT55f]
		- w[rT55b] + w[rT56f] - w[rT56b] + w[rT57f]
		- w[rT57b] + w[rT58f] - w[rT58b] + w[rXY19f]
		- w[rXY19b];

	cdot[sA1CH2OXC7H7O] = w[rT17f] - w[rT17b] + w[rT19f] - w[rT19b]
		- w[rT23f] + w[rT23b] + w[rT24f] - w[rT24b]
		...
		- w[rT34f] + w[rT34b] - w[rT35f] + w[rT35b];

	cdot[sA1CH2OHXC7H8O] = w[rT18f] - w[rT18b] + w[rT23f] - w[rT23b]
		- w[rT24f] + w[rT24b] - w[rT25f] + w[rT25b]
	...
	cdot[sA1CHOXC7H6O] = w[rT21f] - w[rT21b] + w[rT29f] - w[rT29b]
		...
		+ w[rT34f] - w[rT34b] + w[rT35f] - w[rT35b]
		- w[rT36] - w[rT37] - w[rT38] - w[rT39]
		- w[rT40] - w[rT41] - w[rT42] + w[rE18f]
		- w[rE18b] + w[rST04f] - w[rST04b] + w[rST14f]
		- w[rST14b] + w[rXY40f] - w[rXY40b] + w[rXY45f]
		- w[rXY45b] + w[rXY51] + w[rXY52] + w[rXY53]
		+ w[rXY54] + w[rXY55] + w[rXY56] + w[rXY57f]
		- w[rXY57b];

	cdot[sA1OXC6H5O] = w[rT22f] - w[rT22b] + w[rXY42] + w[rXY58]
		+ w[rOX99f] - w[rOX99b] + w[rOX07f] - w[rOX07b]
		+ w[rOX11f] - w[rOX11b] + w[rOX13f] - w[rOX13b]
		+ w[rOX14f] - w[rOX14b] + w[rOX15f] - w[rOX15b]
		+ w[rOX18f] - w[rOX18b] + w[rOX19f] - w[rOX19b]
		+ w[rOX20f] - w[rOX20b] + w[rOX21f] - w[rOX21b]
		+ w[rOX22f] - w[rOX22b] - w[rOX23f] + w[rOX23b]
		- w[rOX24f] + w[rOX24b] - w[rOX25f] + w[rOX25b];

	cdot[sA1CH3YXC7H7] = w[rT50f] - w[rT50b] + w[rT51f] - w[rT51b]
		+ w[rT52f] - w[rT52b] + w[rT53f] - w[rT53b]
		+ w[rT54f] - w[rT54b] - w[rT55f] + w[rT55b]
		- w[rT56f] + w[rT56b] - w[rT57f] + w[rT57b]
		- w[rT58f] + w[rT58b] - w[rT59] - w[rT60]
		+ w[rXY01f] - w[rXY01b] + w[rXY13f] - w[rXY13b]
		+ w[rXY15f] - w[rXY15b] + w[rXY202] + w[rXY25]
		+ w[rXY33] + w[rXY34] + w[rXY35] + w[rXY36]
		+ w[rXY37] + w[rXY38];

	cdot[sPXC3H4] = w[rT60];

	cdot[sA1C2H4XC8H9] = - w[rE01f] + w[rE01b] + w[rE06f] - w[rE06b]
		+ w[rE07f] - w[rE07b] + w[rE08f] - w[rE08b]
		+ w[rE09f] - w[rE09b] + w[rE10f] - w[rE10b]
		- w[rE11f] + w[rE11b] - w[rE12f] + w[rE12b]
		- w[rE13f] + w[rE13b] - w[rE14f] + w[rE14b]
		- w[rE15f] + w[rE15b] - w[rE16f] + w[rE16b]
		- w[rE17f] + w[rE17b] - w[rE18f] + w[rE18b]
		- w[rE19] - w[rE30] - w[rE31] + w[rE32];

	cdot[sA1C2H5XC8H10] = w[rE01f] - w[rE01b] + w[rE02f] - w[rE02b]
		+ w[rE03f] - w[rE03b] - w[rE04f] + w[rE04b]
		- w[rE05f] + w[rE05b] - w[rE06f] + w[rE06b]
		- w[rE07f] + w[rE07b] - w[rE08f] + w[rE08b]
		- w[rE09f] + w[rE09b] - w[rE10f] + w[rE10b];

	cdot[sC8H9O2] = w[rE30] - w[rE32] - w[rE33] - w[rE34]
		- w[rE35] + w[rE35] - w[rE36];
	...
	cdot[sA1CH3CH2XC8H9] = w[rXY00f] - w[rXY00b] + w[rXY02f] - w[rXY02b]
		...
		+ w[rXY15b] - w[rXY16f] + w[rXY16b] - w[rXY17]
		- w[rXY18f] + w[rXY18b] - w[rXY19f] + w[rXY19b]
		- w[rXY201] - w[rXY202] - w[rXY203] - w[rXY22];

	cdot[sA1CH3CHOXC8H8O] = w[rXY14f] - w[rXY14b] + w[rXY17] + w[rXY18f]
		- w[rXY18b] + w[rXY201] - w[rXY23f] + w[rXY23b]
		- w[rXY24] - w[rXY25] - w[rXY26f] + w[rXY26b]
		- w[rXY27f] + w[rXY27b] - w[rXY28f] + w[rXY28b]
		- w[rXY29f] + w[rXY29b] - w[rXY30f] + w[rXY30b]
		- w[rXY31f] + w[rXY31b] - w[rXY33] - w[rXY34]
		- w[rXY35] - w[rXY36] - w[rXY37] - w[rXY38]
		- w[rXY39f] + w[rXY39b] - w[rXY40f] + w[rXY40b]
		- w[rXY41f] + w[rXY41b] - w[rXY42];
	...
	cdot[sA1CHOCH2XC8H7O] = w[rXY23f] - w[rXY23b] + w[rXY26f] - w[rXY26b]
		...
		- w[rXY44] - w[rXY45f] + w[rXY45b] - w[rXY46]
		- w[rXY47f] + w[rXY47b] - w[rXY48];

	cdot[sA1CHOCHOXC8H6O2] = w[rXY43f] - w[rXY43b] + w[rXY46] + w[rXY47f]
		- w[rXY47b] + w[rXY48] - w[rXY50] - w[rXY51]
		- w[rXY52] - w[rXY53] - w[rXY54] - w[rXY55]
		- w[rXY56] - w[rXY57f] + w[rXY57b] - w[rXY58];
	...
	cdot[sA2CH2XC11H9] = w[rN04f] - w[rN04b] - w[rN06f] + w[rN06b]
		...
		+ w[rN13f] - w[rN13b] - w[rN16f] + w[rN16b]
		- w[rN17] - w[rN18f] + w[rN18b] - w[rN19]
		- w[rN20f] + w[rN20b] - w[rN21f] + w[rN21b];

	cdot[sA2CH2OXC11H9O] = w[rN16f] - w[rN16b] + w[rN17] + w[rN18f]
		- w[rN18b] - w[rN22f] + w[rN22b] - w[rN23f]
		+ w[rN23b] - w[rN24f] + w[rN24b] - w[rN25f]
		+ w[rN25b] - w[rN26f] + w[rN26b] - w[rN27f]
		+ w[rN27b];

	cdot[sA2CHOXC11H8O] = w[rN20f] - w[rN20b] + w[rN22f] - w[rN22b]
		+ w[rN24f] - w[rN24b] + w[rN25f] - w[rN25b]
		+ w[rN26f] - w[rN26b] + w[rN27f] - w[rN27b]
		- w[rN28] - w[rN29] - w[rN30] - w[rN31]
		- w[rN32] - w[rN33] - w[rN34];
...
/*
	...
	The parameter h and cp should provide workspace of length 135 */
