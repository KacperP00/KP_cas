...
*/
	...
	k[r12f] = 3.2500000000E+16 * exp( -2 * lgt );
	...
	k[r100] = 2.3200000000E+26 * exp( -5 * lgt - 75100000 / rt );
	...
	k[r517] = 3.9000000000E+09 * exp( -48600000 / rt );
	k[r518] = 9.6000000000E+09 * exp( -39800000 / rt );
	k[r519] = 9.6000000000E+09 * exp( -39800000 / rt );
	k[r520] = 9.6000000000E+09 * exp( -39800000 / rt );
	k[r521] = 9.6000000000E+09 * exp( -39800000 / rt );
	...
	k[rl10b] = 4.0000000000E+14 * exp( -117100000 / rt );
	k[rl20f] = 2.0000000000E+09;
	k[rl20b] = 4.0000000000E+14 * exp( -117100000 / rt );
	k[rl30f] = 2.0000000000E+09;
	k[rl30b] = 4.0000000000E+14 * exp( -117100000 / rt );
	k[rl40f] = 2.0000000000E+09;
	k[rl40b] = 4.0000000000E+14 * exp( -117100000 / rt );
	k[rl50f] = 2.0000000000E+09;
	k[rl50b] = 4.0000000000E+14 * exp( -117100000 / rt );
	k[rl60f] = 6.4000000000E+12 * exp( -61100000 / rt );
	k[rl60b] = 2.0000000000E+11 * exp( -27600000 / rt );
	k[rl61] = 1.1000000000E+09 * exp( -31400000 / rt );
	k[rl62] = 2.0000000000E+13 * exp( -62800000 / rt );
	k[rb5f] = 2.4000000000E+14 * exp( -301500000 / rt );
	k[rb5b] = 3.5500000000E+08 * exp( 23400000 / rt );
	k[rb425] = 1.3000000000E+06 * exp( 1.3 * lgt - 2900000 / rt );
	k[rb395] = 2.5000000000E+16 * exp( -297700000 / rt );
	k[rb396] = 1.0000000000E+10;
	k[rl70] = 5.0000000000E+08;
	k[rl80] = 2.0000000000E+11 * exp( -71200000 / rt );
	k[rl90] = 1.1000000000E+09 * exp( -31400000 / rt );
	k[rl100] = 1.4400000000E+15 * exp( -180100000 / rt );
	k[rl110] = 2.0000000000E+13 * exp( -62800000 / rt );
	...
	k[rs266] = 5.5000000000E+09 * exp( -10000000 / rt );
	kTroe0 = 4.4990000000E+20 * exp( -3.28 * lgt - 42700000 / rt );
	kTroeInf = 3.7000000000E+04 * exp( 1.33 * lgt - 8800000 / rt );
	fcTroe = 1 * exp( -0 / temp );
	k[rs268] = GetLindRateCoeff( temp, pressure, kTroe0, kTroeInf
				, fcTroe, -1.0 );
	k[rs271] = 5.0000000000E+08;
	k[rs272] = 2.0000000000E+08 * exp( -8370000 / rt );
	k[rs273] = 1.0000000000E+10;
	k[rs274f] = 4.0000000000E+13 * exp( -305000000 / rt );
	k[rs276] = 1.0000000000E+15 * exp( -450000000 / rt );
	k[rsA276] = 4.5000000000E+13 * exp( -303430000 / rt );
	k[rs277] = 4.4100000000E+29 * exp( -3.9 * lgt - 489900000 / rt );
	k[rs278f] = 7.9000000000E+10 * exp( -41800000 / rt );
	k[rs279f] = 1.6300000000E+05 * exp( 1.42 * lgt - 6100000 / rt );
	k[rs280f] = 3.5530000000E-02 * exp( 3.8 * lgt - 3930000 / rt );
	k[rsA280f] = 6.3000000000E+10 * exp( -251040000 / rt );
	k[rs281f] = 2.7800000000E+10 * exp( -20540000 / rt );
	k[rs2A281f] = 5.0000000000E+10 * exp( -4180000 / rt );
	k[rs275] = 8.0900000000E+08 * exp( -31250000 / rt );
	k[rs3A281f] = 2.5000000000E+11;
	k[rs284f] = 1.1500000000E+11 * exp( -51880000 / rt );
	k[rsA284f] = 2.2100000000E+10 * exp( -33080000 / rt );
	k[rs285f] = 6.0000000000E+09;
	...
	k[rs288f] = 1.0000000000E+11;
	k[rs290] = 1.0000000000E+10;
	k[rs292f] = 1.0000000000E+11;
	k[rs295f] = 2.0000000000E+10;
	k[rs296] = 1.0000000000E+10;
	k[rs298f] = 1.0000000000E+11;
	k[rs301f] = 2.0000000000E+10;
	k[rs303f] = 1.0000000000E+10;
	k[rs304f] = 1.0000000000E+10;
	k[rs306f] = 1.0000000000E+10;
	k[rs307f] = 7.9000000000E+10 * exp( -41800000 / rt );
	k[rs308f] = 1.6300000000E+05 * exp( 1.4 * lgt - 6100000 / rt );
	k[rs309f] = 2.0000000000E+10;
	...
	k[rF2f] = 3.1000000000E+15 * exp( -373000000 / rt );
	k[rAF2f] = 1.2000000000E+10 * exp( -5379000 / rt );
	k[rF3f] = 5.1900000000E+05 * exp( 1 * lgt - 3658000 / rt );
	k[rF4f] = 3.9800000000E-01 * exp( 3.44 * lgt - 13050000 / rt );
	k[rF5f] = 1.2000000000E+10 * exp( -21540000 / rt );
	k[rA2F9] = 4.5800000000E+07 * exp( 1580000 / rt );
	k[rF12f] = 6.0000000000E+10;
	k[rAF12f] = 1.5800000000E+10;
	k[rF13] = 1.2000000000E+12 * exp( -173000000 / rt );
	k[rF14] = 5.1900000000E+06 * exp( 1 * lgt - 3658000 / rt );
	k[rF15] = 3.9800000000E-01 * exp( 3.44 * lgt - 13050000 / rt );
	k[rF16f] = 1.2000000000E+10 * exp( -21540000 / rt );
	k[rF18f] = 7.8100000000E+09;
	k[rF19f] = 8.8200000000E+05 * exp( 1.62 * lgt - 4560000 / rt );
	k[rF21f] = 6.0000000000E+09 * exp( -7570000 / rt );
	k[rF26f] = 3.9800000000E+14 * exp( -123000000 / rt );
	k[rF30f] = 2.7800000000E+10 * exp( -20540000 / rt );
	k[rA3F32f] = 3.5530000000E-02 * exp( 3.8 * lgt - 3930000 / rt );
	k[rA4F32f] = 6.3000000000E+10 * exp( -251040000 / rt );
	k[rF31f] = 5.0000000000E+10 * exp( -4180000 / rt );
	k[rF32f] = 2.0900000000E+09 * exp( -31250000 / rt );
	k[rF33f] = 2.5100000000E+11 * exp( -183700000 / rt );
	k[rF33b] = 9.5000000000E+00 * exp( 1.4 * lgt - 111110000 / rt );
	k[rF34f] = 2.5000000000E+11;
	k[rF35f] = 6.0000000000E+09;
	k[rF36f] = 1.1500000000E+11 * exp( -51880000 / rt );
	k[rF37f] = 2.2100000000E+10 * exp( -33080000 / rt );
	k[rF38f] = 1.2600000000E+10 * exp( -12130000 / rt );
	k[rF39f] = 1.0000000000E+11;
	k[rF40f] = 1.0000000000E+11;
	k[rF43f] = 3.0000000000E+10;
	k[rF44f] = 2.1900000000E+05 * exp( 1.77 * lgt - 12550000 / rt );
	k[rF46f] = 3.4300000000E+06 * exp( 1.18 * lgt + 1870000 / rt );
	k[rF49f] = 1.0000000000E+10 * exp( -86660000 / rt );
	k[rF50f] = 2.5100000000E+11 * exp( -183680000 / rt );
	k[rF51f] = 8.0000000000E+10;
	k[rF52f] = 8.0000000000E+10;
	...
	w[r66] = k[r66] * c[sCH2OH] * M[mM1];
	w[r67] = k[r67] * c[sCH2OH] * c[sH];
	w[r68f] = k[r68f] * c[sCH2OH] * c[sO2];
	...
	w[r210f] = k[r210f] * c[sC2H2] * c[sC2H];
	...
	w[r517] = k[r517] * c[sNXC10H22] * c[sCH3];
	w[r518] = k[r518] * c[sNXC10H22] * c[sCH3];
	w[r519] = k[r519] * c[sNXC10H22] * c[sCH3];
	w[r520] = k[r520] * c[sNXC10H22] * c[sCH3];
	w[r521] = k[r521] * c[sNXC10H22] * c[sCH3];
	...
	w[rl10b] = k[rl10b] * c[sC10H21O2];
	w[rl20f] = k[rl20f] * c[s2XC10H21] * c[sO2];
	w[rl20b] = k[rl20b] * c[sC10H21O2];
	w[rl30f] = k[rl30f] * c[s3XC10H21] * c[sO2];
	w[rl30b] = k[rl30b] * c[sC10H21O2];
	w[rl40f] = k[rl40f] * c[s4XC10H21] * c[sO2];
	w[rl40b] = k[rl40b] * c[sC10H21O2];
	w[rl50f] = k[rl50f] * c[s5XC10H21] * c[sO2];
	w[rl50b] = k[rl50b] * c[sC10H21O2];
	w[rl60f] = k[rl60f] * c[sC10H21O2];
	w[rl60b] = k[rl60b] * c[sNDECOOHXC10H20OOH];
	w[rl61] = k[rl61] * c[sNDECOOHXC10H20OOH];
	w[rl62] = k[rl62] * c[sC10H20O];
	w[rb5f] = k[rb5f] * c[sC3H6O];
	w[rb5b] = k[rb5b] * c[sCH3CO] * c[sCH3];
	w[rb425] = k[rb425] * c[s1XC7H14] * c[sOH];
	w[rb395] = k[rb395] * c[s1XC7H14];
	w[rb396] = k[rb396] * c[sPXC4H9] * c[sC3H5];
	w[rl70] = k[rl70] * c[sNDECOOHXC10H20OOH] * c[sO2];
	w[rl80] = k[rl80] * c[sOOC10OOHXOOC10H20OOH];
	w[rl90] = k[rl90] * c[sHO4C10HXHOOC10H19OOH];
	w[rl100] = k[rl100] * c[sOC10OOHXOC10H19OOH];
	w[rl110] = k[rl110] * c[sOC10H19O];
	w[rs257f] = k[rs257f] * c[sUXC4H3] * c[sC2H2];
	w[rs260f] = k[rs260f] * c[sC3H3] * c[sC3H3];
	w[rs261f] = k[rs261f] * c[sC3H4] * c[sC3H3];
	w[rs266] = k[rs266] * c[sC6H6] * c[sH];
	w[rs268] = k[rs268] * c[sUXC4H5] * c[sC2H2];
	...
	w[rs292f] = k[rs292f] * c[sA1C2HXC8H6] * c[sH];
	w[rs295f] = k[rs295f] * c[sA1C2HXC8H6] * c[sCH3];
	w[rs296] = k[rs296] * c[sA1C2HXXC8H5] * c[sO2];
	w[rs298f] = k[rs298f] * c[sA1C2HXC8H6] * c[sH];
	w[rs301f] = k[rs301f] * c[sA1C2HXC8H6] * c[sCH3];
	w[rs303f] = k[rs303f] * c[sA1C2HYXC8H5] * c[sC2H2];
	w[rs304f] = k[rs304f] * c[sA1C2HACXC10H7];
	w[rs306f] = k[rs306f] * c[sA2XXXC10H7] * c[sH];
	w[rs307f] = k[rs307f] * c[sA2XC10H8] * c[sH];
	w[rs308f] = k[rs308f] * c[sA2XC10H8] * c[sOH];
	w[rs309f] = k[rs309f] * c[sA2XC10H8] * c[sC2H];
	...
	w[rF2f] = k[rF2f] * c[sA2CH3XC11H10];
	w[rAF2f] = k[rAF2f] * c[sA2CH3XC11H10] * c[sO];
	w[rF3f] = k[rF3f] * c[sA2CH3XC11H10] * c[sOH];
	w[rF4f] = k[rF4f] * c[sA2CH3XC11H10] * c[sH];
	w[rF5f] = k[rF5f] * c[sA2CH3XC11H10] * c[sH];
	w[rA2F9] = k[rA2F9] * c[sA2CH2XC11H9] * c[sO2];
	w[rF12f] = k[rF12f] * c[sA2CH2XC11H9] * c[sOH];
	w[rAF12f] = k[rAF12f] * c[sA2CH2XC11H9] * c[sOH];
	w[rF13] = k[rF13] * c[sA2CH2OHXC11H9OH] * c[sO2];
	w[rF14] = k[rF14] * c[sA2CH2OHXC11H9OH] * c[sOH];
	w[rF15] = k[rF15] * c[sA2CH2OHXC11H9OH] * c[sH];
	w[rF16f] = k[rF16f] * c[sA2CH2OHXC11H9OH] * c[sH];
	w[rF18f] = k[rF18f] * c[sA2CHOXC11H8O] * c[sOH];
	w[rF19f] = k[rF19f] * c[sA2CHOXC11H8O] * c[sH];
	w[rF21f] = k[rF21f] * c[sA2CHOXC11H8O] * c[sO];
	w[rF26f] = k[rF26f] * c[sA2COXC11H7O];
	w[rF30f] = k[rF30f] * c[sA2XC10H8] * c[sO];
	w[rA3F32f] = k[rA3F32f] * c[sA2XC10H8] * c[sO];
	w[rA4F32f] = k[rA4F32f] * c[sA2XC10H8] * c[sO2];
	w[rF31f] = k[rF31f] * c[sA2XXXC10H7] * c[sHO2];
	w[rF32f] = k[rF32f] * c[sA2XXXC10H7] * c[sO2];
	w[rF33f] = k[rF33f] * c[sA2OXC10H7O];
	w[rF33b] = k[rF33b] * c[sINDENYLXC9H7] * c[sCO];
	w[rF34f] = k[rF34f] * c[sA2OXC10H7O] * c[sH];
	w[rF35f] = k[rF35f] * c[sA2OHXC10H7OH] * c[sOH];
	w[rF36f] = k[rF36f] * c[sA2OHXC10H7OH] * c[sH];
	w[rF37f] = k[rF37f] * c[sA2OHXC10H7OH] * c[sH];
	w[rF38f] = k[rF38f] * c[sA2OHXC10H7OH] * c[sO];
	w[rF39f] = k[rF39f] * c[sINDENYLXC9H7] * c[sH];
	w[rF40f] = k[rF40f] * c[sINDENYLXC9H7] * c[sO];
	w[rF43f] = k[rF43f] * c[sINDENYLXC9H7] * c[sHO2];
	w[rF44f] = k[rF44f] * c[sINDENEXC9H8] * c[sH];
	w[rF46f] = k[rF46f] * c[sINDENEXC9H8] * c[sOH];
	w[rF49f] = k[rF49f] * c[sINDENEXC9H8] * c[sO2];
	w[rF50f] = k[rF50f] * c[sINDENOXYXC9H7O];
	w[rF51f] = k[rF51f] * c[sA1XXC6H5] * c[sC2H2];
	w[rF52f] = k[rF52f] * c[sA1C2HXC8H6] * c[sH];
	...
	cdot[sO2] = - w[r1f] - w[r5f] + w[r7f] + w[r8f]
		...
		- w[r39] - w[r40] - w[r58] + w[r65]
		- w[r68f] - w[r78] - w[r125] - w[ra125]
		- w[r122] - w[r144] - w[r193] - w[r180f]
		...
		- w[rs275] - w[rsA49f] - w[rs296] - w[rs335]
		- w[rF1f] - w[rA2F9] - w[rF13] - w[rA4F32f]
		- w[rF32f] - w[rF49f];
	...
	cdot[sH] = - w[r1f] + w[r2f] + w[r3f] - w[r5f]
		...
		- w[r235f] - w[r236f] - w[r237] - w[r248f]
		+ w[r241f] - w[r258] - w[r374] - w[r433]
		- w[r522] - w[r523] - w[r524] - w[r525]
		- w[r526] + w[rs261f] - w[rs266] + w[rs272]
		+ w[rs273] + w[rs277] - w[rs278f] + w[rs281f]
		- w[rs3A281f] - w[rs284f] - w[rsA284f] - w[rsA39f]
		- w[rsA44f] - w[rs288f] - w[rs292f] - w[rs298f]
		- w[rs306f] - w[rs307f] + w[rs313f] - w[rs315f]
		- w[rs319f] - w[rs322f] - w[rs329f] + w[rs342f]
		- w[rs342b] - w[rF4f] - w[rF5f] + w[rF13]
		+ w[rF14] - w[rF15] + w[rF15] - w[rF16f]
		- w[rF19f] + w[rF30f] - w[rF34f] - w[rF36f]
		- w[rF37f] - w[rF39f] - w[rF44f] - w[rF52f];

	cdot[sOH] = w[r1f] + w[r2f] - w[r3f] - 2 * w[r4f]
		+ 2 * w[r6f] - w[r8f] + w[r10f] - 2 * w[r12f]
		+ w[r14f] + w[r15f] - w[r16f] - w[r18f]
		- w[r20f] + w[r21] - w[r32] + w[r39]
		- w[r51] + w[r58] - w[r59] + w[r60]
		+ w[r61] - w[r73f] - w[r85f] - w[r91f]
		- w[r116f] - w[r128] - w[r153] - w[r164]
		- w[r176] - w[r208] - w[r226f] - w[r227]
		- w[r250] - w[r265] - w[r279] - w[r354]
		- w[r409] - w[r502] - w[r503] - w[r504]
		- w[r505] - w[r506] + w[rl61] - w[rb425]
		+ w[rl90] + w[rl100] - w[rs279f] + w[rs280f]
		+ w[rs2A281f] + w[rsA284f] - w[rs285f] + w[rsA285f]
		+ w[rsA43f] + w[rsA45f] - w[rsA46f] + w[rsA49f]
		- w[rs290] - w[rs308f] - w[rs334] - w[rs339]
		+ w[rAF2f] - w[rF3f] + w[rA2F9] - w[rF12f]
		- w[rAF12f] - w[rF14] - w[rF18f] + w[rF21f]
		+ w[rA3F32f] + w[rF31f] - w[rF35f] + w[rF37f]
		+ w[rF38f] + w[rF43f] - w[rF46f] + w[rF49f];

	cdot[sO] = w[r1f] - w[r2f] + w[r4f] + w[r9f]
		- w[r10f] - w[r15f] - 2 * w[r19f] - w[r22]
		- w[r24] + w[r25] - w[r57] + w[r78]
		- w[r80] - w[r86] - w[r87] - w[r90f]
		- w[r145] - w[rs280f] - w[rs281f] + w[rs275]
		- w[rsA285f] - w[rsA40f] - w[rsA41f] - w[rsA45f]
		- w[rAF2f] - w[rF21f] - w[rF30f] - w[rA3F32f]
		+ w[rF32f] - w[rF38f] - w[rF40f];
	...
	cdot[sH2] = - w[r2f] - w[r3f] + w[r7f] + w[r13f]
		...
		+ w[r248f] + w[r258] + w[r374] + w[r433]
		+ w[r522] + w[r523] + w[r524] + w[r525]
		+ w[r526] + w[rs278f] + w[rs284f] + w[rsA44f]
		+ w[rs292f] + w[rs298f] + w[rs307f] + w[rs315f]
		+ w[rs322f] + w[rs329f] + w[rF4f] + w[rAF12f]
		+ w[rF15] + w[rF19f] + w[rF36f] + w[rF44f];
	...
	cdot[sH2O] = w[r3f] + w[r4f] + w[r8f] + w[r9f]
		...
		+ w[r502] + w[r503] + w[r504] + w[r505]
		+ w[r506] + w[rb425] + w[rs279f] + w[rs285f]
		+ w[rsA46f] + w[rs308f] + w[rF3f] + w[rF14]
		+ w[rF18f] + w[rF35f] + w[rF46f];

	cdot[sHO2] = w[r5f] - w[r6f] - w[r7f] - w[r8f]
		- w[r9f] - w[r10f] - 2 * w[r11f] + w[r13f]
		+ w[r15f] + w[r16f] - w[r21] - w[r61]
		- w[r65] + w[r68f] + w[r125] + w[r122]
		+ w[r193] + w[r180f] + w[r244] - w[r269]
		+ w[r294] - w[r364] - w[r421] + w[r497]
		+ w[r498] + w[r499] + w[r500] + w[r501]
		- w[r512] - w[r513] - w[r514] - w[r515]
		- w[r516] + w[rsA280f] - w[rs2A281f] - w[rsA43f]
		+ w[rF1f] + w[rF13] + w[rA4F32f] - w[rF31f]
		- w[rF43f];
	...
	cdot[sCO] = - w[r20f] - w[r21] - w[r22] + w[r24]
		...
		+ w[r39] + w[r79f] + 2 * w[r80] + w[r86]
		+ w[r88] + w[r89f] + w[r100] + w[r143]
		+ w[rl110] + w[rsA33f] + w[rsA40f] + w[rsA50f]
		+ 2 * w[rs296] + 2 * w[rs335] + w[rF26f] + w[rF33f]
		- w[rF33b] + w[rF40f] + w[rF50f];
	...
	cdot[sHCO] = w[r25] + w[r26] - w[r28f] - w[r29]
		- w[r32] + w[r48] + w[r49] + w[r51]
		+ 2 * w[r90f] + w[r91f] + w[ra125] + w[r144]
		+ 2 * w[r243] + w[rs339];

	cdot[sCH2OH] = w[r27f] + w[r59] - w[r60] + w[r61]
		- w[r66] - w[r67] - w[r68f] - w[rm69]
		- w[rm70] + w[rF16f];
	...
	cdot[sC2H2] = w[r42] + w[r43] - w[r84f] - w[r85f]
		...
		+ w[r157f] - w[r207f] + w[r208] - w[r210f]
		- 2 * w[r211f] - w[r221f] - w[r234f] - w[rs257f]
		- w[rs268] + w[rs276] + w[rsA276] + w[rs288f]
		- w[rs303f] + w[rs309f] - w[rs313f] + w[rs319f]
		- w[rs326f] - w[rs333f] - w[rF51f];

	cdot[sCH3] = - w[r44] + w[r46f] - w[r56f] - w[r57]
		- w[r58] - w[r59] + w[r60] - w[r61]
		- w[r62f] - 2 * w[r63] - 2 * w[r64] - w[r65]
		+ w[r71f] + w[r73f] + w[r89f] + w[r100]
		- w[r117f] - w[r120] - w[r129f] - w[r149]
		+ w[r157f] - w[r168] + w[r169f] - w[r172f]
		+ w[r178f] - w[r245f] + w[r255f] + w[r335]
		- w[r369] - w[r427] - w[r517] - w[r518]
		- w[r519] - w[r520] - w[r521] + w[rb5f]
		- w[rb5b] - w[rs295f] - w[rs301f] - w[rs310f]
		- w[rs318f] - w[rs325f] - w[rs332f] + w[rF2f]
		+ w[rF5f];

	cdot[sC2H4] = w[r44] + w[r64] + w[r76] - w[r113f]
		- w[r115f] - w[r116f] - w[r117f] + w[r119f]
		+ w[r120] + w[r121] + w[r122] + w[r178f]
		+ w[rm242] + w[r292] + w[r336] + w[r381]
		+ w[r387] + w[r444] + w[r456] + w[r468]
		+ w[r485];

	cdot[s1XCH2] = - w[r45f] - w[r46f] - w[r141f];

	cdot[sCH2O] = - w[r48] - w[r49] - w[r51] + w[r57]
		+ w[r58] + w[r66] + w[r67] + w[r68f]
		+ w[rm69] + w[rm70] + w[r91f] + w[ra125]
		+ w[r145] + w[r153] + w[r164] + w[r176]
		+ w[r265] + w[rl110];

	cdot[sCH4] = w[r62f] + w[r65] - w[r71f] - w[r73f]
		- w[r76] + w[r117f] + w[r120] + w[r129f]
		+ w[r149] + w[r168] + w[r172f] + w[r369]
		+ w[r427] + w[r517] + w[r518] + w[r519]
		+ w[r520] + w[r521] + w[rs295f] + w[rs301f]
	...
	cdot[sCH3CO] = - w[r100] + w[rb5f] - w[rb5b];

	cdot[sC2H5] = - w[r119f] - w[r120] - 2 * w[r121] - w[r122]
		+ w[r126f] + w[r128] + w[r129f] + w[r176]
		+ w[r292] + w[r333] + w[r347] + w[r386]
		+ w[r401];
	...
	cdot[sUXC4H3] = w[r210f] + w[r211f] + w[r224f] + w[r226f]
		- w[rs257f] + w[rsA276];
	...
	cdot[sUXC4H5] = w[r234f] + w[r236f] - w[rs268] + w[rsA40f]
		+ w[rsA50f];

	cdot[sSXC4H5] = w[r235f] - w[r237] - w[r243] + w[r248f]
		+ w[r250];
	...
	cdot[s1XC4H8] = - w[r255f] - w[r258] - w[r265] - w[r269]
		- w[r279] + w[r294] + w[r385] + w[r482]
		+ w[rb425];

	cdot[sPXC4H9] = - w[r292] - w[r294] + w[r444] + w[r484]
		+ w[rb395] - w[rb396];
	...
	cdot[sNXC10H22] = - w[r496] - w[r497] - w[r498] - w[r499]
		...
		- w[r517] - w[r518] - w[r519] - w[r520]
		- w[r521] - w[r522] - w[r523] - w[r524]
		- w[r525] - w[r526];

	cdot[sC10H21O2] = w[rl10f] - w[rl10b] + w[rl20f] - w[rl20b]
		+ w[rl30f] - w[rl30b] + w[rl40f] - w[rl40b]
		+ w[rl50f] - w[rl50b] - w[rl60f] + w[rl60b];

	cdot[sNDECOOHXC10H20OOH] = w[rl60f] - w[rl60b] - w[rl61] - w[rl70];

	cdot[sC10H20O] = w[rl61] - w[rl62];

	cdot[sC3H6O] = w[rl62] - w[rb5f] + w[rb5b];

	cdot[s1XC7H14] = w[rl62] - w[rb425] - w[rb395] + w[rb396];

	cdot[sOOC10OOHXOOC10H20OOH] = w[rl70] - w[rl80];

	cdot[sHO4C10HXHOOC10H19OOH] = w[rl80] - w[rl90];

	cdot[sOC10OOHXOC10H19OOH] = w[rl90] - w[rl100];

	cdot[sOC10H19O] = w[rl100] - w[rl110];

	cdot[sUXC6H5] = w[rs257f] + w[rs274f] + w[rs296];

	cdot[sC6H6] = w[rs260f] + w[rs261f] - w[rs266];

	cdot[sUXC6H7] = w[rs266] + w[rs268] - w[rs273];

	cdot[sA1XC6H6] = w[rs271] + w[rs272] + w[rs273] - w[rs276]
		- w[rs277] - w[rs278f] - w[rs279f] - w[rs280f]
		- w[rsA280f] - w[rs281f] + w[rsA284f] + w[rs290];

	cdot[sA1XXC6H5] = - w[rs274f] - w[rsA276] + w[rs277] + w[rs278f]
		+ w[rs279f] + w[rs280f] + w[rsA280f] - w[rs2A281f]
		- w[rs275] + w[rs288f] - w[rF51f];
	...
	cdot[sA1C2HXC8H6] = - w[rs288f] - w[rs290] - w[rs292f] - w[rs295f]
		- w[rs298f] - w[rs301f] - w[rF52f];

	cdot[sA1C2HXXC8H5] = w[rs292f] + w[rs295f] - w[rs296];

	cdot[sA1C2HYXC8H5] = w[rs298f] + w[rs301f] - w[rs303f];

	cdot[sA1C2HACXC10H7] = w[rs303f] - w[rs304f];

	cdot[sA2XXXC10H7] = w[rs304f] - w[rs306f] + w[rs307f] + w[rs308f]
		+ w[rs309f] + w[rs310f] - w[rs313f] + w[rs335]
		+ w[rF2f] + w[rF26f] + w[rA3F32f] + w[rA4F32f]
		- w[rF31f] - w[rF32f];

	cdot[sA2XC10H8] = w[rs306f] - w[rs307f] - w[rs308f] - w[rs309f]
		- w[rs310f] + w[rs334] + w[rF5f] + w[rF16f]
		- w[rF30f] - w[rA3F32f] - w[rA4F32f] + w[rF37f];
	...
	cdot[sA2CH3XC11H10] = - w[rF1f] - w[rF2f] - w[rAF2f] - w[rF3f]
		- w[rF4f] - w[rF5f];

	cdot[sA2CH2XC11H9] = w[rF1f] + w[rAF2f] + w[rF3f] + w[rF4f]
		- w[rA2F9] - w[rF12f] - w[rAF12f];

	cdot[sA2CHOXC11H8O] = w[rA2F9] + w[rAF12f] + w[rF13] + w[rF14]
		+ w[rF15] - w[rF18f] - w[rF19f] - w[rF21f];

	cdot[sA2CH2OHXC11H9OH] = w[rF12f] - w[rF13] - w[rF14] - w[rF15]
		- w[rF16f];

	cdot[sA2COXC11H7O] = w[rF18f] + w[rF19f] + w[rF21f] - w[rF26f];

	cdot[sA2OXC10H7O] = w[rF30f] + w[rF31f] + w[rF32f] - w[rF33f]
		+ w[rF33b] - w[rF34f] + w[rF35f] + w[rF36f]
		+ w[rF38f];

	cdot[sINDENYLXC9H7] = w[rF33f] - w[rF33b] - w[rF39f] - w[rF40f]
		- w[rF43f] + w[rF44f] + w[rF46f];

	cdot[sA2OHXC10H7OH] = w[rF34f] - w[rF35f] - w[rF36f] - w[rF37f]
		- w[rF38f];

	cdot[sINDENEXC9H8] = w[rF39f] - w[rF44f] - w[rF46f] - w[rF49f];

	cdot[sA1C2H2UXC8H7] = w[rF40f] + w[rF50f] + w[rF51f] + w[rF52f];

	cdot[sINDENOXYXC9H7O] = w[rF43f] + w[rF49f] - w[rF50f];
...
void GetMolarMass( double *W )
{
	...
	W[sC10H21O2] =  1.73268000e+02;
	W[sNDECOOHXC10H20OOH] =  1.73268000e+02;
	W[sC10H20O] =  1.56260000e+02;
	W[sC3H6O] =  5.80500000e+01;
	W[s1XC7H14] =  9.81820000e+01;
	W[sOOC10OOHXOOC10H20OOH] =  2.05268000e+02;
	W[sHO4C10HXHOOC10H19OOH] =  2.05268000e+02;
	W[sOC10OOHXOC10H19OOH] =  1.88260000e+02;
	W[sOC10H19O] =  1.71252000e+02;
	...
	W[sA2CH2OHXC11H9OH] =  1.58190000e+02;
	W[sA2COXC11H7O] =  1.55166000e+02;
	W[sA2OXC10H7O] =  1.43156000e+02;
	W[sINDENYLXC9H7] =  1.15146000e+02;
	W[sA2OHXC10H7OH] =  1.44164000e+02;
	W[sINDENEXC9H8] =  1.16154000e+02;
	W[sA1C2H2UXC8H7] =  1.03136000e+02;
	W[sINDENOXYXC9H7O] =  1.31146000e+02;
}
...
void GetSpeciesNames( char **names )
{
	...
	strcpy( names[sC10H21O2], "C10H21O2            " );
	strcpy( names[sNDECOOHXC10H20OOH], "NDECOOH-C10H20OOH   " );
	strcpy( names[sC10H20O], "C10H20O             " );
	strcpy( names[sC3H6O], "C3H6O               " );
	strcpy( names[s1XC7H14], "1-C7H14             " );
	strcpy( names[sOOC10OOHXOOC10H20OOH], "OOC10OOH-OOC10H20OOH" );
	strcpy( names[sHO4C10HXHOOC10H19OOH], "HO4C10H-HOOC10H19OOH" );
	strcpy( names[sOC10OOHXOC10H19OOH], "OC10OOH-OC10H19OOH  " );
	strcpy( names[sOC10H19O], "OC10H19O            " );
	...
	strcpy( names[sA1C2HXXC8H5], "A1C2H--C8H5         " );
	...
	strcpy( names[sA2CH2OHXC11H9OH], "A2CH2OH-C11H9OH     " );
	strcpy( names[sA2COXC11H7O], "A2CO-C11H7O         " );
	strcpy( names[sA2OXC10H7O], "A2O-C10H7O          " );
	strcpy( names[sINDENYLXC9H7], "INDENYL-C9H7        " );
	strcpy( names[sA2OHXC10H7OH], "A2OH-C10H7OH        " );
	strcpy( names[sINDENEXC9H8], "INDENE-C9H8         " );
	strcpy( names[sA1C2H2UXC8H7], "A1C2H2U-C8H7        " );
	strcpy( names[sINDENOXYXC9H7O], "INDENOXY-C9H7O      " );
}
...
/*
	...
	The parameter h and cp should provide workspace of length 103 */
	...
	if ( T > 1000.0 ) {
		...
		cp[sC2H3] =  3.07323871e+02 * (
			...
			+ T *  2.37864300e-14 ) ) ) );
		h[sCH3CO] =  1.93266853e+02 * (
			T * (  5.61227900e+00 + T * (  4.22494300e-03
			+ T * ( -9.51382333e-07 + T * (  1.05959400e-10
			+ T * -4.53680600e-15 ) ) ) ) -5.18786300e+03 );
		cp[sCH3CO] =  1.93266853e+02 * (
		...
		cp[sNXC10H22] =  5.84381062e+01 * (
			...
			+ T * -9.62121010e-14 ) ) ) );
		h[sC10H21O2] =  4.79854330e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sC10H21O2] =  4.79854330e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		h[sNDECOOHXC10H20OOH] =  4.79854330e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sNDECOOHXC10H20OOH] =  4.79854330e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		h[sC10H20O] =  5.32083707e+01 * (
			T * (  2.28188930e+01 + T * (  1.62717270e-02
			+ T * ( -3.70668033e-06 + T * (  4.28293575e-10
			+ T * -1.92424202e-14 ) ) ) ) -3.36787380e+04 );
		cp[sC10H20O] =  5.32083707e+01 * (
			 2.28188930e+01 + T * (  3.25434540e-02 
			+ T * ( -1.11200410e-05 + T * (  1.71317430e-09
			+ T * -9.62121010e-14 ) ) ) );
		h[sC3H6O] =  1.43227218e+02 * (
			T * (  8.70725730e+00 + T * (  7.99382650e-03
			+ T * ( -1.79209323e-06 + T * (  1.98556338e-10
			+ T * -8.44252440e-15 ) ) ) ) -6.93703520e+03 );
		cp[sC3H6O] =  1.43227218e+02 * (
			 8.70725730e+00 + T * (  1.59876530e-02 
			+ T * ( -5.37627970e-06 + T * (  7.94225350e-10
			+ T * -4.22126220e-14 ) ) ) );
		...
		cp[s1XC7H14] =  8.46829358e+01 * (
			...
			+ T *  1.89383770e-13 ) ) ) );
		h[sOOC10OOHXOOC10H20OOH] =  4.05048035e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sOOC10OOHXOOC10H20OOH] =  4.05048035e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		h[sHO4C10HXHOOC10H19OOH] =  4.05048035e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sHO4C10HXHOOC10H19OOH] =  4.05048035e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		h[sOC10OOHXOC10H19OOH] =  4.41641347e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sOC10OOHXOC10H19OOH] =  4.41641347e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		h[sOC10H19O] =  4.85503235e+01 * (
			T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) ) +  0.00000000e+00 );
		cp[sOC10H19O] =  4.85503235e+01 * (
			 0.00000000e+00 + T * (  0.00000000e+00 
			+ T * (  0.00000000e+00 + T * (  0.00000000e+00
			+ T *  0.00000000e+00 ) ) ) );
		...
		cp[sA2CHOXC11H8O] =  5.32376708e+01 * (
			...
			+ T * -1.45218180e-12 ) ) ) );
		h[sA2CH2OHXC11H9OH] =  5.25592010e+01 * (
			T * (  3.24103550e+01 + T * (  6.01160250e-03
			+ T * (  8.22978200e-07 + T * (  4.64507425e-11
			+ T *  1.12960802e-13 ) ) ) ) -1.80739340e+04 );
		cp[sA2CH2OHXC11H9OH] =  5.25592010e+01 * (
			 3.24103550e+01 + T * (  1.20232050e-02 
			+ T * (  2.46893460e-06 + T * (  1.85802970e-10
			+ T *  5.64804010e-13 ) ) ) );
		h[sA2COXC11H7O] =  5.35835170e+01 * (
			T * (  1.53382340e+01 + T * (  6.57121250e-03
			+ T * (  2.30059930e-06 + T * (  3.02705400e-10
			+ T * -3.94150260e-13 ) ) ) ) +  1.78536330e+04 );
		cp[sA2COXC11H7O] =  5.35835170e+01 * (
			 1.53382340e+01 + T * (  1.31424250e-02 
			+ T * (  6.90179790e-06 + T * (  1.21082160e-09
			+ T * -1.97075130e-12 ) ) ) );
		h[sA2OXC10H7O] =  5.80788790e+01 * (
			T * (  1.77268430e+01 + T * (  5.40478650e-03
			+ T * (  1.58202193e-06 + T * (  2.48925270e-10
			+ T * -1.33945600e-13 ) ) ) ) +  9.57138280e+03 );
		cp[sA2OXC10H7O] =  5.80788790e+01 * (
			 1.77268430e+01 + T * (  1.08095730e-02 
			+ T * (  4.74606580e-06 + T * (  9.95701080e-10
			+ T * -6.69728000e-13 ) ) ) );
		h[sINDENYLXC9H7] =  7.22069373e+01 * (
			T * (  1.31457040e+01 + T * (  7.56887800e-03
			+ T * (  2.86863027e-06 + T * (  2.71644575e-10
			+ T * -6.92702700e-13 ) ) ) ) +  3.40730660e+04 );
		cp[sINDENYLXC9H7] =  7.22069373e+01 * (
			 1.31457040e+01 + T * (  1.51377560e-02 
			+ T * (  8.60589080e-06 + T * (  1.08657830e-09
			+ T * -3.46351350e-12 ) ) ) );
		h[sA2OHXC10H7OH] =  5.76727893e+01 * (
			T * (  2.85889590e+01 + T * (  5.43877300e-03
			+ T * (  7.74980967e-07 + T * (  2.25722965e-11
			+ T *  5.71317680e-14 ) ) ) ) -1.57408270e+04 );
		cp[sA2OHXC10H7OH] =  5.76727893e+01 * (
			 2.85889590e+01 + T * (  1.08775460e-02 
			+ T * (  2.32494290e-06 + T * (  9.02891860e-11
			+ T *  2.85658840e-13 ) ) ) );
		h[sINDENEXC9H8] =  7.15803158e+01 * (
			T * ( -3.68085100e+01 + T * (  2.41219105e-02
			+ T * (  1.44263880e-05 + T * (  1.56908165e-09
			+ T * -4.49484660e-12 ) ) ) ) +  4.20337620e+04 );
		cp[sINDENEXC9H8] =  7.15803158e+01 * (
			-3.68085100e+01 + T * (  4.82438210e-02 
			+ T * (  4.32791640e-05 + T * (  6.27632660e-09
			+ T * -2.24742330e-11 ) ) ) );
		h[sA1C2H2UXC8H7] =  8.06153041e+01 * (
			T * (  1.68267440e+01 + T * (  6.02327450e-03
			+ T * (  1.79263513e-06 + T * (  7.22745675e-11
			+ T * -4.45790680e-13 ) ) ) ) +  4.01622580e+04 );
		cp[sA1C2H2UXC8H7] =  8.06153041e+01 * (
			 1.68267440e+01 + T * (  1.20465490e-02 
			+ T * (  5.37790540e-06 + T * (  2.89098270e-10
			+ T * -2.22895340e-12 ) ) ) );
		h[sINDENOXYXC9H7O] =  6.33975874e+01 * (
			T * (  1.49947540e+01 + T * (  7.74522400e-03
			+ T * (  2.81897033e-06 + T * (  2.46296290e-10
			+ T * -6.80359980e-13 ) ) ) ) +  1.29912020e+04 );
		cp[sINDENOXYXC9H7O] =  6.33975874e+01 * (
			 1.49947540e+01 + T * (  1.54904480e-02 
			+ T * (  8.45691100e-06 + T * (  9.85185160e-10
			+ T * -3.40179990e-12 ) ) ) );
	}
		...
		h[sCH3CO] =  1.93266853e+02 * (
			...
			+ T *  6.38743400e-13 ) ) ) ) -4.10850700e+03 );
		cp[sCH3CO] =  1.93266853e+02 * (
		...
		cp[sC10H20O] =  5.32083707e+01 * (
			...
			+ T *  2.08087300e-11 ) ) ) );
		h[sC3H6O] =  1.43227218e+02 * (
			T * (  4.83785030e-01 + T * (  1.42873505e-02
			+ T * (  9.34078333e-07 + T * ( -5.59288075e-09
			+ T *  2.11630880e-12 ) ) ) ) -4.06655570e+03 );
		cp[sC3H6O] =  1.43227218e+02 * (
			 4.83785030e-01 + T * (  2.85747010e-02 
			+ T * (  2.80223500e-06 + T * ( -2.23715230e-08
			+ T *  1.05815440e-11 ) ) ) );
		h[s1XC7H14] =  8.46829358e+01 * (
		...
		cp[sA2CHOXC11H8O] =  5.32376708e+01 * (
			...
			+ T *  2.53592110e-11 ) ) ) );
		h[sA2CH2OHXC11H9OH] =  5.25592010e+01 * (
			T * (  1.01882850e+00 + T * (  3.55420410e-02
			+ T * ( -1.59520110e-06 + T * ( -9.23041375e-09
			+ T *  3.45148900e-12 ) ) ) ) -7.85633250e+03 );
		cp[sA2CH2OHXC11H9OH] =  5.25592010e+01 * (
			 1.01882850e+00 + T * (  7.10840820e-02 
			+ T * ( -4.78560330e-06 + T * ( -3.69216550e-08
			+ T *  1.72574450e-11 ) ) ) );
		h[sA2COXC11H7O] =  5.35835170e+01 * (
			T * ( -7.29756780e+00 + T * (  3.52324210e-02
			+ T * ( -4.17938933e-06 + T * ( -1.03333200e-08
			+ T *  5.06534060e-12 ) ) ) ) +  2.34847480e+04 );
		cp[sA2COXC11H7O] =  5.35835170e+01 * (
			-7.29756780e+00 + T * (  7.04648420e-02 
			+ T * ( -1.25381680e-05 + T * ( -4.13332800e-08
			+ T *  2.53267030e-11 ) ) ) );
		h[sA2OXC10H7O] =  5.80788790e+01 * (
			T * ( -8.58593850e+00 + T * (  3.42375075e-02
			+ T * ( -3.06822617e-06 + T * ( -9.71199200e-09
			+ T *  4.35440460e-12 ) ) ) ) +  1.71742660e+04 );
		cp[sA2OXC10H7O] =  5.80788790e+01 * (
			-8.58593850e+00 + T * (  6.84750150e-02 
			+ T * ( -9.20467850e-06 + T * ( -3.88479680e-08
			+ T *  2.17720230e-11 ) ) ) );
		h[sINDENYLXC9H7] =  7.22069373e+01 * (
			T * ( -1.16719530e+01 + T * (  3.64090315e-02
			+ T * ( -2.65337953e-06 + T * ( -9.88790750e-09
			+ T *  4.17561440e-12 ) ) ) ) +  4.08638200e+04 );
		cp[sINDENYLXC9H7] =  7.22069373e+01 * (
			-1.16719530e+01 + T * (  7.28180630e-02 
			+ T * ( -7.96013860e-06 + T * ( -3.95516300e-08
			+ T *  2.08780720e-11 ) ) ) );
		h[sA2OHXC10H7OH] =  5.76727893e+01 * (
			T * ( -2.56072540e-03 + T * (  3.47063915e-02
			+ T * ( -2.92130880e-06 + T * ( -9.74289625e-09
			+ T *  4.09853680e-12 ) ) ) ) -6.99657370e+03 );
		cp[sA2OHXC10H7OH] =  5.76727893e+01 * (
			-2.56072540e-03 + T * (  6.94127830e-02 
			+ T * ( -8.76392640e-06 + T * ( -3.89715850e-08
			+ T *  2.04926840e-11 ) ) ) );
		h[sINDENEXC9H8] =  7.15803158e+01 * (
			T * ( -1.68956740e+01 + T * (  4.73692045e-02
			+ T * ( -1.13360803e-05 + T * ( -1.45709907e-08
			+ T *  1.05932076e-11 ) ) ) ) +  2.56881170e+04 );
		cp[sINDENEXC9H8] =  7.15803158e+01 * (
			-1.68956740e+01 + T * (  9.47384090e-02 
			+ T * ( -3.40082410e-05 + T * ( -5.82839630e-08
			+ T *  5.29660380e-11 ) ) ) );
		h[sA1C2H2UXC8H7] =  8.06153041e+01 * (
			T * ( -1.14373020e+00 + T * (  2.87340040e-02
			+ T * ( -3.32947273e-06 + T * ( -8.34017825e-09
			+ T *  3.86723840e-12 ) ) ) ) +  4.46435430e+04 );
		cp[sA1C2H2UXC8H7] =  8.06153041e+01 * (
			-1.14373020e+00 + T * (  5.74680080e-02 
			+ T * ( -9.98841820e-06 + T * ( -3.33607130e-08
			+ T *  1.93361920e-11 ) ) ) );
		h[sINDENOXYXC9H7O] =  6.33975874e+01 * (
			T * ( -9.66275600e+00 + T * (  3.64235600e-02
			+ T * ( -2.67874110e-06 + T * ( -9.86713200e-09
			+ T *  4.16917720e-12 ) ) ) ) +  1.97319800e+04 );
		cp[sINDENOXYXC9H7O] =  6.33975874e+01 * (
			-9.66275600e+00 + T * (  7.28471200e-02 
			+ T * ( -8.03622330e-06 + T * ( -3.94685280e-08
			+ T *  2.08458860e-11 ) ) ) );
	}
	else {
