...
*/
	...
	M[mM1] = 0.4 * c[sN2] + 0.4 * c[sO2] + c[sH] + c[sOH]
		 ...
		 + 3 * c[sCH4] + c[sCH3O] + c[sC2H6] + c[sHCCO]
		 + c[sC2H3] + c[sC2H5] + c[sC3H4] + c[sC3H5]
		 + c[sC3H6] + c[sNXC3H7] + c[s1XC4H8] + c[sPXC4H9]
		 + c[s1XC5H11] + c[sC6H11] + c[s1XC6H12] + c[s1XC7H15]
		 + c[s2XC7H15] + 3 * c[sNXC7H16] + c[s1C7H15O2XC7H15O2] + c[s1HEOOHX2XC7H15O2]
		 + c[s2OO7OOH1XO2C7H15O2] + c[s1X2HEOOHXO2C7H14OOH] + c[sOC7OOHXOC7H13OOH] + c[s1X2HEPOOXOC7H13O];
	...
	cdot[sCH2OH] = w[r27f] - w[r27b] - w[r69f] + w[r69b]
	...
	cdot[sCH3O] = w[r55] + w[r58f] - w[r58b] - w[r62f]
		+ w[r62b] - w[r63f] + w[r63b] - w[r64f]
		+ w[r64b];
...
void GetSpeciesNames( char **names )
{
	...
	strcpy( names[s1XC4H8], "P-C4H8              " );
	strcpy( names[sPXC4H9], "P-C4H9              " );
	strcpy( names[s1XC5H11], "P-C5H11             " );
	strcpy( names[sC6H11], "C6H11               " );
	strcpy( names[s1XC6H12], "P-C6H12             " );
	strcpy( names[s1XC7H15], "P-C7H15             " );
	strcpy( names[s2XC7H15], "S-C7H15             " );
	strcpy( names[sNXC7H16], "N-C7H16             " );
	strcpy( names[s1C7H15O2XC7H15O2],    "PC7H15O2            " );
	strcpy( names[s1HEOOHX2XC7H15O2],    "PHEOOH-2            " );
	strcpy( names[s2OO7OOH1XO2C7H15O2],  "SOO7OOH1            " );
	strcpy( names[s1X2HEOOHXO2C7H14OOH], "P-2HEOOH            " );
	strcpy( names[sOC7OOHXOC7H13OOH],    "OC7OOH              " );
	strcpy( names[s1X2HEPOOXOC7H13O],    "P-2HEPOO            " );
}
...
/*
	...
	The parameter h and cp should provide workspace of length 44 */
