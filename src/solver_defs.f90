...
!!$            solver%Flux, solver%alpha_l, solver%alpha_g)
    ...
    allocate(solver%W(13,nzo)); solver%W = 0.0_WP
    allocate(solver%Wold(13,nzo)); solver%Wold = 0.0_WP
    allocate(solver%F(13,nzo)); solver%F = 0.0_WP
    allocate(solver%S(13,nzo)); solver%S = 0.0_WP
    allocate(solver%Res(13,nzo)); solver%Res = 0.0_WP
