...
subroutine pc_1butanol(pc)
    ...
    pc%Tcrit = 563.05;             ! K    
    pc%pcrit = 4.4230E06;          ! Pa 
    pc%vcrit = 0.27400;            ! m^3/kmol 
    pc%CritCompressFactor = 0.260; ! -
    
 
    pc%MeltingPoint = 183.85;              ! K
    pc%TripletPointT = 184.51;             ! K
    pc%TripletPointp = 5.7220E-04;         ! Pa
    pc%NormalBoilingPoint = 390.81;        ! K
    pc%liqMolarVolume = 0.091991;          ! m^3/kmol
    
 
    pc%IG_HeatOfFormation = -2.7460E08;             ! J/kmol
    pc%IG_GibbsOfFormation = -1.5030E08;            ! J/kmol
    pc%IG_AbsoluteEntropy =  3.6148E05;             ! J/kmolK
    pc%HeatFusionAtMeltPoint =  9.3720E06;          ! J/kmol
    pc%StandardNetHeatOfCombustion = -2.4560E09;    ! J/kmol
    ...
    pc%AcentricFactor = 0.5935;            ! -
    pc%RadiusOfGyration = 3.2250E-10;      ! m
    pc%SolubilityParameter = 2.3350E04;    ! (J/m^3)^.5 
    pc%DipoleMoment = 5.5400E-30;          ! C^m
    pc%VanDerWaalsVolume = 0.05240;        ! m^3/kmol
    
 
    pc%VanDerWaalsArea = 7.6200E08;        ! m^2/kmol
    pc%RefractiveIndex = 1.3971;           ! -
    pc%FlashPoint = 302.00;                ! K
    pc%FlammabilityLimits = (/ 1.4 11.2 /);    ! vol-!
    pc%FlammabilityLimitTemps = (/ MAX_REAL_WP MAX_REAL_WP /); ! K
    pc%AutoignitionTemp = 616.00;          ! K
    ...
    pc%solDensity%D = 0;
    pc%solDensity%E = 0;
    pc%solDensity%range(:,1) = (/ 184.51, 1.4100E01 /);
    pc%solDensity%eqn = 100;
    
    pc%liqDensity%A = 9.6500E-01;
    pc%liqDensity%B = 2.6660E-01;
    pc%liqDensity%C = 5.6305E02;
    pc%liqDensity%D = 2.4419E-01;
    pc%liqDensity%E = 0;
    pc%liqDensity%range(:,1) = (/ 184.51, 1.2016E01; 563.05, 3.6197E00 /);
    ...
    pc%vapPressure%range(:,1) = (/ 184.51, 5.7220E-04; 563.05, 4.3392E06 /);
    ...
    pc%HeatOfVap%D = 0;
    pc%HeatOfVap%E = 0;
    pc%HeatOfVap%range(:,1) = (/ 184.51, 6.0575E07; 563.05, 0 /);
    ...
    pc%solHeatCapacity%range(:,1) = (/ 20.00, 8.0477E03; 184.51, 9.7456E04 /);
    ...
    pc%liqHeatCapacity%range(:,1) = (/ 184.51, 1.3473E05; 390.81, 2.5701E05 /);
    ...
    pc%IG_HeatCapacity%range(:,1) = (/ 200.00, 8.1616E04; 1500.00, 2.8509E05 /);
    ...
    pc%SecondViralCoef%range(:,1) = (/ 282.00, 3.9128E00; 1500.00, 5.5659E-02 /);
    ...
    pc%liqViscosity%range(:,1) = (/ 190.00, 2.5440E-01; 390.81, 3.8873E-04 /);
    ...
    pc%vapViscosity%D = 0;
    pc%vapViscosity%E = 0;
    pc%vapViscosity%range(:,1) = (/ 184.51, 3.9786E-06; 1000.00, 2.2066E-05 /);
    ...
    pc%liqThermalConductivity%range(:,1) = (/ 184.51, 1.7607E-01; 390.81, 1.3411E-01 /);
    ...
    pc%vapThermalConductivity%range(:,1) = (/ 370.00, 2.1971E-02; 800.00, 8.7247E-02 /);
    ...
    pc%SurfaceTension%range(:,1) = (/ 273.15, 2.6503E-02; 413.15, 1.4547E-02 /);
...
subroutine pc_1decanol(pc)
    ...
    pc%solDensity%D = 0;
    pc%solDensity%E = 0;
    pc%solDensity%range(:,1) = (/ 280.05, 6.1900E00 /);
    pc%solDensity%eqn = 100;
